...
export default function IdentityGroupsPage() {
  ...
  return (
    <>
      <Head>
        <title>{`${identity} Groups | 6529 SEIZE`}</title>
        <link rel="icon" href="/favicon.ico" />
        <meta name="description" content={`${identity} Groups | 6529 SEIZE`} />
        <meta
          property="og:url"
          content={`${process.env.BASE_ENDPOINT}/groups/${identity}`}
        />
        <meta property="og:title" content={`${identity} Groups`} />
