              ...
              <Row className="pt-3 pb-3" id="background">
                <Col>
                  ...
                  <p>
                    ...
                    more metrics over time. These metrics may be used from time
                    to time by us for allowlists, by others for their own
                    allowlists or by anyone for any purpose whatsoever.
                  </p>
                  <p>
                    No metric is the &apos;correct&apos; metric. They are just
                    different ways to look at the community. We expect to
                    continue to add (but not subtract) metrics over time, in the
                    hope that some might be useful to others.
                  </p>
                  <p>
                  ...
                  <p>
                    <b>Purchases:</b> Number of NFTs (Memes or Gradient) bought
                    by an address
                  </p>
                  <p>
                  ...
                  <br />
                  <p>
                    Higher of Category A and Category B Boosters, plus Category
                    C Boosters
                  </p>
                  <p>
                    <u>Category A</u>
