...
export const EN_GB_MESSAGES = {
  ...
  "profileCms.builder.agent.error.baseHashMismatch": "Patch target package hash does not match the current draft.",
  "profileCms.builder.agent.error.baseHashMissing": "Patch target package hash is required.",
  "profileCms.builder.agent.error.baseVersionMismatch": "Patch target base version is stale for the current draft.",
  "profileCms.builder.agent.error.blockDuplicateId": "Block id {id} already exists in this draft.",
  "profileCms.builder.agent.error.blockFieldUnsupported": "Block field {field} is not editable by agent patches.",
  "profileCms.builder.agent.error.blockStructuralMix": "Structural block operations cannot be combined with other block mutations in one patch.",
  "profileCms.builder.agent.error.codeLabel": "Code: {code}",
  "profileCms.builder.agent.error.jsonInvalid": "Patch JSON could not be parsed.",
  "profileCms.builder.agent.error.metadataFieldUnsupported": "Metadata field {field} is not editable by agent patches.",
  "profileCms.builder.agent.error.navigationMissing": "Builder draft does not contain an editable navigation item.",
  "profileCms.builder.agent.error.operationUnsupported": "Builder review does not support {op}.",
  "profileCms.builder.agent.error.pageMissing": "Builder draft does not contain an editable homepage.",
  "profileCms.builder.agent.error.pathUnsupported": "Builder review cannot apply path {path}.",
  "profileCms.builder.agent.error.schemaInvalid": "Patch JSON does not match the agent patch schema.",
  "profileCms.builder.agent.error.targetDraftMismatch": "Patch target draft id does not match the current draft.",
  "profileCms.builder.agent.error.validationRejected": "Local package validation rejected this change ({code}).",
  "profileCms.builder.agent.error.valueInvalid": "Patch value is not valid for this operation.",
  ...
  "profileCms.builder.agent.patch.accepted": "Patch validates against the current draft.",
  "profileCms.builder.agent.patch.applied": "Patch applied to this draft.",
  "profileCms.builder.agent.patch.apply": "Apply to draft",
  "profileCms.builder.agent.patch.description": "Paste or upload an agent patch, review the diff, then apply it to this draft.",
  "profileCms.builder.agent.patch.diff": "Proposed diff",
  "profileCms.builder.agent.patch.fileTooLarge": "Patch file is too large. Paste a smaller JSON patch.",
  "profileCms.builder.agent.patch.label": "Agent patch JSON",
  "profileCms.builder.agent.patch.rejected": "Patch was rejected before it could change the draft.",
  ...
  "profileCms.builder.agent.source.description": "Export draft context for local tools and review the packet boundaries.",
  "profileCms.builder.agent.source.title": "Source packet",
  "profileCms.builder.api.disabled": "Builder API writes are not enabled in this frontend environment.",
  "profileCms.builder.api.draftSaved": "Draft saved.",
  "profileCms.builder.api.failed": "Builder API action failed.",
  "profileCms.builder.api.missingDraftId": "Save a draft before requesting publish.",
  "profileCms.builder.api.missingProfileId": "This route could not resolve a profile id for the builder API.",
  "profileCms.builder.api.profileNotAuthorized": "Connect as this profile before using backend builder actions.",
  "profileCms.builder.api.publishRequiresSignedStorage": "Publishing needs the signed decentralized storage flow and is not enabled in this MVP.",
  "profileCms.builder.api.serverValidationCompleted": "Server validation completed.",
  ...
  "profileCms.builder.gallery.review.description": "Review the frozen wallet snapshot before saving the generated gallery package.",
  "profileCms.builder.gallery.review.empty": "Request a wallet snapshot to review assets, collections, media status, and generated preview.",
  ...
  "profileCms.builder.gallery.snapshot.failed": "Gallery snapshot could not be created.",
  "profileCms.builder.gallery.snapshot.fixture": "Fixture snapshot",
  "profileCms.builder.gallery.snapshot.loading": "Requesting...",
  "profileCms.builder.gallery.snapshot.loadingDetail": "Collecting holdings and media candidates for review.",
  "profileCms.builder.gallery.snapshot.request": "Request snapshot",
  "profileCms.builder.gallery.snapshot.warning.fixtureBackendDisabled": "Fixture snapshot used until the gallery backend snapshot endpoint is enabled.",
  "profileCms.builder.gallery.snapshot.warning.partialMedia": "Some media may be pending or unavailable in the reviewed snapshot.",
  ...
  "profileCms.builder.gallery.wallets.emptyError": "Enter at least one ETH address or ENS name.",
  "profileCms.builder.gallery.wallets.help": "Paste one or more ETH addresses or ENS names, separated by commas, spaces, or new lines.",
  "profileCms.builder.gallery.wallets.invalidError": "These wallet entries need attention: {entries}",
  ...
  "profileCms.builder.pageDescription": "Build and preview a profile-native CMS site package.",
  ...
  "profileCms.builder.publishState.pending": "Save and publish require the backend builder endpoints. This UI will not fake a production publish.",
  ...
  "profileCms.builder.validation.issueDetail": "Review this field before saving or publishing.",
  ...
  "profileCms.interactive.budgetWarning": "This 3D asset is above the declared performance budget, so loading may be slow.",
  "profileCms.interactive.canvasLabel": "Interactive 3D preview",
  "profileCms.interactive.deepZoom.description": "This V1 renderer keeps deep zoom static until the interactive viewer is enabled.",
  "profileCms.interactive.deepZoom.title": "Deep zoom preview",
  "profileCms.interactive.embed.description": "This embed is not marked for sandboxed rendering.",
  ...
  "profileCms.interactive.loadError": "The 3D preview could not be loaded. Use the 2D links below.",
  "profileCms.interactive.loadObject": "Load 3D object",
  "profileCms.interactive.loading": "Loading {progress}%",
  "profileCms.interactive.mobileFallback": "This mobile view uses the static poster and 2D links for a lighter, more reliable experience.",
  "profileCms.interactive.object.description": "Load the GLB or glTF viewer when you are ready to inspect the model.",
  ...
  "profileCms.interactive.room.description": "Enter a simple exhibition room. Every artwork still links to its canonical 2D detail page.",
  ...
  "profileCms.media.noCaptions": "No captions were provided for this media asset.",
  ...
  "profileCms.state.empty.description": "This profile website is published, but this page is not available.",
