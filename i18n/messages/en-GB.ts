...
export const EN_GB_MESSAGES = {
  ...
  "waves.leaderboard.grid.preview": "Preview",
  "waves.leaderboard.grid.previewUnavailable": "No preview available.",
  "waves.leaderboard.grid.untitled": "Untitled drop",
  "waves.leaderboard.grid.open": "Open",
  "waves.leaderboard.grid.openNamed": "Open {title}",
  "waves.leaderboard.grid.authorProfile": "View {author}'s profile",
  "waves.leaderboard.grid.vote": "Vote",
  "waves.leaderboard.grid.voteSummary": "Vote summary",
  "waves.leaderboard.grid.reached": "Reached",
  "waves.leaderboard.grid.required": "Required",
  "waves.leaderboard.grid.votesNow": "Votes now",
  "waves.leaderboard.grid.current": "Current",
  "waves.leaderboard.grid.projected": "Projected",
  "waves.leaderboard.grid.yourVote": "Your vote",
  "waves.leaderboard.grid.status": "Status",
  "waves.leaderboard.grid.status.approved": "Approved",
  "waves.leaderboard.grid.status.approvingIn": "Approving in {time}",
  "waves.leaderboard.grid.status.reachedThreshold": "Reached threshold",
  "waves.leaderboard.grid.status.closed": "Closed",
  "waves.leaderboard.grid.status.needs": "Needs {amount}",
