...
export const EN_GB_MESSAGES = {
  ...
  "waves.stormComposer.draftTitle": "Storm draft",
  "waves.stormComposer.privateDraftHint":
    "Only you can see this until you post it.",
  "waves.stormComposer.partsCountOne": "{count} part",
  "waves.stormComposer.partsCountMany": "{count} parts",
  "waves.stormComposer.discard": "Discard",
  "waves.stormComposer.discardConfirmation":
    "Discard every saved part and the part you are writing?",
  "waves.stormComposer.keepDraft": "Keep draft",
  "waves.stormComposer.discardDraft": "Discard draft",
  "waves.stormComposer.part": "Part {number}",
  "waves.stormComposer.mediaOnlyPart": "Media-only part",
  "waves.stormComposer.edit": "Edit",
  "waves.stormComposer.editPart": "Edit part {number}",
  "waves.stormComposer.finishCurrentPartBeforeEditing":
    "Add or clear the current part before editing another part",
  "waves.stormComposer.editing": "Editing",
  "waves.stormComposer.movePartEarlier": "Move part {number} earlier",
  "waves.stormComposer.movePartLater": "Move part {number} later",
  "waves.stormComposer.moveEarlier": "Move earlier",
  "waves.stormComposer.moveLater": "Move later",
  "waves.stormComposer.remove": "Remove",
  "waves.stormComposer.removePart": "Remove part {number}",
  "waves.stormComposer.nextPart": "Next: Part {number}",
  "waves.stormComposer.editingPart": "Editing Part {number}",
  "waves.stormComposer.cancelEdit": "Cancel edit",
  "waves.stormComposer.writePart": "Write part {number}",
  "waves.stormComposer.breakIntoStorm": "Break into storm",
  "waves.stormComposer.addPart": "Add part",
  "waves.stormComposer.saveChanges": "Save changes",
  "waves.stormComposer.postStorm": "Post storm",
