...
export const DE_DE_MESSAGES = {
  ...
  "profileCms.builder.agent.error.baseHashMismatch": "Der Zielpaket-Hash des Patches stimmt nicht mit dem aktuellen Entwurf überein.",
  "profileCms.builder.agent.error.baseHashMissing": "Der Zielpaket-Hash des Patches ist erforderlich.",
  "profileCms.builder.agent.error.baseVersionMismatch": "Die Zielversion des Patches ist für den aktuellen Entwurf veraltet.",
  "profileCms.builder.agent.error.blockDuplicateId": "Block-ID {id} existiert bereits in diesem Entwurf.",
  "profileCms.builder.agent.error.blockFieldUnsupported": "Blockfeld {field} kann nicht durch Agent-Patches bearbeitet werden.",
  "profileCms.builder.agent.error.blockStructuralMix": "Strukturelle Blockoperationen können nicht mit anderen Blockmutationen in einem Patch kombiniert werden.",
  "profileCms.builder.agent.error.codeLabel": "Code: {code}",
  "profileCms.builder.agent.error.jsonInvalid": "Patch-JSON konnte nicht analysiert werden.",
  "profileCms.builder.agent.error.metadataFieldUnsupported": "Metadatenfeld {field} kann nicht durch Agent-Patches bearbeitet werden.",
  "profileCms.builder.agent.error.navigationMissing": "Builder-Entwurf enthält kein bearbeitbares Navigationselement.",
  "profileCms.builder.agent.error.operationUnsupported": "Builder-Überprüfung unterstützt nicht {op}.",
  "profileCms.builder.agent.error.pageMissing": "Builder-Entwurf enthält keine bearbeitbare Homepage.",
  "profileCms.builder.agent.error.pathUnsupported": "Builder-Überprüfung kann Pfad {path} nicht anwenden.",
  "profileCms.builder.agent.error.schemaInvalid": "Patch-JSON entspricht nicht dem Agent-Patch-Schema.",
  "profileCms.builder.agent.error.targetDraftMismatch": "Die Ziel-Entwurfs-ID des Patches stimmt nicht mit dem aktuellen Entwurf überein.",
  "profileCms.builder.agent.error.validationRejected": "Lokale Paketvalidierung hat diese Änderung abgelehnt ({code}).",
  "profileCms.builder.agent.error.valueInvalid": "Patch-Wert ist für diese Operation ungültig.",
  ...
  "profileCms.builder.agent.patch.accepted": "Patch validiert gegen den aktuellen Entwurf.",
  "profileCms.builder.agent.patch.applied": "Patch auf diesen Entwurf angewendet.",
  "profileCms.builder.agent.patch.apply": "Auf Entwurf anwenden",
  "profileCms.builder.agent.patch.description": "Fügen Sie einen Agent-Patch ein oder laden Sie ihn hoch, überprüfen Sie den Diff und wenden Sie ihn auf diesen Entwurf an.",
  "profileCms.builder.agent.patch.diff": "Vorgeschlagener Diff",
  "profileCms.builder.agent.patch.fileTooLarge": "Patch-Datei ist zu groß. Fügen Sie einen kleineren JSON-Patch ein.",
  "profileCms.builder.agent.patch.label": "Agent-Patch-JSON",
  "profileCms.builder.agent.patch.rejected": "Patch wurde abgelehnt, bevor es den Entwurf ändern konnte.",
  ...
  "profileCms.builder.agent.source.description": "Exportieren Sie den Entwurfskontext für lokale Tools und überprüfen Sie die Paketgrenzen.",
  "profileCms.builder.agent.source.title": "Quellpaket",
  "profileCms.builder.api.disabled": "Builder-API-Schreibvorgänge sind in dieser Frontend-Umgebung nicht aktiviert.",
  "profileCms.builder.api.draftSaved": "Entwurf gespeichert.",
  "profileCms.builder.api.failed": "Builder-API-Aktion fehlgeschlagen.",
  "profileCms.builder.api.missingDraftId": "Speichern Sie einen Entwurf, bevor Sie eine Veröffentlichung anfordern.",
  "profileCms.builder.api.missingProfileId": "Diese Route konnte keine Profil-ID für die Builder-API auflösen.",
  "profileCms.builder.api.profileNotAuthorized": "Verbinden Sie sich mit diesem Profil, bevor Sie Backend-Builder-Aktionen verwenden.",
  "profileCms.builder.api.publishRequiresSignedStorage": "Veröffentlichung erfordert den signierten dezentralisierten Speicherfluss und ist in diesem MVP nicht aktiviert.",
  "profileCms.builder.api.serverValidationCompleted": "Server-Validierung abgeschlossen.",
  ...
  "profileCms.builder.gallery.review.description": "Überprüfen Sie den eingefrorenen Wallet-Snapshot, bevor Sie das generierte Galerie-Paket speichern.",
  "profileCms.builder.gallery.review.empty": "Fordern Sie einen Wallet-Snapshot an, um Assets, Sammlungen, Medienstatus und generierte Vorschau zu überprüfen.",
  ...
  "profileCms.builder.gallery.snapshot.failed": "Galerie-Snapshot konnte nicht erstellt werden.",
  "profileCms.builder.gallery.snapshot.fixture": "Fixture-Snapshot",
  "profileCms.builder.gallery.snapshot.loading": "Wird angefordert...",
  "profileCms.builder.gallery.snapshot.loadingDetail": "Sammeln von Beständen und Medienkandidaten zur Überprüfung.",
  "profileCms.builder.gallery.snapshot.request": "Snapshot anfordern",
  "profileCms.builder.gallery.snapshot.warning.fixtureBackendDisabled": "Fixture-Snapshot wird verwendet, bis der Galerie-Backend-Snapshot-Endpunkt aktiviert ist.",
  "profileCms.builder.gallery.snapshot.warning.partialMedia": "Einige Medien können im überprüften Snapshot ausstehend oder nicht verfügbar sein.",
  ...
  "profileCms.builder.gallery.wallets.emptyError": "Geben Sie mindestens eine ETH-Adresse oder einen ENS-Namen ein.",
  "profileCms.builder.gallery.wallets.help": "Fügen Sie eine oder mehrere ETH-Adressen oder ENS-Namen ein, getrennt durch Kommas, Leerzeichen oder Zeilenumbrüche.",
  "profileCms.builder.gallery.wallets.invalidError": "Diese Wallet-Einträge benötigen Aufmerksamkeit: {entries}",
  ...
  "profileCms.builder.json.importFailed": "Paket-JSON konnte nicht importiert werden.",
  "profileCms.builder.json.label": "Paketkandidat",
  "profileCms.builder.json.title": "Paket-JSON",
  "profileCms.builder.pageDescription": "Erstellen und Vorschau eines profil-nativen CMS-Site-Pakets.",
  ...
  "profileCms.builder.publishState.pending": "Speichern und Veröffentlichen erfordern die Backend-Builder-Endpunkte. Diese Benutzeroberfläche wird keine Produktionsveröffentlichung simulieren.",
  "profileCms.builder.publishState.title": "Entwurfs- und Veröffentlichungsstatus",
  ...
  "profileCms.builder.validation.issueDetail": "Überprüfen Sie dieses Feld vor dem Speichern oder Veröffentlichen.",
  ...
  "profileCms.error.description": "Diese Profil-Website konnte nicht gerendert werden.",
  ...
  "profileCms.interactive.budgetWarning": "Dieses 3D-Asset überschreitet das deklarierte Performance-Budget, daher das Laden langsam sein kann.",
  "profileCms.interactive.canvasLabel": "Interaktive 3D-Vorschau",
  "profileCms.interactive.deepZoom.description": "Dieser V1-Renderer hält Deep Zoom statisch, bis der interaktive Viewer aktiviert wird.",
  "profileCms.interactive.deepZoom.title": "Deep-Zoom-Vorschau",
  "profileCms.interactive.embed.description": "Dieses Embed ist nicht für geschützte Darstellung gekennzeichnet.",
  "profileCms.interactive.embed.iframeTitle": "Eingebettete Profil-Website-Medien",
  ...
  "profileCms.interactive.loadError": "Die 3D-Vorschau konnte nicht geladen werden. Verwenden Sie die unten stehenden 2D-Links.",
  "profileCms.interactive.loadObject": "3D-Objekt laden",
  "profileCms.interactive.loading": "Wird geladen {progress}%",
  "profileCms.interactive.mobileFallback": "Diese Mobilansicht verwendet das statische Poster und 2D-Links für ein leichteres, zuverlässigeres Erlebnis.",
  "profileCms.interactive.object.description": "Laden Sie den GLB- oder glTF-Viewer, wenn Sie bereit sind, das Modell zu überprüfen.",
  ...
  "profileCms.interactive.room.description": "Betreten Sie einen einfachen Ausstellungsraum. Jedes Kunstwerk verlinkt immer noch auf seine kanonische 2D-Detailseite.",
  ...
  "profileCms.media.noCaptions": "Für dieses Medienelement wurden keine Untertitel bereitgestellt.",
  ...
  "profileCms.state.empty.description": "Diese Profil-Website ist veröffentlicht, aber diese Seite ist nicht verfügbar.",
