...
export const FR_FR_CAPACITOR_CONNECT_MESSAGES = buildCapacitorConnectMessages([
  ...
  "Les portefeuilles de l'app sont des portefeuilles chiffrés stockés de manière sécurisée sur cet appareil. Choisissez-en un ou créez-en un nouveau.",
...
export const ES_ES_CAPACITOR_CONNECT_MESSAGES = buildCapacitorConnectMessages([
  ...
  "Las billeteras de la app están cifradas y se guardan de forma segura en este dispositivo. Elige una o crea una nueva.",
...
export const DE_DE_CAPACITOR_CONNECT_MESSAGES = buildCapacitorConnectMessages([
  ...
  "App-Wallets sind verschlüsselte Wallets, die sicher auf diesem Gerät gespeichert sind. Wähle eine aus oder erstelle eine neue.",
