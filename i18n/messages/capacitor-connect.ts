...
export const CAPACITOR_CONNECT_MESSAGES = buildCapacitorConnectMessages([
  ...
  "External Wallets",
  "Scan Connection QR",
  "App Wallets are encrypted wallets stored securely on this device. Choose one to connect, or create or import one.",
  "Create App Wallet",
  "Import App Wallet",
...
export const FR_FR_CAPACITOR_CONNECT_MESSAGES = buildCapacitorConnectMessages([
  ...
  "Les portefeuilles de l'app sont des portefeuilles chiffrés stockés de manière sécurisée sur cet appareil. Choisissez-en un, créez-en un ou importez-en un.",
  "Créer un portefeuille de l'app",
  "Importer un portefeuille de l'app",
...
export const ES_ES_CAPACITOR_CONNECT_MESSAGES = buildCapacitorConnectMessages([
  ...
  "Las billeteras de la app están cifradas y se guardan de forma segura en este dispositivo. Elige una, crea una nueva o importa una.",
  "Crear billetera de la app",
  "Importar billetera de la app",
...
export const DE_DE_CAPACITOR_CONNECT_MESSAGES = buildCapacitorConnectMessages([
  ...
  "App-Wallets sind verschlüsselte Wallets, die sicher auf diesem Gerät gespeichert sind. Wähle eine aus, erstelle eine neue oder importiere eine.",
  "App-Wallet erstellen",
  "App-Wallet importieren",
