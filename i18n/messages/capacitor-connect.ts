const CAPACITOR_CONNECT_MESSAGE_KEYS = [
  ...
  "capacitorConnect.externalWallets.coinbaseUnsupported",
...
export const FR_FR_CAPACITOR_CONNECT_MESSAGES = buildCapacitorConnectMessages([
  ...
  "Coinbase Wallet n’est pas pris en charge dans l’app 6529. Ouvrez 6529.io dans Safari ou Chrome pour vous connecter avec Coinbase.",
...
export const ES_ES_CAPACITOR_CONNECT_MESSAGES = buildCapacitorConnectMessages([
  ...
  "Billeteras externas",
  "Coinbase Wallet no es compatible con la app de 6529. Abre 6529.io en Safari o Chrome para conectarte con Coinbase.",
...
export const DE_DE_CAPACITOR_CONNECT_MESSAGES = buildCapacitorConnectMessages([
  ...
  "App-Wallets",
  "Externe Wallets",
  "Coinbase Wallet wird in der 6529-App nicht unterstützt. Öffne 6529.io in Safari oder Chrome, um dich mit Coinbase zu verbinden.",
