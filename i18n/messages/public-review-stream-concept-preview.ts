export const PUBLIC_REVIEW_STREAM_CONCEPT_PREVIEW_MESSAGES = {
  "publicReview.conceptPreview.entry.eyebrow":
  ...
  "publicReview.conceptPreview.steps.collector": "Collector",
  "publicReview.conceptPreview.steps.history": "History",
  "publicReview.conceptPreview.next": "Next: {step}",
  "publicReview.conceptPreview.back": "Back: {step}",
  ...
  "publicReview.conceptPreview.artwork.takeaway": "One artwork · one token",
  "publicReview.conceptPreview.plan.heading": "The artist sets the release",
  ...
  "publicReview.conceptPreview.feedback.heading": "Does this make sense?",
  "publicReview.conceptPreview.feedback.description":
    "Tell us what feels unclear or missing.",
  "publicReview.conceptPreview.feedback.action":
    "Share feedback on this preview",
} as const;
