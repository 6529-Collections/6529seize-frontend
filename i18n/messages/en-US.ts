...
const REP_CATEGORY_MESSAGES = objectMessages("rep.categories", {
  ...
  "grant.searchError": "Could not search REP categories. Please try again.",
  "grant.noOptions": "No category options are available.",
  "grant.resultsLabel": "REP category options",
  "grant.existing": "Existing category",
  "grant.submissionCategory": "Counts toward Memes submission eligibility.",
  "grant.mostActive": "Most active spelling among similar categories.",
  "grant.similarSpellings":
    "Similar existing spellings are grouped here and won't be selected:",
  "grant.create": "Create new category",
  "grant.createDescription":
    "No equivalent category exists. This exact spelling creates a separate category.",
  "grant.selectedExisting": "Using existing category: {category}.",
  "grant.selectedNew": "New category selected: {category}.",
