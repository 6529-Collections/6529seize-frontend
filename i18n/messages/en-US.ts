...
const USER_PROFILE_HEADER_MESSAGES = objectMessages("user.profileHeader", {
  ...
  "actions.label": "Profile actions",
  "badges.label": "Profile credentials",
  "badges.level": "Level {level}",
  "badges.nicStatus": "NIC: {status}",
  "badges.nicStatus.inaccurate": "Inaccurate",
  "badges.nicStatus.unknown": "Not Enough Ratings Yet",
  "badges.nicStatus.probablyAccurate": "Probably Accurate",
  "badges.nicStatus.accurate": "Accurate",
  "badges.nicStatus.highlyAccurate": "Highly Accurate",
  "classification.edit": "Edit {name}'s classification",
  "stats.label": "Profile statistics",
