...
const WAVES_SIDEBAR_MESSAGES = objectMessages("waves.sidebar", {
  ...
  "rightPanel.tabs.about": "About",
  "rightPanel.tabs.rules": "Rules",
  "rightPanel.tabs.rep": "REP",
  "rightPanel.tabs.settings": "Settings",
  "rightPanel.tabs.voters": "Voters",
  "rightPanel.tabs.activity": "Activity",
  "rightPanel.voters.loading": "Loading voters…",
  "rightPanel.voters.emptyTitle": "No votes yet",
  "rightPanel.voters.emptyDescription":
    "Voter rankings will appear after the first vote.",
  "rightPanel.activity.loading": "Loading voting activity…",
  "rightPanel.activity.emptyTitle": "No voting activity yet",
  "rightPanel.activity.emptyDescription":
    "Vote changes will appear here as they happen.",
  "rightPanel.activity.openDropAriaLabel": "View drop in chat",
  "rightPanel.activity.voterTitle": "Voter: {profile}",
  "rightPanel.activity.dropCreatorTitle": "Drop creator: {profile}",
  "rightPanel.activity.voted": "voted",
  "rightPanel.activity.unknownProfile": "Unknown profile",
  "rightPanel.voters.avatarFallback": "Voter",
  "rightPanel.specs.overview": "Overview",
  "rightPanel.specs.type": "Type",
  "rightPanel.specs.parentWave": "Parent wave",
  "rightPanel.specs.voting": "Voting",
  "rightPanel.specs.votingPower": "Voting power",
  "rightPanel.specs.creator": "Creator",
  "rightPanel.specs.eligibleIdentities": "Eligible identities",
  "rightPanel.specs.repeatSubmissions": "Repeat submissions",
  "rightPanel.specs.category": "Category",
  "rightPanel.specs.creditor": "Creditor",
  "rightPanel.specs.unknown": "Unknown",
  "rightPanel.specs.creditorAriaLabel": "Creditor {handle}",
  "rightPanel.rules.title": "Rules",
  "rightPanel.rules.creatorTitle": "Creator rules",
  "rightPanel.rules.emptyCreator": "No custom creator rules added.",
  "rightPanel.rules.displayOnly": "Display only",
  "rightPanel.rules.requiresAcceptance": "Requires acceptance",
  "rightPanel.rules.signatureRequired":
    "Participants sign these rules with their wallet before submitting.",
  "rightPanel.settings.rules": "Rules",
  "rightPanel.settings.display": "Display",
  "rightPanel.settings.approvalTabs": "Approval tabs",
  "rightPanel.settings.approvalRule": "Approval rule",
  "rightPanel.settings.chat": "Chat",
  "rightPanel.settings.access": "Access",
  "rightPanel.group.editAriaLabel": "Edit group",
  "rightPanel.group.editTitle": "Edit",
