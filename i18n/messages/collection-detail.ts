...
export const MARKET_DEPTH_MESSAGES = namespaceMessages("marketDepth", [
  ...
  [
    "description",
    "Listings and offers captured from OpenSea. Some quotes share the same NFTs or funds, so available quantities can overlap.",
  ],
  ["loading", "Loading market depth"],
  ["status.fresh", "Fresh snapshot"],
  ["status.stale", "Stale snapshot"],
  ["status.unavailable", "Unavailable"],
  ["status.unknown", "Snapshot status unknown"],
  ["bestAsk", "Best ask · ETH"],
  ["bestBid", "Best bid · WETH"],
  ...
  ["orders.title", "Order details ({count})"],
  ["orders.caption", "Quoted individual orders"],
  ["orders.none", "No individual orders were returned for this snapshot."],
  ["orders.side", "Side"],
  ["orders.ask", "Ask"],
  ["orders.bid", "Bid"],
  ["orders.scope", "Scope"],
  ...
  ["empty", "No quoted depth was returned in the completed snapshot."],
  ["stale", "This snapshot may be out of date. It was captured {time}."],
  ["staleUnknownTime", "at an unknown time"],
  [
    "criteriaSummary",
  ...
  ["details", "Details"],
  ["error", "Market depth could not be loaded."],
  ["moreError", "More order details could not be loaded."],
  [
    "noSnapshotNotes",
    "A completed market snapshot is not available for this token.",
  ],
