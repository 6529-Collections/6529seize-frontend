...
export const MARKET_DEPTH_MESSAGES = namespaceMessages("marketDepth", [
  ...
  ["status.stale", "Snapshot is stale."],
  ["unpricedOrders", "Some orders in the collection could not be priced."],
  ["status.unavailable", "Pricing unavailable"],
  ["bestAsk", "Lowest listing · ETH"],
  ["bestBid", "Highest offer · WETH"],
  ...
  ["table.ariaLabel", "{side} for {currency}"],
  ["table.price", "Price"],
  ["table.quantity", "Quantity"],
  ["table.quantityShort", "Qty"],
  ["table.cumulative", "Cumulative"],
  ["table.cumulativeShort", "Total"],
  ["table.action", "Action"],
  ["levels.showAll", "Show all levels"],
  ["levels.showFewer", "Show fewer levels"],
  ["levels.askDetails", "Listings at {price} {currency}"],
  ["levels.bidDetails", "Offers at {price} {currency}"],
  ["orders.information", "Order information"],
  ["orders.maker", "Wallet"],
  ["orders.reference", "Order reference"],
  ["orders.currencyContract", "Currency contract"],
  ["orders.quotedQuantity", "Quoted quantity"],
  ...
  ["orders.showAll", "Show all {count} orders"],
  ["orders.showFewer", "Show fewer orders"],
  ["orders.otherTitle", "Orders requiring verification ({count})"],
  [
    "orders.otherDescription",
  ...
  ["orders.bid", "Offer"],
  ["orders.scope", "Scope"],
  ["orders.applicability", "Applicability"],
  ["orders.price", "Price"],
  ["orders.currency", "Currency"],
  ["orders.remaining", "Remaining"],
  ["orders.expires", "Expires"],
  ["orders.noExpiry", "No expiry"],
  ["orders.tokenScope", "Token scope"],
  ["orders.collectionScope", "Collection scope"],
  ["orders.traitScope", "Trait scope"],
  ["orders.scopeUnknown", "Scope unknown"],
  ["orders.tokenMatch", "Token match"],
  ["orders.collectionMatch", "Collection match"],
  ["orders.criteriaUnverified", "Criteria match unverified"],
  ["orders.loadMore", "Load more orders"],
  ["orders.loadingMore", "Loading…"],
  ["orders.firstRows", "Showing the first {count} orders."],
  [
    "unavailable.title",
    "Listings and offers are not available for this card yet.",
  ],
  ["empty", "No fixed-price listings or offers are available in this update."],
  ...
  ["about.title", "About these prices"],
  [
    "about.description",
    "Listings can share the same seller inventory, and offers can share the same bidder funds. A collection offer uses one shared budget across every eligible card. The same cards or funds may therefore appear in more than one quote.",
  ],
  [
    "criteriaSummary",
    "{count} criteria orders are shown separately; token applicability is unverified.",
  ],
  [
    "criteriaSummary.single",
    "1 criteria order is shown separately; token applicability is unverified.",
  ],
  ["retry", "Try again"],
  ["refresh", "Refresh"],
  ["error", "Listings and offers could not be loaded."],
  ["moreError", "More listings and offers could not be loaded."],
  ["trade.collect", "Collect"],
  ["trade.remove", "Remove"],
  ["trade.accept", "Accept offer"],
  ["trade.sell", "Sell"],
  ["trade.quantity", "Quantity"],
  ["trade.available", "{quantity} available from this listing"],
  ["trade.quantityInvalid", "Enter an available whole quantity."],
  [
    "trade.ownerRequired",
    "Connect the wallet holding this NFT to accept this offer.",
  ],
  ["trade.connectOwner", "Connect or switch wallet"],
  [
    "trade.overlap",
    "These listings may use the same inventory. Choose one of them.",
  ],
  ["trade.limit", "You can review up to {count} listings at once."],
  ["trade.unsupported", "This order cannot be traded here."],
  ["trade.checking", "Checking the current order…"],
  ["trade.checkFailed", "The current order could not be checked. Try again."],
...
export const MEME_CALENDAR_MESSAGES = namespaceMessages("memeCalendar", [
  ...
  ["overview.controls.showSchedule", "Show mint schedule"],
  ["grid.controls.findMintDate", "Find mint date"],
  ...
  ["artwork.open", "Open Meme #{meme}"],
  ["artwork.notPublished", "Artwork not published yet."],
  ["artwork.checking", "Checking artwork availability…"],
  [
    "artwork.checkFailed",
    "Artwork availability could not be checked. Try again later.",
  ],
