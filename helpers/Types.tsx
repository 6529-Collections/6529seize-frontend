...
export const STATEMENT_TITLE: Record<STATEMENT_TYPE, string> = {
  ...
  [STATEMENT_TYPE.SUPER_RARE]: "SuperRare",
  [STATEMENT_TYPE.FOUNDATION]: "Foundation",
  [STATEMENT_TYPE.MAKERS_PLACE]: "MakersPlace",
  [STATEMENT_TYPE.KNOWN_ORIGIN]: "KnownOrigin",
  [STATEMENT_TYPE.PEPE_WTF]: "Pepe.wtf",
  [STATEMENT_TYPE.OPENSEA]: "OpenSea",
  [STATEMENT_TYPE.ART_BLOCKS]: "Art Blocks",
  [STATEMENT_TYPE.DECA_ART]: "Deca Art",
  [STATEMENT_TYPE.ON_CYBER]: "OnCyber",
  [STATEMENT_TYPE.THE_LINE]: "The Line",
};
...
export const STATEMENT_INPUT_PLACEHOLDER: Record<STATEMENT_TYPE, string> = {
  ...
  [STATEMENT_TYPE.BIO]: "About",
  [STATEMENT_TYPE.SUPER_RARE]: "https://superrare.com/",
  [STATEMENT_TYPE.FOUNDATION]: "https://foundation.app/",
  [STATEMENT_TYPE.MAKERS_PLACE]: "https://makersplace.com/",
  [STATEMENT_TYPE.KNOWN_ORIGIN]: "https://knownorigin.io/",
  [STATEMENT_TYPE.PEPE_WTF]: "https://pepe.wtf/",
  [STATEMENT_TYPE.OPENSEA]: "https://opensea.io/",
  [STATEMENT_TYPE.ART_BLOCKS]: "https://www.artblocks.io/",
  [STATEMENT_TYPE.DECA_ART]: "https://deca.art/",
  [STATEMENT_TYPE.ON_CYBER]: "https://oncyber.io/",
  [STATEMENT_TYPE.THE_LINE]: "https://oncyber.io/line",
};
