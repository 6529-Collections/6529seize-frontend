...
const ALLOWED_PACKAGE_VERSION = "0.0.2";
...
const ALLOWED_TARBALL_URL =
  ...
  `${ALLOWED_PACKAGE_VERSION}/1df8b6fbc1324733fbd5f24be86dce52693390f6`;
const ALLOWED_INTEGRITY =
  "sha512-8lx1FCS9NSXQ3QJR+PbtptAhh16MHC3aATYfbxHQWs/ICpNa+N/h9Jl4C85dhSbMJGaifl2LP02eJFJcFVaTlw==";
