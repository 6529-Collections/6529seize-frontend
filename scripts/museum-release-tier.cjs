...
const POLICY_PATTERNS = Object.freeze([
  ...
  /^scripts\/(?:app-pr-ci-effective-plan|e2e-packs|museum-|pr-ci-policy-bundle|sync-e2e-manifest)/u,
  /^tests\/packs\.manifest\.cjs$/u,
  /^tests\/museum\//u,
  /^__tests__\/lib\/museum\/publication\/corpusContracts\.test\.ts$/u,
  /^__tests__\/scripts\/(?:app-pr-ci-effective-plan|deployment-e2e|e2e-packs|frontend-deployment|museum-|pr-ci-policy-bundle|production-artifact|production-build|production-e2e|sync-e2e-manifest)/u,
