...
const POLICY_PATTERNS = Object.freeze([
  ...
  /^__tests__\/scripts\/(?:app-pr-ci-effective-plan|e2e-packs|frontend-deployment|museum-|pr-ci-policy-bundle|production-artifact|production-build|production-e2e|sync-e2e-manifest)/u,
