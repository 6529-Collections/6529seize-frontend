  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <AllowlistToolAnimationWrapper mode="sync" initial={true}>
        <AllowlistToolAnimationHeightOpacity key="allowlist-tool-builder-wallet-pool-add-file-title">
          {fileName && (
            <div className="tw-px-6 tw-mt-4 tw-flex tw-items-center tw-gap-x-3">
