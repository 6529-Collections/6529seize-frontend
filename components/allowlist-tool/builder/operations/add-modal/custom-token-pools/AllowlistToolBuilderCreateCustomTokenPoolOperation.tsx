  ...
  return (
    <form onSubmit={handleSubmit} className="tw-px-4 sm:tw-px-6">
      ...
      <div className="tw-mt-6 tw-flex tw-gap-x-4">
        <div>
          <label
            htmlFor="custom-token-pool-file-upload-operation"
            className="tw-inline-flex tw-items-center tw-justify-center tw-cursor-pointer tw-whitespace-nowrap tw-bg-transparent hover:tw-bg-neutral-800/80 tw-px-4 tw-py-3 tw-text-sm tw-font-medium tw-text-white tw-w-full tw-border tw-border-solid tw-border-neutral-700 tw-rounded-lg tw-transition tw-duration-300 tw-ease-out"
          >
            <svg
          ...
          <input
            id="custom-token-pool-file-upload-operation"
            type="file"
            accept="text/csv"
            className="tw-hidden"
        ...
        <AllowlistToolAnimationWrapper mode="sync" initial={true}>
          <AllowlistToolAnimationHeightOpacity key="allowlist-tool-builder-custom-token-pool-add-file-title" elementClasses="tw-flex tw-items-center tw-gap-x-3">
            {fileName && (
              <div className="tw-flex tw-items-center tw-gap-x-3">
                <div className="tw-h-6 tw-w-6 tw-flex tw-items-center tw-justify-center tw-rounded-full tw-bg-neutral-700 tw-ring-4 tw-ring-neutral-800">
                  <svg
                    className="tw-h-3.5 tw-w-3.5 tw-text-primary-400"
                    viewBox="0 0 24 24"
                    fill="none"
                    xmlns="http://www.w3.org/2000/svg"
                  >
