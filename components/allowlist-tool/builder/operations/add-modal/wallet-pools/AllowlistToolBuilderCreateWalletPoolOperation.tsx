    ...
    <form onSubmit={handleSubmit} className="tw-px-4 sm:tw-px-6">
      <div className="tw-grid tw-grid-cols-1 tw-gap-4 tw-pt-5">
        ...
        <div className="tw-flex tw-items-center tw-gap-x-6">
          <div>
            <label
              htmlFor="wallet-pool-file-upload-operation"
            ...
            <input
              required
              id="wallet-pool-file-upload-operation"
              type="file"
              accept="text/csv"
              className="tw-hidden"
          ...
          <AllowlistToolAnimationWrapper mode="sync" initial={true}>
            <AllowlistToolAnimationHeightOpacity
              key="allowlist-tool-builder-wallet-pool-add-file-title"
              elementClasses="tw-flex tw-items-center tw-gap-x-3"
            >
              {fileName && (
