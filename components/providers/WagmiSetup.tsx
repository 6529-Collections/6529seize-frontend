      ...
      const initializationPromise = (async () => {
        ...
        if (!appKitInitialized) {
          ...
          const appKitConfig = isCapacitor ? {
            ...
            // Use includeWalletIds to ensure MetaMask appears with proper icon and deep linking
            includeWalletIds: [
            ...
            // Don't use featuredWalletIds for mobile, use includeWalletIds instead
            ...
            enableWalletGuide: false,
            // Use includeWalletIds for consistent wallet presentation
            includeWalletIds: [
              'c57ca95b47569778a828d19178114f4db188b89b763c899ba0be274e97267d96', // MetaMask
              '4622a2b2d6af1c9844944291e5e7351a6aa24cd7b23099efac1b2fd875da31a0', // Trust Wallet
              '1ae92b26df02f0abca6304df07debccd18262fdf5fe82daa81593582dac9a369', // Rainbow
            ...
            featuredWalletIds: ['c57ca95b47569778a828d19178114f4db188b89b763c899ba0be274e97267d96'], // MetaMask as featured
