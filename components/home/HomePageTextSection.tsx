  ...
  return (
    <section className="tw-relative tw-px-3 tw-pb-10 tw-pt-8 sm:tw-px-4 md:tw-px-6 md:tw-pb-16 md:tw-pt-10 lg:tw-px-8">
      ...
      <div className="tw-relative tw-z-10 tw-py-4 md:tw-py-8">
        <div className="tw-mx-auto tw-grid tw-grid-cols-1 tw-gap-y-2 lg:tw-gap-y-3 md:tw-max-w-2xl lg:tw-grid-cols-12 lg:tw-grid-rows-[auto_auto] lg:tw-gap-x-12 xl:tw-gap-x-8 lg:tw-max-w-none">
          <div className="lg:tw-col-span-7 lg:tw-row-start-1 md:tw-text-center lg:tw-text-left">
            <h2 className="tw-mb-0 sm:tw-text-balance tw-text-xl tw-tracking-tight tw-font-semibold tw-leading-tight tw-text-iron-200 sm:tw-text-2xl md:tw-text-3xl">
          ...
          <div className="lg:tw-col-span-7 lg:tw-row-start-2 tw-flex tw-flex-col md:tw-text-center lg:tw-text-left">
            <p className="tw-mb-0 tw-text-balance tw-text-lg tw-font-normal tw-leading-normal tw-text-iron-300 sm:tw-text-xl md:tw-text-2xl">
            ...
            <p className="tw-mb-0 tw-mt-6 md:tw-mt-8 tw-text-balance tw-text-xs tw-uppercase tw-tracking-[0.16em] tw-text-iron-400 lg:tw-whitespace-nowrap">
              The long-term goal is nation-scale positive impact.
            </p>
          </div>
          <div className="tw-relative tw-z-10 tw-mt-6 md:tw-mt-8 lg:tw-mt-0 tw-flex tw-flex-col tw-items-center tw-space-y-6 lg:tw-col-span-5 lg:tw-col-start-8 lg:tw-row-start-2 lg:tw-items-start">
            <div className="tw-group tw-relative tw-w-full tw-max-w-none">
              ...
              <div className="tw-bg-surface-dark/80 tw-relative tw-rounded-xl tw-border tw-border-solid tw-border-iron-700/70 tw-p-6 tw-shadow-[0_16px_40px_rgba(0,0,0,0.35)] tw-backdrop-blur-xl">
                <div className="tw-bg-primary/50 tw-absolute tw-right-3 tw-top-3 tw-h-1.5 tw-w-1.5 tw-animate-pulse tw-rounded-full" />
                <p className="tw-mb-0 md:tw-text-center lg:tw-text-left tw-font-mono tw-text-sm tw-leading-relaxed tw-text-gray-400 lg:tw-text-balance">
