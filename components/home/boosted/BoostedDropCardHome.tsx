    ...
    return (
      ...
      >
        ...
        {media ? (
          ...
          <div className="tw-relative tw-flex tw-aspect-[5/2] tw-w-full tw-items-center tw-justify-center tw-overflow-hidden tw-rounded-xl tw-px-6 tw-pb-6 tw-pt-4 sm:tw-aspect-[5/4] sm:tw-pb-0 sm:tw-pt-16 md:tw-aspect-[8/5] md:tw-pt-12 lg:tw-aspect-[5/4] xl:tw-aspect-[8/5]">
            <div className="tw-relative tw-z-10 tw-flex tw-w-full tw-justify-center">
              <ContentDisplay
                content={previewContent}
                shouldClamp={false}
                className="tw-flex tw-w-fit tw-max-w-full tw-flex-col tw-items-start tw-gap-1 tw-break-words tw-font-normal tw-leading-relaxed tw-tracking-[0.01em] tw-text-iron-300"
