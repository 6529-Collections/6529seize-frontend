...
const HomePageTabs = forwardRef<HTMLDivElement, HomePageTabsProps>(
  ({ hasTouchScreen = false }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={`tailwind-scope tw-px-6 tw-sticky ${
          hasTouchScreen ? 'tw-top-16' : 'tw-top-0'
        } tw-z-20 tw-overflow-hidden tw-bg-black/80 tw-backdrop-blur tw-border-b tw-border-solid tw-border-iron-900 tw-border-x-0 tw-border-t-0`}
      >
