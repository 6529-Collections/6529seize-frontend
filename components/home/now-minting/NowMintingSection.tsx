...
export default function NowMintingSection() {
  ...
  if (isFetching && !nft) {
    return (
      <section className="tw-px-4 tw-pb-20 tw-pt-6 md:tw-pt-8 md:tw-px-6 lg:tw-px-8">
  ...
  return (
    <section className="tw-px-4 tw-pb-20 tw-pt-6 md:tw-pt-8 md:tw-px-6 md:tw-pb-24 lg:tw-px-8">
      <span className="tw-mb-3 tw-block tw-text-xl tw-font-semibold tw-tracking-tight tw-text-zinc-200 md:tw-mb-4 md:tw-text-2xl">
        Latest Drop
      </span>
