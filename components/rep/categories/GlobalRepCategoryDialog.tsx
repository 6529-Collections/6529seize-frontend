    ...
    >
      <div
        className={`
          ...
          [&_.rep-category-header]:tw-pr-14 sm:[&_.rep-category-header]:tw-pr-16 [&_.rep-category-header-actions]:tw-items-center [&_.rep-category-layout]:!tw-gap-5 sm:[&_.rep-category-layout]:!tw-gap-6
          ...
          [&_.rep-category-preview-list]:!tw-gap-0.5 [&_.rep-category-preview-row]:!tw-gap-2 [&_.rep-category-preview-row]:!tw-rounded-lg [&_.rep-category-preview-row]:!tw-border-0 [&_.rep-category-preview-row]:!tw-bg-transparent [&_.rep-category-preview-row]:!tw-px-0 [&_.rep-category-preview-row]:tw-transition-colors hover:[&_.rep-category-preview-row]:!tw-bg-iron-900
          ...
          [&_.rep-category-sort-button[aria-pressed=true]]:!tw-bg-iron-800 [&_.rep-category-sort-button[aria-pressed=true]]:!tw-text-iron-100 [&_.rep-category-sort-button]:!tw-rounded-lg [&_.rep-category-sort-button]:!tw-border-0 [&_.rep-category-sort-button]:!tw-bg-iron-950 [&_.rep-category-sort-button]:!tw-px-3 [&_.rep-category-sort-button]:!tw-py-1.5 [&_.rep-category-sort-button]:!tw-text-xs [&_.rep-category-sort-button]:!tw-font-medium [&_.rep-category-sort-button]:!tw-leading-5 [&_.rep-category-sort-button]:!tw-text-iron-500 hover:[&_.rep-category-sort-button]:!tw-bg-iron-900 hover:[&_.rep-category-sort-button]:!tw-text-iron-100
          [&_.rep-category-sort-row]:!tw-justify-start [&_.rep-category-sort]:!tw-gap-1 [&_.rep-category-sort]:tw-rounded-lg [&_.rep-category-sort]:tw-bg-iron-950 [&_.rep-category-sort]:tw-p-1 [&_.rep-category-sort]:tw-ring-1 [&_.rep-category-sort]:tw-ring-inset [&_.rep-category-sort]:tw-ring-iron-800
