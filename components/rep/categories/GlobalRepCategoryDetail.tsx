...
const PRESENTATION_CLASSNAME = `
  ...
  [&_.rep-category-metric-label]:!tw-mb-1 [&_.rep-category-metric-label]:!tw-mt-0 [&_.rep-category-metric-label]:!tw-whitespace-nowrap [&_.rep-category-metric-label]:!tw-text-[0.625rem] [&_.rep-category-metric-label]:!tw-font-semibold [&_.rep-category-metric-label]:!tw-uppercase [&_.rep-category-metric-label]:!tw-tracking-normal [&_.rep-category-metric-label]:!tw-text-iron-500 sm:[&_.rep-category-metric-label]:!tw-text-xs sm:[&_.rep-category-metric-label]:!tw-tracking-wider
  ...
  [&_.rep-category-metrics]:!tw-grid-cols-2 [&_.rep-category-metrics]:!tw-gap-x-2 [&_.rep-category-metrics]:!tw-gap-y-4 min-[380px]:[&_.rep-category-metrics]:!tw-grid-cols-4 min-[380px]:[&_.rep-category-metrics]:!tw-gap-x-1 sm:[&_.rep-category-metrics]:!tw-gap-x-4 lg:[&_.rep-category-metrics]:!tw-gap-x-6 [&_.rep-category-overview]:!tw-gap-6
  ...
  [&_.rep-category-sort-row]:!tw-justify-start [&_.rep-category-sort]:tw-w-full sm:[&_.rep-category-sort]:tw-w-fit
...
function OverviewContent({ category }: { readonly category: string }) {
  ...
  return (
    <div className="rep-category-overview tw-flex tw-flex-col tw-gap-6">
      ...
      <div className="tw-pt-2 sm:tw-pt-6">
