...
export function AllTokensSelectedCard({
  ...
  return (
    <div
      ...
      className="tw-flex tw-w-full tw-flex-col tw-gap-3 tw-rounded-md tw-border-2 tw-border-green-600/50 tw-bg-green-950/20 tw-p-4 tw-transition-all tw-duration-200 tw-ease-in-out @md:tw-flex-row @md:tw-items-center"
    >
      ...
      <button
        ...
        className="tw-flex tw-w-full tw-items-center tw-justify-center tw-gap-2 tw-rounded-md tw-bg-green-600 tw-px-4 tw-py-2.5 tw-font-medium tw-text-white tw-transition-colors hover:tw-bg-green-700 focus:tw-outline-none focus:tw-ring-2 focus:tw-ring-green-500 focus:tw-ring-offset-2 focus:tw-ring-offset-iron-900 @md:tw-w-auto @md:tw-shrink-0"
      >
