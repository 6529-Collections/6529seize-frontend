        ...
        <LexicalComposer initialConfig={editorConfig}>
          <div>
                  ...
                  <ContentEditable
                    className={`${
                      viewType === CreateDropViewType.COMPACT
                        ...
                        : "editor-input-multi-liner tw-pr-3"
            ...
            {viewType === CreateDropViewType.FULL && (
              <div>
                {!drop?.parts.length && (
                  <div className="tw-text-xs tw-font-medium tw-text-iron-400">
                    <p className="tw-mb-0 tw-mt-1.5">
                      <>
                ...
                <div className="tw-flex tw-items-center tw-gap-x-6 tw-mt-2.5">
                  <button
                    onClick={onDropPart}
                    disabled={!canAddPart}
                    type="button"
                    aria-label="Break into storm"
                    className={`tw-group tw-p-0 tw-flex tw-items-center tw-justify-center tw-border-0 tw-bg-transparent tw-rounded-lg tw-ease-out tw-transition tw-duration-300 
                    ${
                      !canAddPart
                        ? "tw-cursor-default tw-text-iron-600"
