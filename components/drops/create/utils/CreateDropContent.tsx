          ...
          <div>
            <div className="tw-relative">
              ...
              <button
                ...
                className="tw-absolute tw-group tw-top-2 tw-right-3 tw-p-2.5 tw-flex tw-items-center tw-justify-center tw-border-0 tw-bg-transparent tw-rounded-lg tw-text-iron-300 hover:tw-text-primary-400 tw-ease-out tw-transition tw-duration-300"
              >
                <svg
              ...
              {viewType === CreateDropViewType.COMPACT && (
                /* TODO: DISABLED state text-color: tw-text-iron-600 */
                <button
                  type="button"
                  title="add storm"
                  aria-label="Add storm"
