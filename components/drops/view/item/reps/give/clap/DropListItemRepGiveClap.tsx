  ...
  return (
    <div className="tailwind-scope">
      <button
        disabled={!rep}
        id={`clap-${randomID}`}
        className={`${clapClasses} tw-flex-shrink-0 tw-relative tw-outline-1 tw-outline-transparent tw-bg-iron-900 tw-border tw-border-solid tw-border-iron-700 tw-transition tw-duration-300 tw-ease-out ${styles.clap}`}
        onClick={handleClick}
      >
        <span>
          <svg
