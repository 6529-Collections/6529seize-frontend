      ...
      >
        ...
        <div className="tw-fixed tw-inset-0 tw-overflow-y-auto">
          <div className="tw-flex tw-min-h-full tw-items-end tw-justify-center tw-p-4 tw-text-center sm:tw-items-center sm:tw-p-6">
            ...
            >
              <DialogPanel className="tw-relative tw-w-full tw-transform tw-rounded-xl tw-bg-iron-950 tw-p-6 tw-text-left tw-shadow-xl sm:tw-max-w-xl">
                <div className="tw-flex tw-justify-between">
                  <div className="tw-max-w-xl sm:tw-flex sm:tw-space-x-4">
                    <div>
                      <span className="tw-inline-flex tw-h-11 tw-w-11 tw-items-center tw-justify-center tw-rounded-xl tw-border tw-border-solid tw-border-red/10 tw-bg-red/10">
                        <svg
                          className="tw-h-6 tw-w-6 tw-flex-shrink-0 tw-text-red"
                          viewBox="0 0 24 24"
                          fill="none"
                          aria-hidden="true"
                        >
                          <path
                            d="M16 6V5.2C16 4.0799 16 3.51984 15.782 3.09202C15.5903 2.71569 15.2843 2.40973 14.908 2.21799C14.4802 2 13.9201 2 12.8 2H11.2C10.0799 2 9.51984 2 9.09202 2.21799C8.71569 2.40973 8.40973 2.71569 8.21799C8 3.51984 8 4.0799 8 5.2V6M10 11.5V16.5M14 11.5V16.5M3 6H21M19 6V17.2C19 18.8802 19 19.7202 18.673 20.362C18.3854 20.9265 17.9265 21.3854 17.362 21.673C16.7202 22 15.8802 22 14.2 22H9.8C8.11984 22 7.27976 22 6.63803 21.673C6.07354 21.3854 5.6146 21.3854 5.32698 20.362C5 19.7202 5 18.8802 5 17.2V6"
                            stroke="currentColor"
                            strokeWidth="2"
                            strokeLinecap="round"
                    ...
                    <div className="tw-mt-3 tw-flex tw-flex-col sm:tw-mt-0 sm:tw-max-w-sm">
                      <DialogTitle className="tw-mb-0 tw-text-lg tw-font-medium tw-text-iron-50">
                        Delete {contentType}
                      </DialogTitle>
                      <Description className="tw-mb-0 tw-mt-1 tw-text-sm tw-text-iron-400">
                  ...
                  <div className="tw-absolute tw-right-4 tw-top-4">
                    <button
                      ...
                      onClick={closeModal}
                      disabled={mutating}
                      className="tw-flex tw-size-11 tw-items-center tw-justify-center tw-rounded-full tw-border-0 tw-bg-iron-950 tw-p-2.5 tw-text-iron-400 tw-transition tw-duration-300 tw-ease-out focus-visible:tw-outline focus-visible:tw-outline-2 focus-visible:tw-outline-offset-2 focus-visible:tw-outline-primary-400 disabled:tw-cursor-not-allowed disabled:tw-opacity-50 desktop-hover:hover:tw-text-iron-50"
                    >
