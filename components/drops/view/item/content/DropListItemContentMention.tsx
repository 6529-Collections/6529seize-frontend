  ...
  return (
    <UserProfileTooltipWrapper user={user.mentioned_profile_id}>
      <Link
        ...
        className="tw-no-underline tw-font-medium tw-text-primary-400 desktop-hover:hover:tw-underline desktop-hover:hover:tw-text-primary-300 tw-transition tw-duration-300 tw-ease-out">
