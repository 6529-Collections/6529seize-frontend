  ...
  return (
    <div className="tw-pt-4 tw-gap-x-8 tw-flex tw-items-center">
      ...
      <button
        ...
        type="button"
        className="tw-text-iron-500 icon tw-px-0 tw-group tw-bg-transparent tw-border-0 tw-inline-flex tw-items-center tw-gap-x-2 tw-text-[0.8125rem] tw-leading-5 tw-font-normal tw-transition tw-ease-out tw-duration-300"
      >
        <>
          <svg
            className={`${
