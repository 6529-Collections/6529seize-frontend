...
export function MuseumLandingHero({
  ...
  return (
    <header className="tw-grid tw-gap-10 tw-border-b tw-border-solid tw-border-iron-800 tw-pb-12 md:tw-grid-cols-[minmax(0,0.8fr)_minmax(22rem,1.2fr)] md:tw-items-end md:tw-gap-14 md:tw-pb-16">
