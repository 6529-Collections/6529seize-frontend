...
export const WaveRollingWinners: React.FC<WaveRollingWinnersProps> = ({
  ...
  return (
    <div className="tw-space-y-2 tw-mt-2 tw-pb-4 tw-max-h-[calc(100vh-160px)] tw-pr-2 tw-overflow-y-auto tw-scrollbar-thin tw-scrollbar-thumb-iron-500 tw-scrollbar-track-iron-800 hover:tw-scrollbar-thumb-iron-300">
