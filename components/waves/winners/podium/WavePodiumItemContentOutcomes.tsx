...
> = ({ winner }) => {
  ...
  return (
    <>
      ...
      >
        <span className="tw-hidden tw-text-sm tw-font-medium tw-text-iron-300 md:tw-block">
          Outcome
        </span>
        <div className="tw-flex tw-items-center tw-gap-1.5">
          {!!nicOutcomes.length && (
            <div className="tw-flex tw-size-5 tw-items-center tw-justify-center tw-rounded-full tw-bg-[#A4C2DB]/10">
              <svg
          ...
          {!!repOutcomes.length && (
            <div className="tw-flex tw-size-5 tw-items-center tw-justify-center tw-rounded-full tw-bg-[#C3B5D9]/10">
              <svg
          ...
          {!!manualOutcomes.length && (
            <div className="tw-flex tw-size-5 tw-items-center tw-justify-center tw-rounded-full tw-bg-[#D4C5AA]/10">
              <svg
