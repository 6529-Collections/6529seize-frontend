        ...
        <div className="tw-flex tw-flex-col tw-items-center -tw-mb-6 tw-relative tw-z-10">
          ...
          >
            {winner.drop.author.pfp ? (
              <img
                ...
                alt=""
                className="tw-size-12 md:tw-size-14 tw-rounded-xl tw-ring-2 tw-ring-[#E8D48A] tw-object-cover tw-shadow-[0_0_20px_rgba(232,212,138,0.3)]"
              />
            ) : (
              <div className="tw-size-12 md:tw-size-14 tw-rounded-xl tw-ring-2 tw-ring-[#E8D48A] tw-shadow-[0_0_20px_rgba(232,212,138,0.3)] tw-bg-iron-900" />
            )}
          </Link>
          ...
          <div className="tw-absolute -tw-bottom-3 tw-inset-x-0 tw-flex tw-justify-center">
            <div className="tw-bg-iron-900/80 tw-backdrop-blur-sm tw-shadow-lg tw-px-3 tw-py-1 tw-rounded-full tw-flex tw-items-center tw-gap-1.5 tw-border tw-border-iron-700">
              <svg
                className="tw-w-3 md:tw-size-4 tw-text-[#E8D48A]"
                aria-hidden="true"
              ...
              <span className="tw-text-[#E8D48A] tw-font-medium tw-text-xs lg:tw-text-sm">
                1st
              </span>
            </div>
          </div>
        ...
        <div className="tw-relative tw-w-full">
          <div className="tw-h-[220px] tw-transition-all tw-duration-300 tw-ease-out tw-bg-gradient-to-b tw-from-iron-900/70 tw-via-iron-900/50 tw-to-transparent tw-backdrop-blur-xl tw-rounded-xl tw-border tw-border-iron-800/60 tw-flex tw-flex-col tw-items-center tw-justify-center tw-shadow-[0_4px_24px_rgba(0,0,0,0.2)] tw-relative tw-overflow-hidden group-hover:desktop-hover:tw-from-iron-900/75 group-hover:desktop-hover:tw-via-iron-900/55 group-hover:desktop-hover:tw-to-transparent group-hover:desktop-hover:tw-border-iron-700/70 group-hover:desktop-hover:tw-shadow-[0_0_48px_rgba(0,0,0,0.35)]">
            <div className="tw-absolute tw-inset-0">
              ...
              <div className="tw-absolute tw-inset-y-0 tw-right-0 tw-w-px tw-bg-gradient-to-b tw-from-[#E8D48A]/10 tw-via-[#E8D48A]/5 tw-to-transparent group-hover:desktop-hover:tw-via-[#E8D48A]/25" />
              <div className="tw-absolute tw-inset-y-0 tw-left-0 tw-w-px tw-bg-gradient-to-b tw-from-[#E8D48A]/10 tw-via-[#E8D48A]/5 tw-to-transparent group-hover:desktop-hover:tw-via-[#E8D48A]/25" />
            ...
            <Link
              href={`/${winner.drop.author.handle}`}
              onClick={(e) => e.stopPropagation()}
              className="tw-transition-all tw-no-underline tw-mb-2 tw-mt-2 sm:tw-mt-4 tw-relative tw-text-center desktop-hover:hover:tw-text-[#E8D48A] tw-group/link"
            >
              <span className="tw-text-sm sm:tw-text-base md:tw-text-xl tw-font-semibold tw-text-iron-200 desktop-hover:hover:tw-text-[#E8D48A] tw-transition-colors tw-inline-flex tw-items-center">
                ...
                <svg
                  ...
                  strokeWidth="1.5"
                  stroke="currentColor"
                  className="tw-size-3 tw-opacity-0 tw-transition-opacity tw-text-[#E8D48A] tw-ml-2 desktop-hover:group-hover/link:tw-opacity-100 tw-absolute tw-left-[100%]"
                >
                  <path
                    strokeLinecap="round"
            ...
            <div className="tw-flex tw-flex-col tw-items-center tw-gap-y-2 tw-relative">
              <div className="tw-flex tw-items-center tw-gap-x-1">
                <span
                  className={`${
                    winner.drop.rating >= 0 ? "tw-text-[#E8D48A]" : "tw-text-[#ff4466]"
                  } tw-font-semibold tw-text-sm sm:tw-text-base md:tw-text-2xl`}
                >
