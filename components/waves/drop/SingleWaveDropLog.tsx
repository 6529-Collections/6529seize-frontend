        ...
        <div className="tw-flex tw-gap-3">
          ...
          <div className="tw-flex tw-flex-col tw-flex-1 tw-min-w-0">
            ...
            <div className="tw-flex tw-items-center tw-justify-between tw-gap-2">
              ...
              >
                <span className="tw-text-sm tw-font-medium tw-text-iron-50 desktop-hover:group-hover:tw-text-iron-300">
                  {log.invoker.handle}
                </span>
              </Link>
          ...
          <div className="tw-flex tw-items-center tw-gap-x-2 tw-gap-y-2">
            {log.invoker.pfp ? (
              <img
                src={log.invoker.pfp}
                alt=""
                className="tw-size-6 tw-rounded-md tw-ring-1 tw-ring-white/10 tw-bg-iron-800 tw-flex-shrink-0 tw-object-contain"
              />
            ) : (
