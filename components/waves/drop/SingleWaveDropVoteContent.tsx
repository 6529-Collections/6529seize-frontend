...
export const SingleWaveDropVoteContent: React.FC<SingleWaveDropVoteContentProps> = ({
  ...
  return (
    <div
      className="tw-@container tw-flex tw-flex-col tw-gap-4 tw-p-4 md:tw-p-5 tw-rounded-xl tw-bg-iron-800 tw-shadow tw-backdrop-blur-lg tw-border tw-border-iron-700 tw-border-solid tw-relative"
      onClick={(e) => e.stopPropagation()}
    >
