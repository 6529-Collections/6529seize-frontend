...
export const SingleWaveDropVoter: React.FC<SingleWaveDropVoterProps> = ({
  ...
  return (
    <div className="tw-p-3 tw-flex tw-items-center tw-justify-between hover:tw-bg-white/[0.02] tw-rounded-md tw-transition-colors">
      ...
      <div className="tw-flex tw-items-center tw-gap-3 tw-whitespace-nowrap">
        ...
        <span className="tw-text-xs tw-text-iron-600 tw-font-mono tw-tabular-nums">
          {formatNumberWithCommas(voter.absolute_votes_summed)} {WAVE_VOTING_LABELS[creditType]} {WAVE_VOTE_STATS_LABELS.TOTAL}
        </span>
      </div>
    </div>
  );
