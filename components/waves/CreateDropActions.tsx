      ...
      <LayoutGroup>
        ...
        {showGifPicker && (
          <>
            ...
            {/* Popup */}
            <div className="tw-fixed tw-z-50 tw-top-1/2 tw-left-1/2 tw-transform -tw-translate-x-1/2 -tw-translate-y-1/2 tw-bg-white tw-rounded-lg tw-shadow-lg tw-max-h-[90vh] tw-max-w-[90vw] tw-overflow-auto">
              <GifPicker
                tenorApiKey="AIzaSyAbU3KZuMmbnACzxfExwriO4hrxI5Nau1I"
                theme={Theme.DARK}
                height={isMobile ? 250 : 400}
                onGifClick={(gif) => {
                  onGifDrop(gif.shortTenorUrl);
                  setShowGifPicker(false);
                }}
              />
            </div>
