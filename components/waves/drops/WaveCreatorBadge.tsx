    ...
    <>
      <button
        ...
        className="tw-w-6 tw-h-6 md:tw-w-5 md:tw-h-5 tw-outline-none tw-ring-0 tw-inline-flex tw-items-center tw-justify-center
         tw-rounded-md tw-border tw-border-solid tw-border-blue-400/20
          tw-bg-blue-400/10 tw-text-blue-300 tw-text-xs
          tw-shadow-[inset_0_0_2px_rgba(255,255,255,0.08),0_1px_4px_rgba(0,0,0,0.25)]
          tw-transition-all tw-duration-200
          desktop-hover:hover:tw-border-blue-400/30
          desktop-hover:hover:tw-bg-blue-900/30
          ...
          focus:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-blue-400/50 focus-visible:tw-ring-offset-2"
        aria-label="View created waves"
        {...(dataTooltipId && { "data-tooltip-id": dataTooltipId })}
      >
        <FontAwesomeIcon
          icon={faWater}
          className="tw-w-3 tw-h-3 md:tw-w-2.5 md:tw-h-2.5 tw-text-blue-400 tw-flex-shrink-0
          desktop-hover:hover:tw-text-blue-300/90"
        />
      </button>
      {!isMobile && (
        <Tooltip
