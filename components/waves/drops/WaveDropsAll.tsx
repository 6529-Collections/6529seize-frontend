...
export default function WaveDropsAll({
  ...
  return (
    <div className="tw-flex tw-flex-col tw-h-full tw-justify-end tw-relative tw-overflow-y-auto tw-bg-iron-950 tw-border tw-border-solid tw-border-iron-800 tw-border-x-0 tw-border-t tw-border-b-0">
      {renderContent()}
