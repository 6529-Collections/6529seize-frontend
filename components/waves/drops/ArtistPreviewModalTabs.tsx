...
export const ArtistPreviewModalTabs: React.FC<ArtistPreviewModalTabsProps> = ({
  ...
  return (
    <div className="tw-px-6 tw-mt-4 tw-inline-flex tw-relative">
      <div
        className="
  ...
  "
      >
        <button
          ...
          className={`tw-px-2.5 tw-py-1.5 tw-border-0 tw-rounded-md tw-transition tw-duration-300 ${
            activeTab === "active"
        ...
        <button
          ...
          className={`tw-px-2.5 tw-py-1.5 tw-border-0 tw-rounded-md tw-transition-all tw-duration-300 ${
            activeTab === "winners"
              ? `
                tw-bg-[#3F3A31]
                tw-text-[#EADFBF]
