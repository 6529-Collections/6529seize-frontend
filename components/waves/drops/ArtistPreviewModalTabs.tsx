...
export const ArtistPreviewModalTabs: React.FC<ArtistPreviewModalTabsProps> = ({
  ...
  return (
    <div className="tw-px-6 tw-mt-4 tw-inline-flex tw-relative tw-w-full sm:tw-w-auto">
      <div
        className="
    tw-flex tw-items-center tw-h-10 sm:tw-h-9 tw-px-1 tw-text-xs tw-whitespace-nowrap
  ...
  "
      >
        <button
          ...
          className={`tw-px-2.5 tw-py-1.5 tw-text-sm sm:tw-text-xs tw-border-0 tw-rounded-md tw-transition tw-duration-300 tw-flex-1 ${
            activeTab === "active"
        ...
        <button
          ...
          className={`tw-px-2.5 tw-py-1.5 tw-text-sm sm:tw-text-xs tw-border-0 tw-rounded-md tw-transition-all tw-duration-300 tw-flex-1 ${
            activeTab === "winners"
              ? `
                tw-bg-[#3F3A31]
                tw-text-[#EADFBF]
