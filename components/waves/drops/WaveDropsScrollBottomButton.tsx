...
> = ({ isAtBottom, scrollToBottom }) => {
  ...
  return (
    <button
      ...
      className="tw-shrink-0 tw-border tw-border-solid tw-border-iron-700 tw-absolute tw-z-[99] tw-bottom-3 tw-right-2 lg:tw-right-6 tw-bg-iron-700 tw-text-iron-300 tw-rounded-full tw-size-10 
    ...
    >
      <svg
        className="tw-shrink-0 tw-size-4"
        fill="none"
        stroke="currentColor"
        viewBox="0 0 24 24"
