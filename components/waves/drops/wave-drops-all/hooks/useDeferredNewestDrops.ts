...
interface UseDeferredNewestDropsProps {
  ...
  readonly revealThroughSerialNo?: number | null | undefined;
}
...
const getDeferredNewestDropsNextSession = ({
  ...
  nextSession = {
    ...
    revealedLatestSerial: maxSerialNoOrNull(
