      ...
      <div className="tw-mt-3 tw-px-4">
        <div className="tw-flex tw-items-start tw-justify-center tw-gap-x-4">
          <div className="lg:tw-h-[calc(100vh-7rem)] tw-overflow-y-auto no-scrollbar lg:tw-max-w-[20.5rem] tw-w-full">
            <div className="tw-flex tw-flex-1 tw-flex-col tw-gap-y-4">
              <WaveHeader
                wave={wave}
              ...
              <button
                ...
                type="button"
                className="tw-w-full tw-flex tw-justify-between tw-items-center tw-text-iron-300 tw-font-medium tw-py-3 tw-px-5 tw-rounded-xl tw-bg-iron-950 hover:tw-bg-iron-800 tw-transition-colors tw-duration-200 tw-border-0 tw-ring-1 tw-ring-inset tw-ring-iron-800"
                aria-expanded={isExpanded}
              >
                <span className="tw-text-sm">Wave Info</span>
                <svg
                  className={`tw-size-5 tw-text-iron-400 tw-transition-transform tw-duration-300 ${
