    ...
    <div className="tailwind-scope tw-bg-iron-950 tw-min-h-screen">
      ...
      <div className="tw-mt-12 tw-pb-16 lg:tw-pb-20 tw-max-w-5xl tw-mx-auto">
        <div className="tw-flex tw-items-start tw-justify-center tw-gap-x-6">
          ...
          <div className="tw-w-[672px] tw-space-y-4 tw-rounded-xl tw-overflow-hidden tw-border tw-border-solid tw-border-iron-700 tw-pt-4 sm:tw-pt-5 tw-divide-y tw-divide-solid tw-divide-iron-700 tw-divide-x-0">
