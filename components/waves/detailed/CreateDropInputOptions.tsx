...
const CreateDropInputOptions: React.FC<CreateDropInputOptionsProps> = ({
  ...
  return (
    <div className="tw-absolute tw-top-0.5 tw-right-2">
      <div ref={dropdownRef} className="tw-relative">
        <button
          className={`tw-flex tw-items-center tw-justify-center tw-p-2 tw-group tw-rounded-lg tw-border-none tw-bg-transparent tw-ease-out tw-transition tw-duration-300 ${
            ...
            submitting ? "tw-opacity-50 tw-cursor-default" : "tw-cursor-pointer"
          }`}
        ...
        <AnimatePresence>
          {isDropdownOpen && (
            <motion.div
              ...
              className="tw-absolute tw-right-0 tw-bottom-full tw-mb-2 tw-z-10 tw-w-40 tw-origin-bottom-right tw-rounded-lg tw-bg-iron-950 tw-py-2 tw-px-1 tw-shadow-lg tw-ring-1 tw-ring-white/10 tw-focus:tw-outline-none tw-space-y-1"
            >
              <button
