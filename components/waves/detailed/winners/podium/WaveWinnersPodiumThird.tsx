  ...
  return (
    <div className="tw-flex tw-flex-col tw-items-center -tw-mx-3">
      ...
      <div className="tw-relative tw-w-full">
        <div className="tw-h-[160px] tw-bg-iron-900/80 tw-backdrop-blur-xl tw-rounded-2xl tw-border tw-border-iron-800 tw-flex tw-flex-col tw-items-center tw-justify-center tw-shadow-[0_8px_32px_rgba(0,0,0,0.2)]">
          <Link
            href={`/${drop.author.handle}`}
            className="tw-group hover:tw-opacity-80 tw-transition-all tw-no-underline tw-mb-3"
          >
            <div className="tw-text-base tw-font-semibold tw-text-white group-hover:tw-text-[#CD7F32] tw-transition-colors">
              {drop.author.handle}
            </div>
          </Link>
