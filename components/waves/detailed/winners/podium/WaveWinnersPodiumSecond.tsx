    ...
    <div className="tw-flex tw-flex-col tw-items-center">
      <div className="tw-flex tw-flex-col tw-items-center tw-gap-3 tw-mb-4">
        ...
        >
          {drop.author.pfp ? (
            ...
            <div className="tw-size-8 tw-rounded-lg tw-ring-1 tw-ring-silver-400/30 tw-object-cover tw-bg-iron-900" />
          )}
      ...
      <div className="tw-mt-2 tw-relative tw-w-full">
        <div className="tw-absolute tw-z-[1] tw-inset-x-0 -tw-top-3 tw-flex tw-justify-center">
          <div className="tw-shadow-[0_8px_24px_rgba(221,221,221,0.1)] tw-ring-1 tw-bg-gradient-to-b tw-from-[#dddddd]/15 tw-to-iron-900/80 tw-ring-[#dddddd]/20 tw-rounded-xl tw-px-3 tw-py-1.5 tw-text-[#dddddd] tw-font-medium tw-text-sm tw-flex tw-items-center tw-gap-x-2 hover:tw-from-[#dddddd]/20 hover:tw-ring-[#dddddd]/30 tw-transition-all tw-duration-300">
            <svg
