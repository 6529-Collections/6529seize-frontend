    ...
    <div onClick={() => onDropClick(drop)} className="tw-cursor-pointer tw-group">
      <div className="tw-flex tw-flex-col tw-items-center">
        <div className="tw-flex tw-flex-col tw-items-center -tw-mb-2 tw-relative tw-z-10">
          ...
          >
            {drop.author.pfp ? (
              <img
                ...
                alt=""
                className="tw-size-11 tw-rounded-xl tw-ring-2 tw-ring-[#dddddd] tw-object-cover tw-shadow-[0_0_20px_rgba(148,163,184,0.3)]"
              />
            ) : (
              <div className="tw-size-11 tw-rounded-xl tw-ring-2 tw-ring-[#dddddd] tw-shadow-[0_0_20px_rgba(148,163,184,0.3)] tw-bg-iron-900" />
            )}
          </Link>
          ...
          <div className="tw-absolute -tw-bottom-4 tw-inset-x-0 tw-flex tw-justify-center">
            <div className="tw-bg-iron-900/80 tw-backdrop-blur-sm tw-shadow-lg tw-px-2.5 tw-py-0.5 tw-rounded-full tw-flex tw-items-center tw-gap-1.5 tw-border tw-border-iron-700">
              <svg
                className="tw-w-3.5 tw-h-3.5 tw-text-[#dddddd]"
                aria-hidden="true"
              ...
              <span className="tw-text-[#dddddd] tw-font-medium tw-text-sm">
                2nd
              </span>
            </div>
          </div>
        ...
        <div className="tw-relative tw-w-full">
          <div className="tw-h-[190px] tw-transition-all tw-duration-300 tw-ease-out tw-bg-gradient-to-b tw-from-iron-900/70 tw-via-iron-900/50 tw-to-transparent tw-backdrop-blur-xl tw-rounded-xl tw-border tw-border-iron-800/60 tw-flex tw-flex-col tw-items-center tw-justify-center tw-shadow-[0_4px_24px_rgba(0,0,0,0.2)] tw-relative tw-overflow-hidden group-hover:desktop-hover:tw-from-iron-900/75 group-hover:desktop-hover:tw-via-iron-900/55 group-hover:desktop-hover:tw-to-transparent group-hover:desktop-hover:tw-border-iron-700/70 group-hover:desktop-hover:tw-shadow-[0_0_48px_rgba(0,0,0,0.35)]">
            <div className="tw-absolute tw-inset-0">
              <div className="tw-absolute tw-inset-0 tw-bg-gradient-to-b tw-from-[#dddddd]/5 tw-via-[#dddddd]/3 tw-to-transparent group-hover:desktop-hover:tw-from-[#dddddd]/[0.07]" />
              <div className="tw-absolute tw-inset-x-0 tw-top-0 tw-h-px tw-bg-gradient-to-r tw-from-transparent tw-via-[#dddddd]/10 tw-to-transparent group-hover:desktop-hover:tw-via-[#dddddd]/25" />
              <div className="tw-absolute tw-inset-y-0 tw-right-0 tw-w-px tw-bg-gradient-to-b tw-from-[#dddddd]/10 tw-via-[#dddddd]/5 tw-to-transparent group-hover:desktop-hover:tw-via-[#dddddd]/25" />
              <div className="tw-absolute tw-inset-y-0 tw-left-0 tw-w-px tw-bg-gradient-to-b tw-from-[#dddddd]/10 tw-via-[#dddddd]/5 tw-to-transparent group-hover:desktop-hover:tw-via-[#dddddd]/25" />
            ...
            >
              <div className="tw-text-base tw-font-semibold tw-text-iron-200 hover:tw-text-[#dddddd] tw-transition-colors">
                {drop.author.handle}
              </div>
            </Link>
