        ...
        <div className="tw-flex tw-flex-col tw-items-center -tw-mb-2 tw-relative tw-z-10">
          ...
          >
            {drop.author.pfp ? (
              ...
              <div className="tw-size-9 md:tw-size-11 tw-rounded-xl tw-ring-2 tw-ring-[#dddddd] tw-shadow-[0_0_20px_rgba(148,163,184,0.3)] tw-bg-iron-900" />
            )}
          </Link>
          ...
          <div className="tw-absolute -tw-bottom-4 tw-inset-x-0 tw-flex tw-justify-center">
            <div className="tw-bg-iron-900/80 tw-backdrop-blur-sm tw-shadow-lg tw-px-2.5 tw-py-0.5 tw-rounded-full tw-flex tw-items-center tw-gap-1.5 tw-border tw-border-iron-700">
              <svg
                className="tw-w-3 md:tw-size-4 tw-text-[#dddddd]"
                aria-hidden="true"
              ...
              <span className="tw-text-[#dddddd] tw-font-medium tw-text-xs md:tw-text-sm">
                2nd
              </span>
            </div>
          </div>
            ...
            >
              <span className="tw-text-sm sm:tw-text-base tw-font-semibold tw-text-iron-200 desktop-hover:hover:tw-text-[#dddddd] tw-transition-colors tw-inline-flex tw-items-center">
                ...
                <svg
                  ...
                  strokeWidth="1.5"
                  stroke="currentColor"
                  className="tw-size-3 tw-opacity-0 tw-transition-opacity tw-text-[#dddddd] tw-ml-2 desktop-hover:group-hover/link:tw-opacity-100 tw-absolute tw-left-[100%]"
                >
                  <path
                    strokeLinecap="round"
