...
export const WaveWinnersPodiumSecond: React.FC<
    ...
    <div onClick={() => onDropClick(drop)} className="tw-cursor-pointer tw-group">
      <div className="tw-flex tw-flex-col tw-items-center -tw-mx-3">
          ...
          >
            {drop.author.pfp ? (
              <img
                ...
                alt=""
                className="tw-size-12 tw-rounded-xl tw-ring-2 tw-ring-[#DDDDDD] tw-object-cover tw-shadow-[0_0_20px_rgba(221,221,221,0.3)]"
              />
            ) : (
              <div className="tw-size-12 tw-rounded-xl tw-ring-2 tw-ring-[#DDDDDD] tw-shadow-[0_0_20px_rgba(221,221,221,0.3)] tw-bg-iron-900" />
            )}
          </Link>
        ...
        <div className="tw-relative tw-w-full">
          <div className="tw-h-[180px] group-hover:desktop-hover:hover:tw-bg-iron-900 tw-transition-all tw-duration-300 tw-ease-out tw-bg-iron-900/80 tw-backdrop-blur-xl tw-rounded-2xl tw-border tw-border-iron-800 tw-flex tw-flex-col tw-items-center tw-justify-center tw-shadow-[0_8px_32px_rgba(0,0,0,0.2)]">
            <Link
              href={`/${drop.author.handle}`}
              onClick={(e) => e.stopPropagation()}
              className="tw-transition-all tw-no-underline tw-mb-3"
            >
              <div className="tw-text-base tw-font-semibold tw-text-[#DDDDDD] hover:tw-text-[#DDDDDD]/80 tw-transition-colors">
                {drop.author.handle}
              </div>
            </Link>
