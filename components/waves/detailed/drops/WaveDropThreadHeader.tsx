...
interface WaveDropThreadHeaderProps {
  readonly rootDropId: string;
}

const WaveDropThreadHeader: React.FC<WaveDropThreadHeaderProps> = ({
  rootDropId,
}) => {
  const {
    data: drop,
  ...
  if (isFetching && !isRefetching) {
    return (
      <div className="tw-bg-iron-900 tw-px-4 tw-py-4 tw-mb-2">
        <div className="tw-mb-2 tw-bg-iron-700 tw-h-14 tw-w-14 tw-flex tw-justify-center tw-items-center tw-rounded-full tw-animate-pulse" />
        <div className="tw-h-6 tw-bg-iron-700 tw-rounded tw-w-3/4 tw-mb-2 tw-animate-pulse" />
        <div className="tw-h-4 tw-bg-iron-700 tw-rounded tw-w-1/2 tw-mb-1 tw-animate-pulse" />
        <div className="tw-h-3 tw-bg-iron-700 tw-rounded tw-w-1/4 tw-animate-pulse" />
      </div>
    );
  }
  ...
  return (
    <div className="tw-bg-iron-900 tw-px-4 tw-py-4 tw-mb-2">
      <div className="tw-mb-2 tw-rounded-xl tw-size-10 lg:tw-size-14 tw-bg-gradient-to-b tw-p-[1px] tw-from-iron-700 tw-via-indigo-300/40 tw-to-iron-700">
        <div className="tw-bg-iron-900 tw-h-full tw-flex tw-justify-center tw-items-center tw-rounded-xl">
          <svg
            className="tw-size-4 lg:tw-size-6 tw-flex-shrink-0 tw-inline tw-text-indigo-300"
            viewBox="0 0 56 56"
            fill="none"
      ...
      <p className="tw-text-sm tw-text-iron-400 tw-mn-0">
        Started by{" "}
        <Link href={`/${drop.author.handle}`} className="tw-no-underline">
...
export default WaveDropThreadHeader;
