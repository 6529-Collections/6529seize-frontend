...
const getColorClasses = ({
  ...
  if (rank === 1) {
    return "tw-bg-[linear-gradient(90deg,rgba(31,31,37,0.6)_3.5%,rgba(45,40,35,0.75)_100%)] tw-border tw-border-solid tw-border-[#D9A962]/20 tw-shadow-[inset_0_0_12px_rgba(217,169,98,0.05)]";
  }
  if (rank === 2) {
    return "tw-bg-[linear-gradient(90deg,rgba(31,31,37,0.8)_3.5%,rgba(35,35,36,0.9)_100%)] tw-border tw-border-solid tw-border-[#DDDDDD]/20 tw-shadow-[inset_0_0_16px_rgba(221,221,221,0.08)]";
  }
  if (rank === 3) {
    return "tw-bg-[linear-gradient(90deg,rgba(31,31,37,0.6)_3.5%,rgba(45,40,35,0.75)_100%)] tw-border tw-border-solid tw-border-[#D9A962]/20 tw-shadow-[inset_0_0_12px_rgba(217,169,98,0.05)]";
  }
