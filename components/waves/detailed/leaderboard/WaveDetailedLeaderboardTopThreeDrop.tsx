  ...
  return (
    <div>
      ...
      <div className="tw-space-y-3">
        {/*  1 RANK: tw-bg-gradient-to-b tw-from-[#E8D48A]/10 tw-to-iron-900 */}
        {/*  2 RANK: tw-bg-gradient-to-b tw-from-[#DDDDDD]/10 tw-to-iron-900 */}
        {/*  3 RANK: tw-bg-gradient-to-b tw-from-[#D9A962]/10 tw-to-iron-900 */}
        <li className="tw-relative tw-flex tw-flex-col tw-rounded-xl tw-bg-gradient-to-b tw-from-[#E8D48A]/10 tw-to-iron-900 tw-p-[1px]">
            ...
            <div className="tw-flex tw-items-start tw-gap-x-3">
              ...
              <div className="tw-flex-1">
                <div className="tw-flex tw-justify-between tw-items-center">
                  <div className="tw-flex tw-items-center tw-gap-x-2">
                    {/*  1 RANK: tw-ring-[#E8D48A]/80 */}
                    {/*  2 RANK: tw-ring-[#DDDDDD]/80 */}
                    {/*  3 RANK: tw-ring-[#D9A962]/80 */}
                    <img
                      className="tw-size-6 tw-flex-shrink-0 tw-rounded-lg tw-bg-iron-800 tw-ring-1 tw-ring-[#E8D48A]/80"
                    ...
                    <div className="tw-relative">
                      ...
                      <div className="tw-absolute -tw-top-1 -tw-right-0.5 tw-size-2 tw-bg-[#3CCB7F] tw-rounded-full"></div>
                    </div>
                  </div>

                  {/*  1 RANK: tw-text-[#E8D48A]*/}
                  {/*  2 RANK: tw-text-[#DDDDDD] */}
                  {/*  3 RANK: tw-text-[#D9A962] */}
                  <div className="tw-text-[#E8D48A] tw-flex tw-items-center tw-gap-x-1.5">
                    <svg
                    ...
                    <span className="tw-text-xs tw-font-medium ">56</span>
                  </div>
                </div>
                <div className="tw-mt-3 tw-mb-4">
                  <div className="tw-relative tw-max-h-52 tw-overflow-hidden">
                    <img
                      ...
                      alt=""
                      className="tw-w-full tw-h-32 tw-object-cover tw-rounded-lg tw-mb-3"
                    />
                    <p className="tw-text-iron-200 tw-text-sm tw-leading-relaxed tw-line-clamp-3 tw-mb-0">
                      Building scalable solutions for next-generation web
                      applications with focus on performance and user
                      experience.
                    </p>
                    <div className="tw-absolute tw-bottom-0 tw-left-0 tw-right-0 tw-h-12 tw-bg-gradient-to-t tw-from-iron-900 tw-via-iron-900/50 tw-to-transparent"></div>
                  </div>
