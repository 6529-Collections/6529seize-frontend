...
export const WaveLeaderboardSort: React.FC<WaveLeaderboardSortProps> = ({
  ...
  return (
    <div className="tw-flex tw-items-center  tw-rounded-lg tw-gap-x-2">
      <button
        onClick={() => setSort(WaveLeaderboardSortType.RANK)}
        className={`tw-border tw-border-solid tw-px-3 tw-py-1.5 tw-text-sm tw-font-medium tw-rounded-lg tw-transition-all tw-duration-300 tw-ease-out ${
