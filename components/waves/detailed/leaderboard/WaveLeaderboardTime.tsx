...
export const WaveLeaderboardTime: React.FC<WaveLeaderboardTimeProps> = ({
  ...
  return (
    <div className="tw-mt-4 tw-grid tw-grid-cols-1 md:tw-grid-cols-2 tw-gap-4">
      {/* Dropping Phase Card */}
      <div className="tw-rounded-xl tw-bg-gradient-to-br tw-from-[#1E1E2E]/80 tw-via-[#2E2E3E]/60 tw-to-[#3E2E3E]/40 tw-p-3 md:tw-p-6 tw-backdrop-blur-sm tw-border tw-border-[#3E2E3E]/20">
        ...
        {droppingTimeState !== WaveLeaderboardTimeState.COMPLETED ? (
          <div className="tw-grid tw-grid-cols-4 tw-gap-2">
            <div className="tw-@container tw-group tw-bg-gradient-to-br tw-from-primary-300/5 tw-to-primary-400/5 tw-backdrop-blur-sm tw-px-1.5 md:tw-px-3 tw-py-1 md:tw-py-2 tw-rounded-lg tw-border tw-border-primary-300/10 tw-whitespace-nowrap">
              <span className="tw-text-base md:tw-text-xl [@container]:tw-text-xl [@container_(max-width:50px)]:tw-text-base tw-font-medium tw-text-white/90 tw-tracking-tight tw-inline-block tw-text-center">
