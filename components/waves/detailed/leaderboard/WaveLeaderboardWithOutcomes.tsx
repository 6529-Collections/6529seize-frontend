...
import { faTrophy, faUsers, faDatabase } from '@fortawesome/free-solid-svg-icons';
...
const mockData: LeaderboardWithOutcomes = {
  entries: [
    { rank: 1, handle: 'CryptoKING', score: 20, avatarUrl: 'https://example.com/avatar1.jpg' },
    { rank: 2, handle: 'BlockchainQueen', score: 19, avatarUrl: 'https://example.com/avatar2.jpg' },
    { rank: 3, handle: 'TokenMaster', score: 15, avatarUrl: 'https://example.com/avatar3.jpg' },
    { rank: 4, handle: 'Web3Wizard', score: 13, avatarUrl: 'https://example.com/avatar4.jpg' },
  ],
  outcomes: [
    { category: 'Rep Category', icon: faTrophy, value: '2M Rep', prize: '23' },
    { category: 'Manual stuff', icon: faUsers, value: 'Manual stuff', prize: '999k' },
  ...
  return (
    <div className="tw-overflow-hidden tw-rounded-xl tw-bg-iron-950">
      <div className="tw-p-4 tw-bg-iron-900">
        <h2 className="tw-text-lg tw-font-semibold tw-text-iron-50">Leaderboard & Outcomes</h2>
      </div>
        ...
        {entries.map((entry, index) => (
          <div
            ...
            className={`tw-flex tw-items-center tw-gap-4 tw-py-3 tw-px-4 ${
              index < 3 ? `tw-bg-gradient-to-r tw-from-iron-900 tw-to-[${getMedalColor(index)}]/[0.07]` : ''
            }`}
          >
            <div className="tw-flex tw-items-center tw-gap-2">
              ...
              />
              <div className="tw-font-medium tw-text-sm tw-text-iron-50">{entry.handle}</div>
            </div>
            <div className="tw-ml-auto tw-flex tw-items-center tw-gap-2">
              <div className={`tw-text-sm ${index < 3 ? 'tw-text-white' : 'tw-text-iron-300'}`}>
                {entry.score}
              </div>
              {index < outcomes.length && (
                <div className="tw-flex tw-items-center tw-gap-1 tw-text-xs tw-text-iron-400">
                  <FontAwesomeIcon icon={outcomes[index].icon} className="tw-w-3 tw-h-3" />
      ...
      <div className="tw-p-4 tw-bg-iron-900">
        <div className="tw-flex tw-justify-between tw-items-center tw-mb-2">
          <div className="tw-text-sm tw-font-medium tw-text-iron-300">Threshold</div>
