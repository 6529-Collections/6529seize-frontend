...
> = ({ wave, onDropClick }) => {
  ...
  return (
    <div className="tw-px-2 lg:tw-p-4 tw-overflow-y-auto tw-scrollbar-thin tw-scrollbar-thumb-iron-500 tw-scrollbar-track-iron-800 hover:tw-scrollbar-thumb-iron-300">
