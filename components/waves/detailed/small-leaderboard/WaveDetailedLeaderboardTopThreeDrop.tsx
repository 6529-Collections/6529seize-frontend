...
> = ({ drop, wave, onDropClick }) => {
  ...
  const thropyIcon = (rank: number | null) => {
    if (rank === 1) {
      return (
        <div className="tw-shadow-lg tw-ring-1 tw-bg-gradient-to-b tw-to-iron-900 tw-from-[#E8D48A]/30 tw-ring-[#E8D48A]/30 tw-rounded-lg tw-py-1 tw-px-2 tw-text-[#E8D48A] tw-font-semibold tw-text-xs tw-inline-flex tw-items-center tw-gap-x-2">
          <svg
    ...
    if (rank === 2) {
      return (
        <div className="tw-shadow-lg tw-ring-1 tw-bg-gradient-to-b tw-to-iron-900 tw-from-[#dddddd]/20 tw-ring-[#dddddd]/30 tw-rounded-lg tw-py-1 tw-px-2 tw-text-[#DDDDDD] tw-font-semibold tw-text-xs tw-inline-flex tw-items-center tw-gap-x-2">
          <svg
    ...
    if (rank === 3) {
      return (
        <div className="tw-shadow-lg tw-ring-1 tw-bg-gradient-to-b tw-to-iron-900 tw-from-[#CD7F32]/20 tw-ring-[#CD7F32]/30 tw-rounded-lg tw-py-1 tw-px-2 tw-text-[#CD7F32] tw-font-semibold tw-text-xs tw-inline-flex tw-items-center tw-gap-x-2">
          <svg
