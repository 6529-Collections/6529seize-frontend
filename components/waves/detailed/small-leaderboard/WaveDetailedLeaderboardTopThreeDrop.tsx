...
> = ({ drop, wave, onDropClick }) => {
  ...
  const thropyIcon = (rank: number | null) => {
    if (rank === 1) {
      return (
        <div className="tw-shadow-lg tw-ring-1 tw-ring-[#E8D48A]/30 tw-bg-[#E8D48A]/10 tw-rounded-lg tw-py-1 tw-px-2 tw-h-6 tw-min-w-6 tw-text-[#E8D48A] tw-font-semibold tw-text-sm tw-inline-flex tw-items-center tw-gap-x-2">
          <svg
    ...
    if (rank === 2) {
      return (
        <div className="tw-shadow-lg tw-ring-1 tw-ring-[#DDDDDD]/30 tw-bg-[#DDDDDD]/10 tw-rounded-lg tw-py-1 tw-px-2 tw-h-6 tw-min-w-6 tw-text-[#DDDDDD] tw-font-semibold tw-text-sm tw-inline-flex tw-items-center tw-gap-x-2">
          <svg
    ...
    if (rank === 3) {
      return (
        <div className="tw-shadow-lg tw-ring-1 tw-ring-[#CD7F32]/30 tw-bg-[#B87333]/10 tw-rounded-lg tw-py-1 tw-px-2 tw-h-6 tw-min-w-6 tw-text-[#CD7F32] tw-font-semibold tw-text-sm tw-inline-flex tw-items-center tw-gap-x-2">
          <svg
