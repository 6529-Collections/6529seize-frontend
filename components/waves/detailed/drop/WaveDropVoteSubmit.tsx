...
export interface WaveDropVoteSubmitHandles {
...
const WaveDropVoteSubmit = forwardRef<WaveDropVoteSubmitHandles, Props>(
      ...
      <div className="tailwind-scope">
        <div className={`vote-button-container-${randomID} tw-relative`}>
          <button
            ...
            onClick={handleClick}
            disabled={
              isProcessing || newRating === drop.context_profile_context?.rating
            }
            type="button"
...
WaveDropVoteSubmit.displayName = "WaveDropVoteSubmit";

export default WaveDropVoteSubmit;
