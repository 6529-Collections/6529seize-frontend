                ...
                <div className="tw-flex tw-flex-col tw-gap-3">
                  <div className="tw-relative">
                    ...
                    <div className="tw-h-1 tw-bg-iron-800/50 tw-rounded-full">
                      <div className="tw-h-full tw-w-[35%] tw-bg-gradient-to-r tw-from-emerald-700 tw-to-emerald-600 tw-rounded-full" />
                    </div>
                  </div>

                  {/* Time Remaining Row */}
                  {/*  <div className="tw-flex tw-items-center tw-justify-between tw-p-3 tw-rounded-lg tw-bg-iron-900/40 tw-backdrop-blur-sm">
                    <span className="tw-text-xs tw-text-iron-400">
                      Time Remaining
                    </span>
                    <div className="tw-flex tw-items-center tw-gap-2">
                    ...
                    <div className="tw-flex tw-justify-between tw-items-center">
                      <div className="tw-flex tw-items-center tw-gap-4">
                        ...
                        <div className="tw-flex tw-items-center tw-gap-x-2">
                          <button className="tw-border-0 tw-flex tw-items-center tw-justify-center tw-size-9 tw-rounded-xl tw-bg-iron-900/80 tw-ring-1 tw-ring-iron-700/50 hover:tw-ring-iron-600/50 tw-text-iron-300 hover:tw-text-iron-200 tw-transition-all tw-duration-300">
                            <svg
                      ...
                      <svg
                        className="tw-size-5 -tw-mt-0.5 tw-text-green"
                  ...
                  <div className="tw-flex tw-items-center tw-gap-x-4 tw-mt-1">
                    <div className="tw-flex tw-items-center tw-gap-x-2">
                      <img
                        className="tw-size-6 tw-rounded-lg tw-ring-2 tw-ring-[#E8D48A]/20"
                      ...
                      <div className="tw-flex tw-items-center tw-justify-center tw-size-5 tw-rounded-full tw-bg-gradient-to-br tw-from-iron-800 tw-to-iron-900 tw-ring-1 tw-ring-iron-700">
                    ...
                    <div className="tw-flex tw-items-center tw-gap-2 tw-text-xs">
                      <span className="tw-px-2 tw-py-0.5 tw-rounded-full tw-bg-blue-500/10 tw-text-blue-400">
                        150 NIC
                      </span>
                      <span className="tw-px-2 tw-py-0.5 tw-rounded-full tw-bg-emerald-500/10 tw-text-emerald-400">
                        15K Rep
                      </span>
                    </div>
                  </div>
