    ...
    <div className="tw-relative tw-h-full">
      ...
      <div>
        <AnimatePresence>
          ...
          >
            <div
              className="tw-fixed tw-inset-0 tw-bg-iron-950 tw-bg-opacity-75 tw-transition-opacity"
              aria-hidden="true"
            ></div>

            <div className="tw-fixed tw-inset-0 tw-z-10 tw-overflow-y-auto">
              <div className="tw-flex tw-min-h-full tw-items-end tw-justify-center tw-p-4 tw-text-center sm:tw-items-center sm:tw-p-0">
                <div className="tw-pointer-events-none tw-fixed tw-inset-x-0 tw-bottom-0 tw-flex tw-max-h-[calc(100%-4rem)] tw-mt-16">
                  <motion.div
                    className="tw-pointer-events-auto tw-w-screen"
                    initial={{ translateY: "100%" }}
                    animate={{ translateY: 0 }}
                    exit={{ translateY: "100%" }}
                    transition={{ type: "spring", stiffness: 300, damping: 30 }}
                  >
                    <div className="tw-flex tw-h-full tw-flex-col tw-overflow-y-auto tw-scrollbar-thin tw-scrollbar-thumb-iron-500 tw-scrollbar-track-iron-800 tw-bg-iron-900 tw-py-6 tw-shadow-xl tw-rounded-t-2xl tw-border tw-border-solid tw-border-x-0 tw-border-b-0 tw-border-white/20">
                      <div className="tw-relative tw-flex-1 tw-px-4 sm:tw-px-6">
                        <div className="tw-grid tw-grid-cols-1 tw-gap-y-2">
                          <button className="tw-border-0 tw-flex tw-items-center tw-gap-x-4 tw-p-4 tw-bg-iron-900 tw-rounded-xl active:tw-bg-iron-800 tw-transition-colors tw-duration-200">
                            <svg
                          ...
                          <div className="tw-w-full tw-border-t tw-border-x-0 tw-border-b-0 tw-border-iron-800 tw-border-solid">
                            <button className="tw-mt-2 tw-border-0 tw-w-full tw-flex tw-items-center tw-gap-x-4 tw-p-4 tw-bg-iron-900 tw-rounded-xl active:tw-bg-red/10 tw-transition-colors tw-duration-200">
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                viewBox="0 0 24 24"
