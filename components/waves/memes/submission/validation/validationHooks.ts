 ...
 */
export function useTraitsValidation(traits: TraitsData, initialTraits: TraitsData) {
  // Track which fields have been touched by user interaction
  const [touchedFields, setTouchedFields] = useState<Set<keyof TraitsData>>(new Set());
