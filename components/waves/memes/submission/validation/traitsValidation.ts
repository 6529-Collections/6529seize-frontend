...
import { traitDefinitions, SectionDefinition, FieldDefinition } from "../../traits/schema";
import { ValidationOptions, ValidationResult, FieldValidationContext } from "./validationTypes";
...
export function validateTraitsData(
  ...
  const requiredFieldErrors = validateRequiredFields(traits, allFields, options);
