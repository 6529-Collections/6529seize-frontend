...
const UploadArea: React.FC<UploadAreaProps> = ({
  ...
  <div className="tw-absolute tw-inset-0 tw-flex tw-flex-col tw-items-center tw-justify-center tw-p-6">
    ...
    <div className="tw-relative tw-z-10 tw-flex tw-min-h-0 tw-flex-1 tw-flex-col tw-items-center tw-justify-center tw-py-3">
    ...
    <div className="tw-relative tw-z-10 tw-flex tw-w-full tw-flex-shrink-0 tw-flex-col tw-items-center tw-gap-3">
      {error && (
        <ErrorMessage
          error={error}
