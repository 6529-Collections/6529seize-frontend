...
import { WaveLeaderboardGridItemFooter } from "./WaveLeaderboardGridItemFooter";
...
> = ({
  ...
  return (
    <article
      ...
      className="tw-group tw-flex tw-h-full tw-min-w-0 tw-flex-col tw-overflow-hidden tw-rounded-xl tw-border tw-border-solid tw-border-iron-800 tw-bg-iron-950 tw-p-0 tw-transition desktop-hover:hover:tw-border-iron-700"
