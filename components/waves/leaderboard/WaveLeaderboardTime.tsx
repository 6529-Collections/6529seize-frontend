...
export const WaveLeaderboardTime: React.FC<WaveLeaderboardTimeProps> = ({
  ...
  return (
    ...
    >
      {multiDecision ? (
        <div
          className={`tw-box-border tw-mt-2 tw-overflow-hidden tw-rounded-lg tw-border tw-border-solid tw-border-white/[0.08] tw-bg-iron-950/70 tw-@container/timeline sm:tw-mt-4 ${
            isDecisionDetailsOpen ? "" : "tw-h-10"
          }`}
        >
          {(() => {
