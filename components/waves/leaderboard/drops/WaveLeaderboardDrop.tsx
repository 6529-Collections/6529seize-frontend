...
export const WaveLeaderboardDrop: React.FC<WaveLeaderboardDropProps> = ({
  ...
  const getBorderClasses = () => {
    ...
    const baseClasses = "tw-rounded-xl tw-bg-iron-950 tw-p-4 md:tw-px-5 tw-border tw-border-transparent tw-border-l-2 tw-transition-all tw-duration-200 tw-ease-out";
    
    if (rank === 1) {
      return `${baseClasses} tw-shadow-[inset_2px_0_0_#fbbf24,inset_0_1px_0_rgba(251,191,36,0.13),inset_-1px_0_0_rgba(251,191,36,0.13),inset_0_-1px_0_rgba(251,191,36,0.13)]`;
    } else if (rank === 2) {
      return `${baseClasses} tw-shadow-[inset_2px_0_0_#94a3b8,inset_0_1px_0_rgba(148,163,184,0.13),inset_-1px_0_0_rgba(148,163,184,0.13),inset_0_-1px_0_rgba(148,163,184,0.13)]`;
    } else if (rank === 3) {
      return `${baseClasses} tw-shadow-[inset_2px_0_0_#CD7F32,inset_0_1px_0_rgba(205,127,50,0.13),inset_-1px_0_0_rgba(205,127,50,0.13),inset_0_-1px_0_rgba(205,127,50,0.13)]`;
    } else {
      return `${baseClasses} tw-shadow-[inset_2px_0_0_#848490,inset_0_1px_0_rgba(132,132,144,0.13),inset_-1px_0_0_rgba(132,132,144,0.13),inset_0_-1px_0_rgba(132,132,144,0.13)]`;
    }
  };
