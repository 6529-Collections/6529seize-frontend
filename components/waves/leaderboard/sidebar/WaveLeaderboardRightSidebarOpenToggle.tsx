...
interface WaveLeaderboardRightSidebarOpenToggleProps {
  readonly isOpen: boolean;
  readonly onToggle: () => void;
}

export const WaveLeaderboardRightSidebarOpenToggle: React.FC<WaveLeaderboardRightSidebarOpenToggleProps> = ({
  isOpen,
  onToggle,
}) => {
  return (
