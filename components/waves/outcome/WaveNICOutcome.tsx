      ...
      >
        <div className="tw-flex tw-items-center tw-justify-between">
          <div className="tw-flex tw-items-center tw-gap-3">
            <div className="tw-flex tw-items-center tw-justify-center tw-size-10 tw-rounded-lg tw-bg-[#A4C2DB]/10">
              <IdentificationIcon className="tw-size-5 tw-text-[#A4C2DB]" />
            </div>
          ...
          <div className="tw-flex tw-items-center tw-gap-4">
            <div className="tw-text-right">
              <div className="tw-text-sm tw-font-semibold tw-text-[#A4C2DB]">
