    ...
    <div>
      ...
      >
        <button
          ...
          type="button"
          className={`tw-flex tw-items-center tw-justify-center tw-shrink-0  tw-rounded-full tw-transition tw-duration-300 tw-size-8 lg:tw-size-7 focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-offset-2 focus-visible:tw-ring-iron-500 tw-border-0 ${
        ...
        >
          <svg
            className={`tw-h-[1.1rem] tw-w-[1.1rem] lg:tw-size-4 tw-shrink-0 ${
