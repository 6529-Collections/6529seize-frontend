  ...
  return (
    <div className={compact ? "tw-inline-flex" : "tw-w-full"}>
      <button
        ...
        className={`tw-flex tw-items-center tw-justify-center tw-whitespace-nowrap tw-rounded-lg tw-border tw-border-solid tw-border-iron-700 tw-bg-transparent tw-text-xs tw-text-iron-400 tw-transition tw-duration-300 tw-ease-out disabled:tw-cursor-not-allowed disabled:tw-text-iron-500 desktop-hover:hover:tw-text-iron-300 ${
          compact ? "tw-h-8 tw-px-2.5" : "tw-h-10 tw-w-full tw-px-3 lg:tw-h-9"
        }`}
