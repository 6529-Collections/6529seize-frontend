export default function WavesOutcomeCards() {
  return (
    <div className="tw-flex tw-flex-col tw-gap-x-4 tw-gap-y-4">
      <div className="tw-bg-iron-800 tw-rounded-xl tw-ring-1 tw-ring-inset tw-ring-iron-800 tw-px-4 tw-py-4">
        <div className="tw-flex tw-justify-between">
          <div className="tw-flex tw-flex-col">
            <h3 className="tw-text-base tw-font-semibold tw-leading-6 tw-text-white">
              Rep
            </h3>
            <div className="tw-inline-flex tw-gap-x-6">
              <p className="tw-mb-0 tw-text-base tw-text-white tw-font-normal">
                Winner of Wave
              </p>
              <div className="tw-inline-flex tw-items-center tw-gap-x-2">
                ...
                <p className="tw-mb-0 tw-text-base tw-text-primary-400 tw-font-normal">
                  100 winners
                </p>
              </div>
              <p className="tw-mb-0 tw-text-base tw-text-success tw-font-normal">
                420 rep
              </p>
            </div>
          </div>
