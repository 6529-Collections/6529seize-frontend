...
export default function CreateWavesMainStepIcon({
  ...
  return (
    <span
      ...
      className={`${WRAPPER_CLASSES[stepStatus]} tw-relative tw-z-10 tw-flex tw-h-6 tw-w-6 tw-transform tw-items-center tw-justify-center tw-rounded-full tw-ring-2 tw-transition tw-duration-300 tw-ease-out`}
    >
