...
export default function CreateWaveOutcomesCICApprove({
  ...
  return (
    <div className="tw-flex tw-flex-col tw-gap-y-6">
      <div className="tw-grid tw-gap-x-5 tw-pt-[0.5px] md:tw-grid-cols-2">
        <div>
            ...
            <input
              ...
              className={`${
                outcome.maxWinners
                  ? "tw-text-primary-400 focus:tw-text-white"
                  : "tw-text-white"
              } tw-peer tw-form-input tw-block tw-w-full tw-appearance-none tw-rounded-lg tw-border-0 tw-border-iron-600 tw-bg-iron-900 tw-px-4 tw-pb-4 tw-pt-3 tw-text-base tw-font-medium tw-caret-primary-400 tw-shadow-sm tw-ring-1 tw-ring-inset tw-ring-iron-650 tw-transition tw-duration-300 tw-ease-out placeholder:tw-text-iron-500 focus:tw-border-blue-500 focus:tw-bg-iron-900 focus:tw-outline-none focus:tw-ring-1 focus:tw-ring-inset focus:tw-ring-primary-400 sm:tw-text-sm`}
              placeholder=" "
            />
            <label
