...
const CREDIT_LABEL = t(DEFAULT_LOCALE, "waves.create.outcomes.type.nic.label");
const CREDIT_ERROR = t(
  DEFAULT_LOCALE,
  "waves.create.outcomes.type.nic.creditError"
);
...
export default function CreateWaveOutcomesCICApprove({
  ...
  const onSubmit = () => {
    const dontHaveCreditSet = isMissingOutcomeAmount(outcome.credit);
          ...
          <div className="tw-group tw-relative tw-w-full">
            <input
              ...
              className={`${
                ...
                !isMissingOutcomeAmount(outcome.credit)
