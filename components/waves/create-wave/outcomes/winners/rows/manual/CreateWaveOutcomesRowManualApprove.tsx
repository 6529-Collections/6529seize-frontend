...
export default function CreateWaveOutcomesRowManualApprove({
  ...
  return (
    <div className="tw-bg-gradient-to-r tw-from-primary-400/[0.15] tw-to-primary-400/[0.05] tw-rounded-lg tw-ring-1 tw-ring-inset tw-ring-primary-400/10 tw-px-5 tw-py-2 tw-w-full tw-justify-between tw-inline-flex">
      <h3 className="tw-text-sm tw-font-semibold tw-text-white">Manual</h3>
      <p className="tw-text-sm tw-text-white tw-font-normal">{outcome.title}</p>
      <div className="tw-inline-flex tw-items-center tw-gap-x-2">
        ...
        <p className="tw-text-sm tw-text-primary-400 tw-font-medium">
