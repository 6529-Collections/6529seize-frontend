      ...
      <div className="tw-flex tw-flex-wrap tw-items-center tw-justify-between tw-gap-3">
        ...
        <div className="tw-flex tw-flex-wrap tw-items-center tw-justify-end tw-gap-2">
          <button
            ...
            onClick={onClearAll}
            className="tw-rounded-lg tw-border tw-border-solid tw-border-transparent tw-bg-transparent tw-px-3 tw-py-2 tw-text-sm tw-font-semibold tw-text-iron-500 tw-transition tw-duration-200 disabled:tw-cursor-not-allowed disabled:tw-opacity-60 desktop-hover:hover:tw-text-iron-100"
          >
            Clear all
          </button>
          <button
