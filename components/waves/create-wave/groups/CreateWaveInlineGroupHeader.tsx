export default function CreateWaveInlineGroupHeader({
  ...
  return (
    <div className="tw-flex tw-min-w-0 tw-flex-col tw-gap-3 md:tw-pr-[19rem]">
      <div className="tw-flex tw-w-fit tw-max-w-full tw-flex-col tw-items-start tw-gap-0.5 tw-rounded-lg tw-border tw-border-solid tw-border-white/5 tw-bg-white/[0.04] tw-px-3 tw-py-2 md:tw-max-w-72">
