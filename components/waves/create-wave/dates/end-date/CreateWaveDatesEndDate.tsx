        ...
        <div className="tw-relative">
          <input
            ...
            className={`tw-form-input tw-form tw-block tw-w-full tw-text-base tw-rounded-lg tw-border-0 tw-appearance-none ${
              time ? "tw-text-primary-400" : ""
            } tw-pb-3 tw-pt-3 tw-pl-10 tw-pr-4 tw-text-base tw-ring-iron-650 focus:tw-border-blue-500 tw-caret-primary-400 focus:tw-ring-primary-400 tw-form-input tw-block tw-w-full tw-rounded-lg tw-border-0 tw-appearance-none tw-font-medium tw-border-iron-650 tw-peer tw-bg-iron-900 focus:tw-bg-iron-900 tw-shadow-sm tw-ring-1 tw-ring-inset  placeholder:tw-text-iron-500 focus:tw-outline-none focus:tw-ring-1 focus:tw-ring-inset  tw-transition tw-duration-300 tw-ease-out`}
            placeholder=" "
          />
          <label
            htmlFor="dates-end-time"
            className="tw-text-base peer-focus:tw-text-primary-400 tw-text-iron-500 tw-absolute tw-cursor-text tw-font-medium tw-duration-300 tw-transform -tw-translate-y-4 tw-scale-75 tw-top-2 tw-origin-[0] tw-bg-iron-900 peer-focus:tw-bg-iron-900 tw-ml-7 tw-px-2 peer-focus:tw-px-2 peer-placeholder-shown:tw-scale-100 
          ...
          <div className="tw-pointer-events-none tw-absolute tw-flex tw-items-center tw-inset-y-0 tw-pl-3">
            <svg
              className={`tw-w-5 tw-h-5 tw-flex-shrink-0 ${
                time ? "tw-text-primary-400" : "tw-text-iron-300"
              }`}
              viewBox="0 0 24 24"
              fill="none"
              aria-hidden="true"
