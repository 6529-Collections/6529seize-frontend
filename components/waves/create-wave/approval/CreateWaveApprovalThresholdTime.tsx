...
export default function CreateWaveApprovalThresholdTime({
  ...
  const [periodErrors, setPeriodErrors] =
    useState<CREATE_WAVE_VALIDATION_ERROR[]>(getPeriodError());
  ...
  return (
    <div className="tw-col-span-full tw-mt-8">
            ...
            <input
              ...
              className={`${
                timeError
                  ...
                  : "tw-border-iron-650 tw-caret-primary-400 tw-ring-iron-650 focus:tw-border-blue-500 focus:tw-ring-primary-400"
              } tw-form-input tw-block tw-w-full tw-appearance-none tw-rounded-lg tw-border-0 tw-pb-3 tw-pl-10 tw-pr-4 tw-pt-4 tw-text-base sm:tw-text-sm ${
                time
                  ? "tw-text-primary-400 focus:tw-text-white"
                  : "tw-text-white"
              } tw-peer tw-bg-iron-900 tw-font-medium tw-shadow-sm tw-ring-1 tw-ring-inset tw-transition tw-duration-300 tw-ease-out placeholder:tw-text-iron-500 focus:tw-bg-iron-900 focus:tw-outline-none focus:tw-ring-1 focus:tw-ring-inset`}
              placeholder=" "
            />
            <label
              ...
              } tw-absolute tw-start-1 tw-top-2 tw-ml-7 tw-origin-[0] -tw-translate-y-4 tw-scale-75 tw-transform tw-cursor-text tw-bg-iron-900 tw-px-2 tw-text-base tw-font-medium tw-text-iron-500 tw-duration-300 peer-placeholder-shown:tw-top-1/2 peer-placeholder-shown:-tw-translate-y-1/2 peer-placeholder-shown:tw-scale-100 peer-focus:tw-top-2 peer-focus:-tw-translate-y-4 peer-focus:tw-scale-75 peer-focus:tw-bg-iron-900 peer-focus:tw-px-2 rtl:peer-focus:tw-left-auto rtl:peer-focus:tw-translate-x-1/4`}
            >
              Set time
            </label>
