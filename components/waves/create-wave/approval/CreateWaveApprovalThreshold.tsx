export default function CreateWaveApprovalThreshold({
  ...
  const onThresholdChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setThreshold(typeof newThreshold === "number" ? newThreshold : null);
  };
  ...
  return (
    <div className="tw-group tw-w-full tw-relative">
      <input
        ...
        className="tw-form-input tw-block tw-px-4 tw-py-4 tw-w-full tw-text-base tw-rounded-lg tw-border-0 tw-appearance-none tw-text-white tw-border-iron-650 focus:tw-border-blue-500 tw-peer
