  ...
  return (
    <div className="tw-flex tw-min-w-0 tw-flex-1 tw-flex-col">
      ...
      <div className="tw-group tw-flex tw-min-w-0 tw-items-start tw-gap-x-2">
        ...
        >
          <h1 className="tw-m-0 tw-truncate tw-text-lg tw-font-semibold tw-leading-normal tw-tracking-tight tw-text-iron-50 tw-transition tw-duration-300 tw-ease-out desktop-hover:group-hover:tw-text-iron-400">
            {wave.name}
          </h1>
        </Link>
        {showEdit && (
