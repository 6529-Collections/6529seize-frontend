  ...
  return (
    <div className="tw-group tw-flex tw-items-start tw-space-x-2">
      <Link href={getWavePathRoute(wave.id)} className="tw-no-underline">
        <h1 className="tw-mb-0 tw-text-lg tw-font-semibold tw-tracking-tight tw-text-iron-50 tw-transition tw-duration-300 tw-ease-out desktop-hover:group-hover:tw-text-iron-400">
          {wave.name}
        </h1>
      </Link>
      {showEdit && (
