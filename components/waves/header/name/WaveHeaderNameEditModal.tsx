...
export default function WaveHeaderNameEditModal({
  ...
  // The dialog owns stacking, keyboard insets, safe areas, focus and Esc.
  // The hand-rolled portal this replaced sat at `tw-z-50`, which put it under
  // the wave sidebar, and had no keyboard handling, so the native keyboard
  // covered both the input and Save.
  return (
    <MobileWrapperDialog
        ...
        <div className="tw-mt-4 tw-flex tw-justify-end">
          ...
          >
            <div style={{ visibility: mutating ? "hidden" : "visible" }}>
              {t(locale, "waves.header.nameEditSave")}
            </div>
            {mutating && (
              <svg
                aria-hidden="true"
