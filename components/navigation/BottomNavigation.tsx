...
const BottomNavigation: React.FC = () => {
  ...
  return (
    <nav
      ref={setMobileNavRef}
      className="tw-fixed tw-left-0 tw-w-full tw-bottom-0 tw-bg-black tw-border-t tw-border-solid tw-border-x-0 tw-border-b-0 tw-border-iron-900 tw-shadow-inner tw-z-50 tw-pb-[env(safe-area-inset-bottom,0px)]">
