...
export default function NextGenNavigationHeader(
  ...
  function printView(v: NextGenView | undefined) {
    ...
    if ((!v && props.view) || (v && v !== props.view)) {
      styles = {};
    }
    const viewHeader = (
    ...
    return (
      <button className="btn-link" onClick={() => props.setView(v)}>
        {viewHeader}
      </button>
    );
  }
    ...
    <Container className={styles.navigationHeader}>
      <div>
        <Image
          ...
          alt="nextgen"
          onClick={() => props.setView(undefined)}
        />
      </div>
      <div
        className={`d-flex align-items-center ${
          isMobile ? "justify-content-center pt-3 pb-3" : "justify-content-end"
        }`}>
