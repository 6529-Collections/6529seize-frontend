...
export default function FeedItems({
  ...
  return (
    <div className="tw-flex tw-gap-x-3">
      <div className="tw-flex-shrink-0 tw-h-8 tw-w-8 tw-rounded-full tw-bg-iron-800 tw-flex tw-items-center tw-justify-center">
        <svg
      ...
      <div className="tw-flex tw-flex-col tw-gap-y-4 tw-max-w-[672px]">
        {items.map((item, i) => (
          <FeedItem
