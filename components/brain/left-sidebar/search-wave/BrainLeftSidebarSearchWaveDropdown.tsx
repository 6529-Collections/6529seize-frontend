  ...
  return (
    <AnimatePresence mode="wait" initial={false}>
      {open && (
        ...
        >
          <div className="tw-absolute tw-z-20 tw-mt-1 tw-overflow-hidden tw-w-full tw-rounded-xl tw-bg-iron-900 tw-shadow-2xl tw-ring-1 tw-ring-inset tw-ring-white/10">
