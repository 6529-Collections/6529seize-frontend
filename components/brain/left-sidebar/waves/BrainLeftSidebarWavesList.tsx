...
const BrainLeftSidebarWavesList: React.FC<BrainLeftSidebarWavesListProps> = ({
  ...
  return (
    <div className="tw-mb-4">
      <div className="tw-h-full tw-bg-iron-950 tw-rounded-xl tw-ring-1 tw-ring-inset tw-ring-iron-800 tw-pt-5 tw-pb-2">
        ...
        <div className="tw-px-4 tw-pt-2 tw-border-t tw-border-iron-800 tw-border-x-0 tw-border-b-0 tw-border-solid">
