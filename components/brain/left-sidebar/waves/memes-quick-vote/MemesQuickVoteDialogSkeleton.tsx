      ...
      <div className="tw-relative tw-min-h-0 tw-flex-1 md:tw-contents">
        <div className="tw-min-h-0 tw-flex-1 md:tw-min-h-0 md:tw-border-y-0 md:tw-border-b-0 md:tw-border-l-0 md:tw-border-r md:tw-border-solid md:tw-border-white/10">
          <article className="tw-relative tw-flex tw-h-full tw-flex-col tw-overflow-hidden">
            ...
            >
              <div className="tw-relative tw-flex tw-max-h-[45dvh] tw-min-h-24 tw-flex-[3_1_0%] tw-items-center tw-justify-center tw-overflow-hidden tw-border-b tw-border-solid tw-border-white/5 tw-bg-black/40 md:tw-flex md:tw-h-full md:tw-w-full md:tw-items-center md:tw-justify-center md:tw-border-0">
                <SkeletonBlock className="tw-h-full tw-w-full tw-bg-iron-800/60" />
              </div>

              <div className="tw-relative tw-flex tw-min-h-[12.5rem] tw-flex-[2_1_0%] tw-flex-col tw-bg-[#0d0d0e] md:tw-hidden">
