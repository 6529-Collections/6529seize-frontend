...
export default function MemesQuickVoteActionBar({
  ...
  return (
    <div className="tw-relative tw-bg-[linear-gradient(180deg,rgba(10,10,12,0.78),rgba(10,10,12,0.96))] tw-px-3 tw-pb-[calc(env(safe-area-inset-bottom,0px)+0.625rem)] tw-pt-3 tw-backdrop-blur-[28px] sm:tw-pb-[calc(env(safe-area-inset-bottom,0px)+0.75rem)] sm:tw-pt-3 md:tw-relative md:tw-z-20 md:tw-shrink-0 md:tw-p-0 md:tw-px-8 md:tw-pb-6 md:tw-pt-0">
