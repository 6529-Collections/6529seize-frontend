  ...
  return (
    <>
      ...
      {!isLastSubwave && (
        <span
          aria-hidden="true"
          className={`tw-pointer-events-none tw-absolute tw-bottom-0 tw-top-1/2 ${guideLineOffsetClasses} tw-border-0 tw-border-l tw-border-solid ${connectorColorClasses} tw-transition-colors tw-duration-200`}
        />
      )}
    </>
  );
