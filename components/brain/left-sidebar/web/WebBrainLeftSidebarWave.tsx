    ...
    <div
      ...
      <Link
        ...
        className={`tw-flex tw-flex-1 tw-space-x-3 tw-no-underline tw-py-1 tw-transition-all tw-duration-200 tw-ease-out ${
          isActive
            ? "tw-text-white tw-font-medium desktop-hover:group-hover:tw-text-white"
            : "tw-text-iron-400 tw-font-normal desktop-hover:group-hover:tw-text-iron-300"
        }`}>
        ...
        <div className="tw-flex-1">
          <div className="tw-text-sm">{wave.name}</div>
