...
const BrainLeftSidebar: React.FC<BrainLeftSidebarProps> = ({
  ...
  return (
    <div className="tw-flex-shrink-0 tw-relative tw-z-[1001] tw-flex tw-flex-col h-screen lg:tw-h-[calc(100vh-6.25rem)] tw-overflow-y-auto lg:tw-w-[20.5rem] tw-w-full no-scrollbar">
