...
const BrainContentPinnedWave: React.FC<BrainContentPinnedWaveProps> = ({
  ...
  return (
    <div
      className={`tw-group tw-relative tw-transition-all tw-duration-300 ${
        ...
        <div
          ...
          className={`tw-relative tw-flex tw-h-6 tw-cursor-pointer tw-items-center tw-gap-1 tw-rounded-lg tw-px-1.5 tw-transition-all tw-duration-300 ${
            active
              ...
              : "tw-bg-iron-800 tw-ring-1 tw-ring-inset tw-ring-iron-700"
          } `}
        >
          ...
          <span
            className={`tw-relative tw-whitespace-nowrap tw-text-[11px] tw-font-medium ${
          ...
          <button
            ...
            className="tw-relative -tw-mr-0.5 tw-flex tw-cursor-pointer tw-items-center tw-justify-center tw-rounded-full tw-border-0 tw-bg-transparent tw-p-0.5 tw-text-iron-400 tw-opacity-100 tw-transition-all tw-duration-300 desktop-hover:hover:tw-text-red"
          >
            <svg
