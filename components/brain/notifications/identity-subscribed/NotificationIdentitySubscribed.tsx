...
export default function NotificationIdentitySubscribed({
  ...
  return (
    <div className="tw-w-full tw-flex tw-items-start sm:tw-items-center tw-gap-x-3 tw-flex-wrap">
      ...
      <div className="tw-flex tw-flex-col sm:tw-flex-row sm:tw-items-center sm:tw-flex-1 sm:tw-justify-between tw-gap-x-3 tw-gap-y-1">
        <div className="tw-flex tw-flex-col sm:tw-flex-row sm:tw-items-center tw-gap-x-1 tw-gap-y-1">
          ...
          <span className="tw-size-[3px] tw-bg-iron-600 tw-rounded-full tw-flex-shrink-0 tw-hidden sm:tw-block"></span>
