    ...
    >
      {options.map((option) => (
        <button
          ...
          className={`tw-whitespace-nowrap tw-px-2 tw-py-1 tw-text-sm tw-font-medium tw-border-b-2 tw-border-t-0 tw-border-x-0 tw-border-solid tw-bg-transparent tw-transition-all tw-duration-200 ${
            fullWidth
