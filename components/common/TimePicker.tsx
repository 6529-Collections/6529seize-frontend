          ...
          <div className="tw-flex tw-flex-1 tw-items-center tw-space-x-2">
            <div className="tw-relative tw-w-20">
              ...
              <input
                ...
                className={`tw-h-10 tw-w-full tw-rounded-lg tw-border-0 tw-bg-iron-800 tw-p-2 tw-ring-1 tw-ring-iron-700/30 tw-transition-all tw-duration-300 [appearance:textfield] [&::-webkit-inner-spin-button]:tw-appearance-none [&::-webkit-outer-spin-button]:tw-appearance-none ${
                  disabled
            ...
            <button
              ...
              className={`tw-h-10 tw-w-20 tw-rounded-lg tw-border-0 tw-px-3 tw-py-2 tw-transition-all tw-duration-200 ${
                disabled
                  ? "tw-cursor-not-allowed tw-bg-iron-800 tw-text-iron-500"
                  : "tw-bg-iron-800 tw-text-white tw-shadow-md hover:tw-translate-y-[-1px] hover:tw-bg-iron-700 hover:tw-shadow-lg"
              }`}
            >
              {isPm ? "PM" : "AM"}
            </button>
        ...
        <div className="tw-grid tw-grid-cols-3 tw-gap-1.5">
          {timeOptions.map((option) => {
            ...
            let optionStateClassName =
              "tw-bg-iron-800 tw-text-iron-50 tw-shadow-sm hover:tw-translate-y-[-1px] hover:tw-bg-iron-700 hover:tw-shadow-md";

            if (isSelected) {
              optionStateClassName = isFlat
                ? "tw-bg-primary-500 tw-font-semibold tw-text-white hover:tw-bg-primary-500"
              ...
              optionStateClassName =
                "tw-cursor-not-allowed tw-bg-iron-800 tw-text-iron-600 tw-opacity-50";
            }
