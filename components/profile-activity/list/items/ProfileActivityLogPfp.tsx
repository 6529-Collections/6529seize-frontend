          ...
          <div className="tw-pl-1">
            {log.contents.old_value && (
              <Image
                ...
                width="20"
                height="20"
                className="tw-shrink-0 tw-object-contain tw-max-h-10 tw-min-w-10 tw-w-auto tw-h-auto tw-rounded-sm tw-ring-2 tw-ring-white/30 tw-bg-iron-800"
              />
            )}
          </div>
          <svg
            className="tw-shrink-0 tw-h-5 tw-w-5 tw-text-neutral-400"
            viewBox="0 0 24 24"
            fill="none"
