...
export default function ProfileActivityLogBanner({
  ...
  return (
    <>
      ...
      <span className="tw-whitespace-nowrap tw-text-sm md:tw-text-md tw-font-medium tw-text-iron-300">
        {TITLE[log.type]}
      </span>
      {!isAdded && (
        <>
          <span
            className="tw-h-4 tw-w-4 tw-whitespace-nowrap tw-rounded-sm tw-text-sm tw-font-medium"
