...
export function XtdhCollectionsControls({
  ...
  return (
    <section
      className="tw-flex tw-flex-col tw-gap-3 tw-px-6 sm:tw-flex-row sm:tw-items-center sm:tw-justify-between"
      aria-label="Sort and search received collections"
    >
      <div className="tw-relative tw-w-full sm:tw-max-w-xs md:tw-max-w-sm">
        ...
        <input
          ...
          className="tw-form-input tw-block tw-w-full tw-rounded-lg tw-border-0 tw-bg-iron-900 tw-py-2.5 tw-pl-10 tw-pr-3 tw-text-iron-100 tw-caret-primary-400 tw-shadow-sm tw-ring-1 tw-ring-inset tw-ring-iron-700 tw-transition tw-duration-300 tw-ease-out placeholder:tw-text-iron-500 hover:tw-ring-iron-600 focus:tw-bg-transparent focus:tw-outline-none focus:tw-ring-1 focus:tw-ring-inset focus:tw-ring-primary-400 disabled:tw-cursor-not-allowed disabled:tw-opacity-50 sm:tw-text-sm sm:tw-leading-6"
        />
      </div>
      <div className="tw-no-scrollbar tw-w-full tw-overflow-x-auto sm:tw-w-auto">
        <CommonSelect
