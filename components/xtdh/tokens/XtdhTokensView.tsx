...
export type XtdhTokensViewState = {
...
const TOKEN_SORT_ITEMS: CommonSelectItem<XtdhTokensViewState["sort"]>[] = [
      ...
      >
        ...
        <div className="tw-flex tw-flex-col tw-gap-4 tw-rounded-xl tw-border tw-border-iron-800 tw-bg-iron-900 tw-p-4">
          ...
          <div className="tw-grid tw-grid-cols-2 tw-gap-3">
            ...
            <div>
              <label
                htmlFor="xtdh-token-min-grantors"
                className="tw-text-xs tw-font-semibold tw-uppercase tw-text-iron-400 tw-block tw-mb-1"
              >
                Minimum Grantors
              </label>
              <input
                id="xtdh-token-min-grantors"
                name="min-grantors"
                type="number"
                min={0}
