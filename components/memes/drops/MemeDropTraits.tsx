        ...
        {showAllTraits ? (
          <>
            ...
            <button
              ...
              className="tw-text-primary-400 tw-text-xs tw-font-medium desktop-hover:hover:tw-text-primary-300 tw-transition-colors tw-whitespace-nowrap tw-self-end tw-pb-1.5 tw-bg-transparent tw-border-0">
              Show less
            </button>
          </>
        ) : (
