...
export const MemesLeaderboardDropArtworkPreview: React.FC<MemesLeaderboardDropArtworkPreviewProps> = ({
  artworkMedia,
  title,
  onViewLarger,
}) => {
  return (
    <div
      className="tw-col-span-1 md:tw-col-span-7 tw-relative tw-bg-iron-950 tw-h-full"
