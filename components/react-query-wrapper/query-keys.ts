export enum QueryKey {
  COLLECT_CATALOG = "COLLECT_CATALOG",
  COLLECT_ASSETS = "COLLECT_ASSETS",
  COLLECT_CAPABILITIES = "COLLECT_CAPABILITIES",
  COLLECT_ANALYSIS = "COLLECT_ANALYSIS",
  COLLECT_PLAN = "COLLECT_PLAN",
  COLLECT_TDH = "COLLECT_TDH",
  COLLECT_RULES = "COLLECT_RULES",
  MARKET_LISTINGS = "MARKET_LISTINGS",
  MARKET_ORDERS = "MARKET_ORDERS",
  MARKET_OPERATION = "MARKET_OPERATION",
  MARKET_MY_OPERATIONS = "MARKET_MY_OPERATIONS",
  NFT_MARKET_DEPTH = "NFT_MARKET_DEPTH",
  NFT_MARKET_ACTIVITY = "NFT_MARKET_ACTIVITY",
  PROFILE = "PROFILE",
  ...
  TDH_PROFILE_SNAPSHOT = "TDH_PROFILE_SNAPSHOT",
  TDH_RULES = "TDH_RULES",
  ...
  PROFILE_WAVE_ACTIVITY = "PROFILE_WAVE_ACTIVITY",
  ...
  DROPS = "DROPS",
  COMMUNITY_CURATIONS_DROPS = "COMMUNITY_CURATIONS_DROPS",
  ...
  CONTENT_MODERATION_REPORTS = "CONTENT_MODERATION_REPORTS",
  CONTENT_MODERATION_BLOCKED_PROFILES = "CONTENT_MODERATION_BLOCKED_PROFILES",
  GROUPS = "GROUPS",
  ...
  WAVE = "WAVE",
  MEMES_SUBMISSION_ELIGIBILITY = "MEMES_SUBMISSION_ELIGIBILITY",
  WAVE_GROUP_VALIDATION = "WAVE_GROUP_VALIDATION",
  ...
  WAVE_SEARCH_AUTHORS = "WAVE_SEARCH_AUTHORS",
  ...
  PUBLIC_REVIEW_LEDGER = "PUBLIC_REVIEW_LEDGER",
  PUBLIC_REVIEW_DECLARATIONS = "PUBLIC_REVIEW_DECLARATIONS",
  ...
  MEMES_WALLET_ALLOCATIONS = "MEMES_WALLET_ALLOCATIONS",
