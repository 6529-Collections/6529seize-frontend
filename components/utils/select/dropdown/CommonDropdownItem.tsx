  ...
  return (
    <li className="tw:h-full">
      <button
        ...
        } tw:w-full tw:h-full tw:bg-transparent tw:border-none tw:text-left tw:inline-flex tw:justify-between tw:text-white tw:rounded-lg tw:relative tw:cursor-pointer tw:select-none tw:px-2 tw:focus:outline-none tw:focus:ring-1 tw:focus:ring-primary-400 tw:transition tw:duration-300 tw:ease-out`}
        onClick={onSelected}
