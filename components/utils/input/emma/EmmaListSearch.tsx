  ...
  return (
    <div className="tw-group tw-w-full tw-relative" ref={wrapperRef}>
      <input
        ...
        className="tw-form-input tw-block tw-pb-3 tw-pt-3 tw-pl-10 tw-pr-4 tw-w-full tw-text-md tw-rounded-lg tw-border-0 tw-appearance-none tw-text-white tw-border-iron-650 focus:tw-border-blue-500 tw-peer
