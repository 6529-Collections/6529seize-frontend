...
export default function SearchProfileModalItem({
  ...
  return (
    <div
      ...
      } tw-rounded-md tw-px-2 tw-transition tw-duration-300 tw-ease-out tw-w-full`}
    >
      <button
        onClick={goToProfile}
        className="tw-group tw-bg-transparent tw-border-none tw-cursor-default tw-select-none tw-rounded-md tw-space-x-2 tw-pt-1 tw-flex tw-items-center tw-w-full tw-text-left"
      >
