  ...
  return (
    <div>
      <AnimatePresence mode="wait" initial={false}>
        {isOpen && (
          <motion.div
            className="tw-fixed tw-z-[9999] tw-mb-2 tw-mt-1 tw-w-72 tw-overflow-y-auto tw-rounded-lg tw-bg-iron-800 tw-shadow-xl tw-ring-1 tw-ring-black tw-ring-opacity-5 motion-safe:tw-animate-sidebar-account-menu-in motion-reduce:tw-animate-none"
            style={{
              left: "calc(var(--layout-margin, 0px) + 1.5rem)",
              bottom: "calc(4rem + var(--sidebar-toggle-height, 0px))",
              maxHeight:
                "calc(100dvh - 5rem - var(--sidebar-toggle-height, 0px))",
            }}
          >
