...
export default function BlockPickerAdvancedItemBlock({
  ...
  return (
    <div>
      <FontAwesomeIcon
        onClick={copy}
        className="tw-mr-2.5 tw-h-5 tw-w-5 tw-cursor-pointer tw-text-iron-300 tw-transition tw-duration-300 tw-ease-out hover:tw-text-iron-50"
        icon={faCopy}
      />
      {coping ? (
        "Copied"
...
export function BlockPickerAdvancedItemBlockLink({
  ...
  return (
    <Link
      className="tw-underline tw-underline-offset-2 tw-transition tw-duration-300 tw-ease-out"
