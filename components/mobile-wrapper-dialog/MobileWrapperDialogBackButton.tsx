...
export default function MobileWrapperDialogBackButton({
  ...
  return (
    ...
    >
      <span className="tw-inline-flex tw-size-9 tw-items-center tw-justify-center tw-rounded-full tw-border tw-border-solid tw-border-white/10 tw-bg-white/[0.04] tw-transition-[background-color,border-color] tw-duration-150 tw-ease-out desktop-hover:group-hover:tw-border-white/15 desktop-hover:group-hover:tw-bg-white/[0.08] group-active:tw-bg-white/10 motion-reduce:tw-transition-none">
        <ChevronLeftIcon
          className="tw-size-5"
          strokeWidth={2}
          aria-hidden="true"
