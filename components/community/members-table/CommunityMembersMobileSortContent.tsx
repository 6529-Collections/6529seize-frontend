        ...
        {SORT_OPTIONS.map((option) => {
          ...
          return (
            <button
              ...
              className={`tw-flex tw-w-full tw-items-center tw-justify-between tw-gap-x-1.5 tw-py-3 tw-px-4 tw-rounded-lg tw-border tw-border-solid tw-text-sm tw-font-medium tw-transition ${
                isActive
