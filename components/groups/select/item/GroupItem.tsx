        ...
        {isActive && onActiveGroupId && (
          <div className="tw:absolute tw:-right-2 tw:-top-10">
            ...
            >
              ...
              <FontAwesomeIcon
                icon={faXmark}
                className="tw:h-4 tw:w-4 tw:text-iron-400 tw:group-hover:text-iron-50 tw:transition tw:duration-300 tw:ease-out"
              />
            </button>
          </div>
        )}
            ...
            <div className="tw:mt-1 tw:text-sm tw:flex tw:items-center tw:w-full tw:justify-between">
              <span className="tw:text-iron-50 tw:font-semibold">
                <Link
                  ...
                  className="tw:no-underline hover:tw:underline tw:group-hover:text-iron-500 tw:transition tw:duration-300 tw:ease-out tw:text-iron-50 tw:text-sm tw:font-medium"
                >
