...
const INTERACTIVE_CARD_ELEMENT_SELECTOR =
...
export default function GroupCard({
  ...
  const onCardClick = (event: MouseEvent<HTMLDivElement>) => {
    ...
    if (
      ...
      target.closest(INTERACTIVE_CARD_ELEMENT_SELECTOR)
    ) {
      return;
    }
    ...
    <div className="tw-relative tw-col-span-1">
      {isIdle && cardHref && (
        <Link
          ...
          className="tw-pointer-events-none tw-absolute tw-inset-0 tw-z-30 tw-rounded-xl focus-visible:tw-outline focus-visible:tw-outline-2 focus-visible:tw-outline-offset-2 focus-visible:tw-outline-primary-500"
