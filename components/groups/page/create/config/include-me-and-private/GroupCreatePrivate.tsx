export default function GroupCreatePrivate({
  ...
  return (
    <div>
      <label htmlFor="private-group-toggle" className="tw-flex tw-flex-col tw-cursor-pointer">
        ...
        <div className="tw-mt-2 sm:tw-mt-3">
          <div className="tw-flex tw-items-center">
            <div className="tw-rounded-full tw-bg-gradient-to-b tw-p-[1px] 
            ">
              <button
                ...
                className={`tw-p-0 tw-relative tw-flex tw-items-center tw-h-6 tw-w-11 tw-flex-shrink-0 tw-cursor-pointer tw-rounded-full tw-border-2 tw-border-transparent tw-transition-colors tw-duration-200 tw-ease-in-out focus:tw-outline-none ${
                  isPrivate ? "tw-bg-primary-500 focus:tw-ring-2 focus:tw-ring-primary-500 focus:tw-ring-offset-2" : "tw-bg-iron-700"
                }`}
                role="switch"
