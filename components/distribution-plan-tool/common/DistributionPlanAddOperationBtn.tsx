...
export default function DistributionPlanAddOperationBtn({
  ...
  return (
    <button
      disabled={loading}
      type="submit"
      className="tw-flex tw-items-center tw-justify-center tw-relative tw-bg-transparent hover:tw-bg-neutral-800/80 tw-px-4 tw-py-3 tw-text-sm tw-font-medium tw-text-white tw-w-full tw-border-2 tw-border-solid tw-border-neutral-700 tw-rounded-lg tw-transition tw-duration-300 tw-ease-out"
    >
