    ...
    <li className="tw-relative tw-pb-10">
      ...
      <div className="tw-group tw-relative tw-flex tw-items-start">
        <span className="tw-flex tw-h-8 tw-items-center" aria-hidden="true">
          <span className="tw-relative tw-z-0 tw-flex tw-h-7 tw-w-7 tw-items-center tw-justify-center tw-rounded-full tw-border-solid tw-border-2 tw-border-iron-300 tw-bg-iron-900">
            <span className="tw-h-2.5 tw-w-2.5 tw-rounded-full tw-bg-iron-300"></span>
          </span>
        </span>
