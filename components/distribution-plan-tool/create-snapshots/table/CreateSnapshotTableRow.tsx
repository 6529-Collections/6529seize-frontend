  ...
  return (
    <DistributionPlanTableRowWrapper>
      ...
      <td
        ...
        className={`${haveConsolidatedBlockNo ? 'tw-cursor-pointer' : ''} tw-group tw-whitespace-nowrap tw-px-3 tw-py-4 tw-text-sm tw-font-normal tw-text-neutral-300 hover:tw-text-white tw-transition tw-duration-300 tw-ease-out`}
      >
