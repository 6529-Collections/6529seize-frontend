...
export default function CreateSnapshotFormSearchCollectionDropdown({
  ...
  return (
    <div className="tw-absolute tw-z-10 tw-mt-1 tw-overflow-hidden tw-max-w-lg tw-w-full tw-rounded-md tw-bg-neutral-900 tw-shadow-lg tw-ring-1 tw-ring-white/10">
