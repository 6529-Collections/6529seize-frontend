        ...
        <div className="tw-w-full">
          <div className="tw-py-2">
            <div className="tw-overflow-hidden tw-rounded-lg tw-shadow tw-ring-1 tw-ring-white/10">
              ...
              <table className="tw-block tw-w-full tw-table-fixed tw-divide-y tw-divide-iron-700/60 before:tw-content-none after:tw-content-none sm:tw-table [&_*]:before:tw-content-none [&_*]:after:tw-content-none">
                <thead className="tw-sr-only tw-bg-iron-800/60 sm:tw-not-sr-only">
                  <tr>
                    <th
                      scope="col"
                ...
                <tbody className="tw-block tw-divide-y tw-divide-iron-700/40 tw-bg-iron-900 sm:tw-table-row-group">
                  {plans.map((plan) => (
