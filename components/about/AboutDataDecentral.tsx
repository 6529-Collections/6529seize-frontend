      ...
      <Container>
        <Row>
          <Col className="text-center">
            <h1 className="float-none">DATA DECENTRALIZATION</h1>
          </Col>
        </Row>
        <Row className="pt-3 pb-3">
          <Col className="text-left">
            <p>
              One of our goals is to demonstrate how applications can be built
            ...
            <p>
              This page shares the source of all data displayed on seize.io.
            </p>
            <p>On-Chain (Ethereum)</p>
            <ul>
              <li>The token #</li>
              <li>
                The location (URI/URL) of the JSON with the token&apos;s
                metadata
              </li>
              <li>The collectors&apos; Ethereum addresses</li>
              <li>
                The collectors&apos; NFTs currently owned, as well as bought,
                sold or transfered
              </li>
            ...
            <ul>
              ...
              <li>
                TDH values (calculated from on-chain data, using this formula.
                We will release sample code for this calculation soon)
              </li>
            </ul>
            ...
            <ul>
              <li>
                ...
                us, we also export daily all our compiled and calculated data
                for the convenience of those without programming backgrounds
              </li>
              <li>
