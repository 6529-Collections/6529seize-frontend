...
const ENS_TITLE_CLASS =
  "tw-m-0 tw-pt-4 tw-text-[22px] tw-font-semibold tw-leading-tight tw-tracking-tight tw-text-iron-50 sm:tw-pt-8 sm:tw-text-[26px]";
...
const ENS_DOMAINS_LINK_CLASS =
  "tw-text-primary-300 tw-underline tw-decoration-primary-400/50 tw-underline-offset-4 tw-transition-colors hover:tw-text-iron-50 hover:tw-decoration-primary-300 focus-visible:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-primary-400 focus-visible:tw-ring-offset-2 focus-visible:tw-ring-offset-[#0D0D0F] motion-reduce:tw-transition-none";
...
const ENS_HTML_CONTENT_CLASS = [
  ...
  "[&>p:first-child]:tw-mb-8 [&>p:first-child]:tw-mt-0 [&>p:first-child]:tw-text-left [&>p:first-child]:tw-text-sm [&>p:first-child]:tw-leading-6 [&>p:first-child]:tw-text-iron-500",
  "[&>ul:first-of-type]:tw-mb-16 [&>ul:first-of-type]:tw-mt-0 [&>ul:first-of-type]:tw-flex [&>ul:first-of-type]:tw-list-none [&>ul:first-of-type]:tw-flex-col [&>ul:first-of-type]:tw-gap-1 [&>ul:first-of-type]:tw-rounded-xl [&>ul:first-of-type]:tw-border [&>ul:first-of-type]:tw-border-solid [&>ul:first-of-type]:tw-border-white/[0.05] [&>ul:first-of-type]:tw-bg-iron-950 [&>ul:first-of-type]:tw-p-6 [&>ul:first-of-type::before]:tw-static [&>ul:first-of-type::before]:tw-mb-3 [&>ul:first-of-type::before]:tw-block [&>ul:first-of-type::before]:tw-text-xs [&>ul:first-of-type::before]:tw-font-semibold [&>ul:first-of-type::before]:tw-uppercase [&>ul:first-of-type::before]:tw-leading-5 [&>ul:first-of-type::before]:tw-tracking-[0.16em] [&>ul:first-of-type::before]:tw-text-iron-500 [&>ul:first-of-type::before]:tw-content-['Contents:'] sm:[&>ul:first-of-type]:tw-p-8",
  ...
  "[&>h4]:tw-mb-0 [&>h4]:tw-mt-0 [&>h4]:tw-scroll-mt-24 [&>h4]:tw-border-x-0 [&>h4]:tw-border-b [&>h4]:tw-border-t-0 [&>h4]:tw-border-solid [&>h4]:tw-border-white/10 [&>h4]:tw-pb-4 [&>h4]:tw-font-sans [&>h4]:tw-text-xl [&>h4]:tw-font-semibold [&>h4]:tw-leading-tight [&>h4]:tw-tracking-tight [&>h4]:tw-text-iron-50 sm:[&>h4]:tw-text-2xl",
  ...
  "[&>p:not(:first-child)]:tw-mb-0 [&>p:not(:first-child)]:tw-mt-10 [&>p:not(:first-child)]:tw-text-base [&>p:not(:first-child)]:tw-font-semibold [&>p:not(:first-child)]:tw-leading-6 [&>p:not(:first-child)]:tw-text-[#8f5cff]",
