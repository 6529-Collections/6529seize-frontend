...
const APPLY_PANEL_CLASS =
  "tw-mt-6 tw-max-w-4xl tw-rounded-xl tw-border tw-border-solid tw-border-white/[0.07] tw-bg-white/[0.025] tw-p-5 sm:tw-p-6";
...
const APPLY_DETAIL_BODY_CLASS =
  "tw-m-0 tw-mt-2 tw-text-base tw-leading-7 tw-text-iron-400";
  ...
  return (
    ...
    >
        ...
        <div className="tw-max-w-4xl">
          ...
          <ul className="tw-m-0 tw-mt-5 tw-grid tw-list-none tw-grid-cols-1 tw-gap-3 tw-p-0 sm:tw-grid-cols-2">
            <li className="tw-flex tw-items-start tw-gap-3 tw-rounded-xl tw-border tw-border-solid tw-border-white/[0.07] tw-bg-white/[0.025] tw-p-4 tw-text-base tw-leading-7 tw-text-iron-300">
              <span aria-hidden="true" className="tw-font-bold tw-text-success">
                ✓
              </span>
              <span>
      ...
      >
        ...
        <div className={APPLY_PANEL_CLASS}>
          ...
          <div className={`tw-pt-5 ${APPLY_DETAIL_ROW_CLASS}`}>
            <h3 className={APPLY_DETAIL_HEADING_CLASS}>Replace Submissions</h3>
            <p className={APPLY_DETAIL_BODY_CLASS}>
              If you remove a submission or one of your submissions is selected
              to be minted, you can submit another card to fill that spot.
            </p>
          </div>
          ...
          <div className="tw-pt-5">
            ...
            <div className="tw-mt-5 tw-rounded-lg tw-border tw-border-solid tw-border-white/[0.06] tw-bg-iron-950 tw-p-4 sm:tw-p-5">
              <h4 className="tw-m-0 tw-flex tw-items-center tw-gap-2 tw-text-base tw-font-semibold tw-leading-6 tw-text-iron-100">
                <FontAwesomeIcon aria-hidden="true" icon={faCalendar} />
                Checkpoint Schedule
              </h4>
              <div className="tw-mt-4 tw-space-y-3 tw-text-sm tw-leading-6 tw-text-iron-400 sm:tw-text-base sm:tw-leading-7">
      ...
      >
        ...
        <div className={APPLY_PANEL_CLASS}>
          <div className="tw-space-y-4 tw-text-base tw-leading-7 tw-text-iron-400">
            <p className="tw-m-0">
              Carefully read the{" "}
              <a
                className={APPLY_LINK_CLASS}
              ...
              vision, themes, and guidelines. <br /> High-quality,
              mission-aligned submissions perform best. Low-effort or off-theme
              submissions are unlikely to be chosen.
            </p>
            <p className="tw-m-0">
            ...
            <p className="tw-m-0">
              You&apos;re the expert on your art — we&apos;re here to help with
              The Memes style and mission. Sharing drafts or brainstorming early
          ...
          <div className="tw-mt-6 tw-border-x-0 tw-border-b-0 tw-border-t tw-border-solid tw-border-white/[0.06] tw-pt-6">
            ...
            <div className="tw-pt-5">
              <h3 className={APPLY_DETAIL_HEADING_CLASS}>General Questions?</h3>
              <p className={APPLY_DETAIL_BODY_CLASS}>
                Visit{" "}
                <a
                  className={APPLY_LINK_CLASS}
          ...
          <div className="tw-mt-6 tw-rounded-lg tw-border tw-border-solid tw-border-white/[0.06] tw-bg-iron-950 tw-p-4 tw-text-center">
            <p className="tw-m-0 tw-text-sm tw-italic tw-leading-6 tw-text-iron-500">
              We receive many messages; thank you for your patience if responses
              are delayed.
            </p>
          </div>
        </div>
...
function ScheduleRow({
  ...
  return (
    <div className="tw-grid tw-grid-cols-[minmax(5.75rem,auto)_minmax(0,1fr)] tw-items-center tw-gap-3">
      ...
      <span className="tw-flex tw-min-w-0 tw-flex-wrap tw-items-center tw-gap-x-2">
        ...
        <FontAwesomeIcon
          aria-hidden="true"
          className="tw-shrink-0 tw-text-iron-600"
          icon={faArrowRight}
        />
        <span>minted {destination}</span>
      </span>
    </div>
  );
}
