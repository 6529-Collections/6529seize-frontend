      ...
      <Container>
        <Row>
          <Col className="text-center">
            <h1 className="float-none">MINTING MEME CARDS</h1>
          </Col>
        </Row>
        <Row className="pt-3 pb-3">
          <Col>
            ...
            <ul>
              ...
              <br />
              <li>
                The Memes generally mint using an allowlist model. The purpose
                of the allowlist is to avoid gas wars / bot wars and to give as
                broad a range of people as possible a chance to mint.
              </li>
              <br />
              <li>
                ...
                <ul>
                  ...
                  <br />
                  <li>
                    The allowlist approach is constantly changing and may, in
                    the future, move to a completely different model, if a
                    better approach emerges.
                  </li>
                  <br />
                  <li>
                    Buy The Memes that you like, because you like holding the
                    art or feel a sense of identity with the mission. Do not buy
                    them for an allowlist spot.
                  </li>
                </ul>
              </li>
              <br />
            ...
            <ul>
              <li>
                ...
                are very difficult to manage effectively. The main approaches
                and our views on them are highlighted below.
              </li>
              <br />
              <li>
              ...
              <br />
              <li>
                Raise Prices (either directly or through auctions): The benefit
                of higher prices is that they help avoid gas wars and return
              ...
              <li>
                ...
                prices with this model. This is the model we feel is most
                suitable for the project mission of The Memes.
              </li>
              <br />
              <li>
                Open Editions: Open editions absorb all demand by having
                unlimited size editions. This is an intriguing and relevant
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    collectors and artists who share a common ideological
                    interest in art and decentralization
                  </li>
                  <br />
                  <li>
                  ...
                  <br />
                  <li>
                    The answer here is broadly similar, but with two
                    differences: the scale is sometimes larger and people can
                    pretend to be more than 1 person by having different
                    Ethereum addresses
                  </li>
                  <br />
                  <li>
                  ...
                  <li>
                    ...
                    is, in some ways, to prevent Sybil attacks vs other
                    consensus mechanisms that do not protect against them
                  </li>
                </ul>
              </li>
              <br />
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    to 90% if you exclude our internal holdings
                  </li>
                </ul>
              </li>
              <br />
                ...
                <ul>
                  ...
                  <li>
                    ...
                    <ul>
                      ...
                      <br />
                      <li>
                        We allowlist some other random categories so that there
                        is some diversity in the minters
                      </li>
                    </ul>
                  </li>
                  <br />
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    important New York gallery, sure, it is normal to expect
                    that you might be invited to their cocktail parties or to
                    get an early look at new work in the gallery
                  </li>
                  <br />
                  <li>
                    You would not, however, collect Andy Warhols primarily to
                    receive cocktail party invites and you would understand that
                    you did not always get an early look at all new pieces in
                    the gallery
                  </li>
                </ul>
              </li>
            ...
            <ul>
              ...
              <li>
                ...
                metrics. Who is contributing in Discord, who is creating
            ...
            <ul>
              <li>
                ...
                fail to load a transaction. You may have to refresh multiple
                times to be successful in minting.
              </li>
              <br />
              <li>
              ...
              <li>
                ...
                price to mint in time. We cannot advise on the correct gas to
                use as it differs every time.
              </li>
              <br />
              <li>
                In highly competitive mints, you may pay for a transaction that
                does not mint in time and lose your gas fee. We do not refund
