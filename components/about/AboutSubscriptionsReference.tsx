...
function Delegation({ locale }: { readonly locale: SupportedLocale }) {
  return (
    ...
    >
      ...
      >
        <summary className="tw-flex tw-min-h-16 tw-list-none tw-items-center tw-justify-between tw-gap-4 tw-bg-white/[0.02] tw-px-6 tw-py-5 tw-text-white/80 tw-transition-colors hover:tw-text-white focus:tw-outline-none focus-visible:tw-ring-2 focus-visible:tw-ring-inset focus-visible:tw-ring-[#00f0ff]/50 sm:tw-px-8 [&::-webkit-details-marker]:tw-hidden">
        ...
        <div className="tw-border-0 tw-border-t tw-border-solid tw-border-white/5 tw-bg-[#0a0a0c]/50 tw-px-6 tw-pb-8 tw-pt-5 sm:tw-px-8">
