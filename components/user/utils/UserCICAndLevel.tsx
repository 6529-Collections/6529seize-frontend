...
export default function UserCICAndLevel({
  ...
  return (
    /*  <div className="tw-relative">
      <div className="tw-flex tw-items-center tw-justify-center tw-h-4 tw-w-4 tw-text-[9px] tw-leading-3 tw-font-bold tw-rounded-full tw-ring-2 tw-ring-iron-300 tw-text-iron-300">
        {level}
      </div>
      <span
        className={`tw-flex-shrink-0 tw-absolute -tw-right-1 -tw-top-[0.1875rem] tw-block tw-h-2 tw-w-2 tw-rounded-full ${CIC_COLOR[cicType]}`}
      ></span>
    </div> */
    <div className="tw-relative">
      <div
