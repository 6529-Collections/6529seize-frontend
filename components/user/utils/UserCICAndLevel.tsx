...
export default function UserCICAndLevel({
  ...
  return (
    <div className="tw-relative">
      <div
        className={`${LEVEL_SIZE_CLASSES[size]} tw-flex tw-items-center tw-justify-center tw-leading-3 tw-font-bold tw-rounded-full tw-ring-1 tw-ring-iron-700 tw-text-${mainColor}`}>
        {level}
      </div>
      <span
