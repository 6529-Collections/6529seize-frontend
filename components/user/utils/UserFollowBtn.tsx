...
export default function UserFollowBtn({ handle }: { readonly handle: string }) {
  ...
  return (
    <button
      ...
      type="button"
      className={`tw-flex tw-items-center tw-gap-x-1 tw-cursor-pointer tw-px-2.5 tw-py-0.5 tw-text-xs tw-rounded-lg tw-font-semibold tw-border-0 tw-ring-1 tw-ring-inset ${
        following
