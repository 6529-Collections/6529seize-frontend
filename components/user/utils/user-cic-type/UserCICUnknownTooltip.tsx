export default function UserCICUnknownTooltip() {
  return (
    <div className="tw-p-3">
      ...
      <div className="tw-mt-4 tw-space-y-0.5">
        <span className="tw-block tw-text-neutral-100 tw-font-semibold">
          <span>Rating:</span>
          <span className="tw-ml-1 tw-text-white tw-font-bold">50</span>
        </span>
        <span className="tw-block tw-text-neutral-100 tw-font-semibold">
          <span>Status:</span>
          <span className="tw-ml-1 tw-text-yellow tw-font-bold">
