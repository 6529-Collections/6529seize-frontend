...
export default function ProfileRatersTableWrapper({
  ...
  return (
    <div>
      ...
      <div className="tw-mt-4 tw-bg-iron-900 tw-border tw-border-white/10 tw-border-solid tw-rounded-xl xl:tw-min-h-[28rem] tw-max-h-[28rem] tw-scroll-py-3 tw-overflow-y-auto">
        {ratings.length ? (
