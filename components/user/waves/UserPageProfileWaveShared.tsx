...
export function OfficialWaveSummary({
  ...
  return (
    <div className="tw-flex tw-flex-wrap tw-items-start tw-gap-x-3 tw-gap-y-4 lg:tw-flex-nowrap lg:tw-justify-between">
      ...
      {canManageOwnOfficialWave && onAddPost !== undefined && (
        <button
          type="button"
          onClick={onAddPost}
        ...
        >
          <PlusIcon className="tw-h-4 tw-w-4 tw-flex-shrink-0 -tw-ml-1" />
      ...
      {canManageOwnOfficialWave && (
        <div
          role="group"
          aria-label="Profile wave switch controls"
          className="horizontal-menu-hide-scrollbar tw-order-last tw-w-full tw-basis-full tw-overflow-x-auto lg:tw-order-none lg:tw-w-auto lg:tw-basis-auto lg:tw-overflow-visible"
        >
