...
export default function UserPageIdentityHeaderCIC({
  ...
  return (
    <div className="tw-mb-8">
      <div className="tw-text-[11px] tw-font-semibold tw-text-iron-500 tw-uppercase tw-tracking-widest tw-mb-2">
        NIC
      </div>
      <div className="tw-text-3xl tw-font-bold tw-text-white tw-tracking-tight tw-leading-none">
        {formatNumberWithCommas(cicRating)}
      </div>
      <div className="tw-mt-3 tw-flex tw-items-center tw-gap-1.5 tw-text-xs tw-font-bold tw-tracking-[0.1em] tw-uppercase">
