                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          x
                          {numberWithCommas(
                            props.tdh.memes_balance +
                              props.tdh.gradients_balance
                          )}
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          {props.tdh.memes_balance_season1 > 0
                            ? `#${numberWithCommas(
                                ...
                                props.tdh
                                  .dense_rank_balance_memes_season1__ties > 1
                                  ? ` (tie)`
                                  : ""
                              }`
                            : "-"}
                        ...
                        <td>
                          {props.tdh.memes_balance_season2 > 0
                            ? `#${numberWithCommas(
                                ...
                                props.tdh
                                  .dense_rank_balance_memes_season2__ties > 1
                                  ? ` (tie)`
                                  : ""
                              }`
                            : "-"}
                        ...
                        <td>
                          {props.tdh.memes_balance_season3 > 0
                            ? `#${numberWithCommas(
                                ...
                                props.tdh
                                  .dense_rank_balance_memes_season3__ties > 1
                                  ? ` (tie)`
                                  : ""
                              }`
                            : "-"}
                        ...
                        <td>
                          {props.tdh.memes_balance_season4 > 0
                            ? `#${numberWithCommas(
                                props.tdh.dense_rank_balance_memes_season4
                              )}${
                                props.tdh
                                  .dense_rank_balance_memes_season4__ties > 1
                                  ? ` (tie)`
                                  : ""
                              }`
                            : "-"}
                      ...
                      <tr>
                        ...
                        <td>
                          {props.tdh.memes_balance_season1 > 0
                            ? `#${numberWithCommas(
                                ...
                                props.tdh
                                  .dense_rank_unique_memes_season1__ties > 1
                                  ? ` (tie)`
                                  : ""
                              }`
                            : "-"}
                        ...
                        <td>
                          {props.tdh.memes_balance_season2 > 0
                            ? `#${numberWithCommas(
                                ...
                                props.tdh
                                  .dense_rank_unique_memes_season2__ties > 1
                                  ? ` (tie)`
                                  : ""
                              }`
                            : "-"}
                        ...
                        <td>
                          {props.tdh.memes_balance_season3 > 0
                            ? `#${numberWithCommas(
                                ...
                                props.tdh
                                  .dense_rank_unique_memes_season3__ties > 1
                                  ? ` (tie)`
                                  : ""
                              }`
                            : "-"}
                        ...
                        <td>
                          {props.tdh.memes_balance_season4 > 0
                            ? `#${numberWithCommas(
                                props.tdh.dense_rank_unique_memes_season4
                              )}${
                                props.tdh
                                  .dense_rank_unique_memes_season4__ties > 1
                                  ? ` (tie)`
                                  : ""
                              }`
                            : "-"}
                      ...
                      <tr>
                        ...
                        <td>
                          {props.tdh.tdh_rank_memes_szn4 > 0
                            ? `#${numberWithCommas(
                                props.tdh.tdh_rank_memes_szn4
                              )}`
                            : "-"}
                        </td>
                        <td>
                  ...
                  <Table className={styles.primaryTableActivity}>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          {props.tdh.purchases_value > 0
                            ? `${numberWithCommas(
                                Math.round(props.tdh.purchases_value * 100) /
                                  100
                              )}`
                            : "-"}
                        </td>
                        ...
                        <td>
                          {props.tdh.purchases_value_memes_season4 > 0
                            ? `${numberWithCommas(
                                Math.round(
                                  props.tdh.purchases_value_memes_season4 * 100
                                ) / 100
                              )}`
                            : "-"}
                        </td>
                      ...
                      <tr>
                        ...
                        <td>
                          {props.tdh.transfers_out_memes_season4 > 0
                            ? `x${numberWithCommas(
                                props.tdh.transfers_out_memes_season4
                              )}`
                            : "-"}
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          {props.tdh.sales_value_memes_season4 > 0
                            ? `${numberWithCommas(
                                Math.round(
