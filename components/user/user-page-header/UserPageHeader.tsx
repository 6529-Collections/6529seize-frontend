    ...
    <div className={`tailwind-scope ${inter.className}`}>
      <section className="tw-pb-6 md:tw-pb-8">
        <UserPageHeaderBanner
          ...
          canEdit={canEdit}
        />
        <div className="tw-relative tw-px-6 min-[1000px]:tw-max-w-[850px] min-[1100px]:tw-max-w-[950px] min-[1200px]:tw-max-w-[1050px] min-[1300px]:tw-max-w-[1150px] min-[1400px]:tw-max-w-[1250px] min-[1500px]:tw-max-w-[1280px] tw-mx-auto">
