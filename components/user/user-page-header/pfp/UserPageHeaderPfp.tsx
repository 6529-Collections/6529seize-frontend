  ...
  if (profile.profile?.pfp_url) {
    return (
      <Image
        ...
        width="176"
        height="176"
        className="tw-shrink-0 tw-object-contain tw-max-h-28 sm:tw-max-h-44 tw-w-auto tw-h-auto tw-rounded-lg tw-ring-[3px] tw-ring-white/30 tw-bg-iron-800"
      />
    );
  }
  return (
    <div
      className="tw-shrink-0 tw-h-36 sm:tw-h-44 tw-w-36 sm:tw-w-44 tw-rounded-lg tw-ring-[3px] tw-ring-white/30"
      style={{
