...
export default function ProxyListReceived({
  ...
  return (
    <div className="tw-space-y-4">
      <div className="tw-py-4 tw-divide-y tw-divide-iron-700 tw-divide-solid tw-divide-x-0 tw-rounded-lg tw-ring-1 tw-ring-iron-600">
        ...
        <div className="tw-mt-2 sm:tw-mt-4 tw-px-4 tw-divide-y tw-divide-iron-700 tw-divide-solid tw-divide-x-0">
