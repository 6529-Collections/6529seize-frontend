  ...
  return (
    <div className="tw-flex tw-items-center tw-justify-end md:tw-justify-start tw-gap-x-3">
      ...
      <button
        ...
        className="tw-w-full sm:tw-w-auto tw-bg-primary-500 tw-px-3 tw-py-2.5 tw-text-sm tw-leading-5 tw-font-semibold tw-text-white tw-border tw-border-solid tw-border-primary-500 tw-rounded-lg hover:tw-bg-primary-600 hover:tw-border-primary-600 tw-transition tw-duration-300 tw-ease-out"
      >
        Save
      </button>
    </div>
