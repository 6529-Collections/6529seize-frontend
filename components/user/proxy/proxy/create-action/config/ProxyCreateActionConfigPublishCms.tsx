import type { CreateProxyPublishCmsAction } from "@/entities/IProxy";
import { ApiProfileProxyActionType } from "@/generated/models/ApiProfileProxyActionType";

export default function ProxyCreateActionConfigPublishCms({
  endTime,
  onSubmit,
  onCancel,
}: {
  readonly endTime: number | null;
  readonly onSubmit: (action: CreateProxyPublishCmsAction) => void;
  readonly onCancel: () => void;
}) {
  const handleSubmit = () =>
    onSubmit({
      action_type: ApiProfileProxyActionType.PublishCms,
      end_time: endTime,
    });
  return (
