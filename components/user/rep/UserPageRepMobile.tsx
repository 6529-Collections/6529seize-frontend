    ...
    <div className="lg:tw-hidden">
      ...
      <div className="tw-grid tw-grid-cols-2 tw-gap-3">
        ...
        <button
          ...
          className={`tw-relative tw-overflow-hidden tw-rounded-xl tw-border tw-border-solid tw-p-4 tw-text-left tw-cursor-pointer tw-transition-all tw-duration-300 tw-ease-out ${
            activeTab === "rep"
              ? "tw-bg-[#0f1014] tw-border-blue-500/40 tw-scale-[1.02]"
              : "tw-bg-white/[0.02] tw-border-white/[0.06]"
          }`}
        >
          {activeTab === "rep" && (
            <>
          ...
          <div className={`tw-relative tw-transition-opacity tw-duration-300 ${activeTab === "rep" ? "" : "tw-opacity-40"}`}>
            <div className="tw-mb-1 tw-text-[10px] tw-font-semibold tw-uppercase tw-tracking-widest tw-text-iron-500">
              Total Rep
            </div>
            <div className="tw-text-2xl tw-font-bold tw-leading-none tw-tracking-tight tw-text-primary-400">
              {repRates
            ...
            {repRates && (
              <div className="tw-mt-2 tw-flex tw-items-center tw-gap-2">
                <TopRaterAvatars
                  ...
                  size="sm"
                />
                <span className="tw-text-xs tw-font-semibold tw-text-iron-400">
        ...
        <button
          ...
          className={`tw-relative tw-overflow-hidden tw-rounded-xl tw-border tw-border-solid tw-p-4 tw-text-left tw-cursor-pointer tw-transition-all tw-duration-300 tw-ease-out ${
            activeTab === "identity"
              ? "tw-bg-[#0f1014] tw-border-emerald-500/40 tw-scale-[1.02]"
              : "tw-bg-white/[0.02] tw-border-white/[0.06]"
          }`}
        >
          {activeTab === "identity" && (
          ...
          <div className={`tw-relative tw-transition-opacity tw-duration-300 ${activeTab === "identity" ? "" : "tw-opacity-40"}`}>
            ...
            <div className="tw-text-2xl tw-font-bold tw-leading-none tw-tracking-tight tw-text-white">
            ...
            <div className="tw-mt-2 tw-flex tw-items-center tw-gap-1.5">
              ...
              <span className="tw-text-xs tw-font-bold tw-uppercase tw-tracking-wide">
        ...
        {activeTab === "rep" ? (
          ...
          >
            ...
            <div className="tw-mt-4 tw-flex tw-items-center tw-justify-between tw-rounded-xl tw-border tw-border-solid tw-bg-emerald-500/5 tw-border-emerald-500/10 tw-px-5 tw-py-3">
              <span className="tw-text-sm tw-font-medium tw-text-emerald-200/70">
