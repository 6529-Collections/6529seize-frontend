...
> = {
  [MEMES_SEASON.SZN1]: {
    ...
    title: "SZN1",
    classes: "tw-whitespace-nowrap tw-inline-flex tw-items-center tw-rounded-full tw-bg-[#84ACFF]/10 tw-px-2 tw-py-1 tw-text-sm tw-font-medium tw-text-[#84ACFF] tw-ring-1 tw-ring-inset tw-ring-[#84ACFF]/20",
    value: (props) => props?.memes_cards_sets_szn1 ?? 0,
  },
  [MEMES_SEASON.SZN2]: {
    id: MEMES_SEASON.SZN2,
    title: "SZN2",
    classes: "tw-whitespace-nowrap tw-inline-flex tw-items-center tw-rounded-full tw-bg-[#8494FF]/10 tw-px-2 tw-py-1 tw-text-sm tw-font-medium tw-text-[#8494FF] tw-ring-1 tw-ring-inset tw-ring-[#8494FF]/20",
    value: (props) => props?.memes_cards_sets_szn2 ?? 0,
  },
  [MEMES_SEASON.SZN3]: {
    id: MEMES_SEASON.SZN3,
    title: "SZN3",
    classes: "tw-whitespace-nowrap tw-inline-flex tw-items-center tw-rounded-full tw-bg-[#8A84FF]/10 tw-px-2 tw-py-1 tw-text-sm tw-font-medium tw-text-[#8A84FF] tw-ring-1 tw-ring-inset tw-ring-[#8A84FF]/20",
    value: (props) => props?.memes_cards_sets_szn3 ?? 0,
  },
  [MEMES_SEASON.SZN4]: {
    id: MEMES_SEASON.SZN4,
    title: "SZN4",
    classes: "tw-whitespace-nowrap tw-inline-flex tw-items-center tw-rounded-full tw-bg-[#A184FF]/10 tw-px-2 tw-py-1 tw-text-sm tw-font-medium tw-text-[#A184FF] tw-ring-1 tw-ring-inset tw-ring-[#A184FF]/20",
    value: (props) => props?.memes_cards_sets_szn4 ?? 0,
  },
  [MEMES_SEASON.SZN5]: {
    id: MEMES_SEASON.SZN5,
    title: "SZN5",
    classes: "tw-whitespace-nowrap tw-inline-flex tw-items-center tw-rounded-full tw-bg-[#B884FF]/10 tw-px-2 tw-py-1 tw-text-sm tw-font-medium tw-text-[#B884FF] tw-ring-1 tw-ring-inset tw-ring-[#B884FF]/20",
    value: (props) => props?.memes_cards_sets_szn5 ?? 0,
  },
  [MEMES_SEASON.SZN6]: {
    id: MEMES_SEASON.SZN6,
    title: "SZN6",
    classes: "tw-whitespace-nowrap tw-inline-flex tw-items-center tw-rounded-full tw-bg-[#CF84FF]/10 tw-px-2 tw-py-1 tw-text-sm tw-font-medium tw-text-[#CF84FF] tw-ring-1 tw-ring-inset tw-ring-[#CF84FF]/20",
