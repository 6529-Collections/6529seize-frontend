...
export default function UserPageStatsActivityDistributionsTableItem({
  ...
  return (
    <tr>
      <td className="tw-text-iron-500 tw-font-medium tw-px-4 sm:tw-px-6 tw-whitespace-nowrap tw-text-base">
      ...
      <td className="tw-text-iron-500 tw-font-normal tw-px-4 sm:tw-px-6 tw-whitespace-nowrap tw-text-base">
        {item.name}
      </td>
      <td className="tw-text-iron-500 tw-font-normal tw-px-4 sm:tw-px-6 tw-whitespace-nowrap tw-text-base">
        {item.wallet}
      ...
      {item.phases.map((phase) => (
        <td
          ...
          className="tw-text-iron-500 tw-font-normal tw-px-4 tw-text-right sm:tw-px-6 tw-whitespace-nowrap tw-text-base"
        >
