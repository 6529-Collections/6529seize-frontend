  ...
  return (
    ...
    >
      <label
        ...
        } tw-relative tw-flex tw-h-48 tw-w-full tw-cursor-pointer tw-flex-col tw-items-center tw-justify-center tw-rounded-lg tw-border-2 tw-border-dashed tw-transition tw-duration-300 tw-ease-out hover:tw-border-iron-600 hover:tw-bg-iron-800 ${
          shake ? "tw-animate-shake" : ""
        } `}
      >
        <div className="tw-flex tw-flex-col tw-items-center tw-justify-center tw-gap-3 tw-px-4">
          {imageToShow ? (
            <div className="tw-h-24 tw-w-full tw-overflow-hidden tw-rounded-md tw-ring-1 tw-ring-iron-800">
              <img
                src={imageToShow}
                alt="Banner preview"
