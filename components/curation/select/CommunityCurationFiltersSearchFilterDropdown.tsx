...
import CommunityCurationFiltersSearchFilterDropdownItem from "./CommunityCurationFiltersSearchFilterDropdownItem";

export default function CommunityCurationFiltersSearchFilterDropdown({
  open,
  filters,
  selected,
  onSelect,
            ...
            <div className="tw-absolute tw-z-10 tw-mt-1 tw-overflow-hidden tw-w-full tw-rounded-md tw-bg-iron-800 tw-shadow-2xl tw-ring-1 tw-ring-white/10">
              <div className="tw-py-1 tw-flow-root tw-overflow-x-hidden tw-overflow-y-auto">
                <ul className="tw-flex tw-flex-col tw-px-2 tw-mx-0 tw-mb-0 tw-list-none">
                  {filters.length ? (
                    filters.map((filter) => (
                      <CommunityCurationFiltersSearchFilterDropdownItem
                        key={filter.id}
                        filter={filter}
                        selected={selected}
                        onSelect={onSelect}
