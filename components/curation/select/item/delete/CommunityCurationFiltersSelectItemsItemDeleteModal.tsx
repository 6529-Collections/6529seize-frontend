...
import { selectActiveCurationFilterId, setActiveCurationFilterId } from "../../../../../store/curationFilterSlice";
export default function CommunityCurationFiltersSelectItemsItemDeleteModal({
  filterId,
  onClose,
}: {
