...
const ttlMinutes = readNumber(env.PEPE_CACHE_TTL_MINUTES, 10);
const cacheMaxItems = readNumber(env.PEPE_CACHE_MAX_ITEMS, 500);
...
const IPFS_GATEWAY = trimSlashes(
  env.IPFS_GATEWAY_ENDPOINT || "https://ipfs.io/ipfs/"
);
