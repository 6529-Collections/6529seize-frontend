...
export function generateStaticParams() {
  ...
  return STREAM_REVIEW_DEFINITION.availableVersions.flatMap((version) =>
    STREAM_REVIEW_PAGES.filter((page) => page.id !== "overview").map(
      (page) => ({
...
export default async function VersionedPublicReviewEditorialPage({
  params,
}: Props) {
