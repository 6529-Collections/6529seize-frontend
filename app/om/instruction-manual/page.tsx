                      ...
                      <div
                        ...
                        <div className="fusion-column-wrapper fusion-column-has-shadow fusion-flex-justify-content-flex-start fusion-content-layout-column">
                          ...
                          <div className="fusion-text fusion-text-1">
                            ...
                            <p>
                              Switch your browser to use your dedicated GPU, not
                              your integrated GPU (if you have a dedicated
                              GPU).&nbsp; It will make a big difference in
                              performance, though will use more battery power if
                              you are unplugged.
                            </p>
                            <h4>
                            ...
                            <p>
                              Some computers aren't set up to use dedicated GPU.
                            </p>
                            <p>
                            ...
                            <p>
                              Below are changes for those who use NVIDA GPUs and
                              those who use AMD GPUs.
                            </p>
                            <p>
                              M
                              <strong>
                            ...
                            <p>
                              3. Open the tab “Program Settings” and choose your
                              browser from the dropdown menu
                            </p>
                            <p>
                              <img
                                loading="lazy"
                            ...
                            <p>
                              5. Scroll down, select GPUs and adjust from global
                              setting to use NVIDIA
                            </p>
                            <p>
                              <img
                                loading="lazy"
                            ...
                            <p>
                              ...
                              Display Settings by right-clicking on the Desktop.
                            </p>
                          </div>
                        </div>
                      </div>
