...
export const museumMigratedWordPressPage = {
  ...
  blocks: [
    ...
    },
    {
      ...
      html: migratedWordPressTrustedHtml(
        '<p><a href="https://oncyber.io/6529om" rel="noopener noreferrer" target="_blank" data-migrated-wordpress-button>VISIT 6529 MUSEUM DISTRICT </a></p>'
      ),
    },
    {
      type: "html",
      html: migratedWordPressTrustedHtml(
        "<p>The 6529 Museum of Art has one of the largest and most valuable NFT collections in the world across all major NFT categories. The 6529 Museum has a particular focus on generative art where it has one of the top horizontal generative art collections in the world. </p>"
      ),
    },
    {
      type: "html",
      html: migratedWordPressTrustedHtml(
        "<p>The museum also owns iconic pieces in each category – Summer.jpg, The Tulip and Punk 6529 are among the best known NFTs in their respective categories. </p>"
      ),
    },
    {
      type: "html",
      html: migratedWordPressTrustedHtml(
        "<p>More importantly, the 6529 Museum is a permanent collection, a place for the NFT art to have a permanent curational home. The Museum is committed to being headquartered in decentralized spaces, in support of the 6529 Mission. </p>"
      ),
    },
    {
      type: "image",
    ...
    {
      type: "heading",
      content: "6529 MUSEUM OF ART MAP",
    },
    {
      type: "image",
      media: {
