...
export default async function MuseumArtistPage({
  ...
  const profile = publication.documents.find(
    (document) => document.kind === "artist_practice"
  );
    ...
    <article>
            ...
            >
              ...
              >
                ...
                <span className="tw-text-sm tw-font-normal tw-text-iron-500">
                  ...
                  {project.artworkIds.length === 1 ? "work" : "works"}
                </span>
              </Link>
            </li>
          ))}
      ...
      >
        ...
        {profile ? (
          ...
          <p
            className="tw-m-0 tw-mt-5 tw-text-sm tw-text-yellow-100"
            role="status"
          >
