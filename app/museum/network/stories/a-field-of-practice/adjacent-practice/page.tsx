...
export async function renderMuseumAdjacentPracticePage() {
  ...
  const document = publication.institutionalPractice.adjacentPractice;
  ...
  return (
    <article className="tw-min-w-0">
      ...
      <div className="tw-mt-12 tw-max-w-5xl tw-border-x-0 tw-border-b-0 tw-border-t tw-border-solid tw-border-iron-800 tw-pt-2">
        <InstitutionalPracticeManuscript
...
export default function MuseumAdjacentPracticeLegacyPage() {
  permanentRedirect(
