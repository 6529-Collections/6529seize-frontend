...
export const museum_6529FundSzn1AzukiMigratedWordPressPage = {
  ...
  blocks: [
    {
      ...
      html: migratedWordPressTrustedHtml(
        "<p><strong>Azuki</strong><br>Chiru Labs </p>"
      ),
    },
    {
      type: "image",
