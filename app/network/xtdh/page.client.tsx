    ...
    <Container className="tw-min-h-screen tw-pb-12 tw-pt-12">
      <Row>
        <Col>
          ...
          <h1>xTDH</h1>
          <p className="tw-mt-2">
            xTDH is an extension of <Link href="/network/tdh">TDH</Link> which
            helps to include other NFT holders to 6529 ecosystem and offer them
            all the benefits of TDH.
          </p>
          <p className="tw-mt-2">
            I tracks:
            <ol>
          ...
          <div className="tw-mt-8 tw-space-y-2">
            ...
            <p className="tw-mt-2">
              ...
              in the future to *all or some* tokens in an ERC721 collection. If
              you own a token that has active grants, you receive a portion of
              those grants every day.
            </p>
            ...
            <p className="tw-mt-2">
              Just like with TDH, "transfers" inside the same consolidation
              group <b>do not reset</b> the ownership window. Sales or transfers
              across groups <b>do</b>.
            </p>
            <p className="tw-mt-2">
          ...
          <div className="tw-mt-8 tw-space-y-2">
            ...
            <p className="tw-mt-2">
              You can't give away xTDH which is already pinned to your identity,
              but you can give away future xTDH earnings via grants. You can
              give away it all or some part of it. The total amount you are
            ...
            <p className="tw-mt-2">
              <ol>
                ...
                <li>
                  sum up all portions of grantees who have been holding the
                  token less than 24h
                </li>
