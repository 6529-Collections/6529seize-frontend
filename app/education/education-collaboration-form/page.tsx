...
import { educationEducationCollaborationFormMigratedWordPressPage as content } from "./content";

export default function EducationEducationCollaborationFormPage() {
