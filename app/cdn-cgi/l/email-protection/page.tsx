...
export default function EmailProtectionPage() {
  return (
    <div>
      ...
      {/*[if IE 8]>    <html className="no-js ie8 oldie" lang="en-US"> <![endif]*/}
      {/*[if gt IE 8]><!*/}
      {/*<![endif]*/}
      ...
      <div id="cf-wrapper">
        <div
          className="cf-alert cf-alert-error cf-cookie-error"
          id="cookie-alert"
            ...
            <div className="cf-columns two">
              <div className="cf-column">
                <p>
                  ...
                  <strong>
                    You must enable Javascript in your browser in order to
          ...
          <div className="cf-error-footer cf-wrapper w-240 lg:w-full py-10 sm:py-4 sm:px-8 mx-auto text-center sm:text-left border-solid border-0 border-t border-gray-300">
            <p className="text-13">
              <span className="cf-footer-item sm:block sm:mb-1">
                Cloudflare Ray ID:{" "}
                <strong className="font-semibold">8e5f95d3c8b210be</strong>
              </span>
