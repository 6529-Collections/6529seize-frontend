...
const DistributionPlanToolWrapper = dynamic(
  () => import("@/components/distribution-plan-tool/wrapper/DistributionPlanToolWrapper"),
  { ssr: false }
);
            ...
            <div className="2xl:tw-max-w-xl tw-mx-auto lg:tw-pr-10 xl:tw-pr-16 2xl:tw-pr-0">
              <div className="tw-flex tw-flex-col">
                ...
                <p className="tw-text-justify tw-mb-0 tw-mt-2 md:tw-mt-4 tw-block tw-font-light tw-text-base tw-leading-[1.6] tw-text-neutral-400">
                  The Memes and the Allowlist Research Institute have built what may be the world's deepest expertise in complex allowlist management across 150+ NFT drops (and counting). These efforts lead to the creation of {""}
                  <a
                ...
                <p className="tw-text-justify tw-mb-0 tw-mt-2 md:tw-mt-4 tw-block tw-font-light tw-text-base tw-leading-[1.6] tw-text-neutral-400">
                  ...
                  <br /> Users with TDH &gt; 25,000 can create unlimited allowlists per day.
                </p>
