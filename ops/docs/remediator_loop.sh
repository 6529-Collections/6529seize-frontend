...
Read ops/docs/.remediator-loop.log.
Find next undocumented area from docs vs code.
Document exactly one area.
Append one line to ops/docs/.remediator-loop.log as:
