...
Staging and production use the existing direct GitHub Actions workflows, with
frontend staging triggered by `1a-staging` pushes and backend services deployed
sequentially. The earlier release-railway, queue, ledger, and dashboard proposal
is retired. Current merges, dependency ordering, automatic E2E, and rollback are
documented in [Deployment](../docs/developer/deployment.md).
