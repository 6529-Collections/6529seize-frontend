...
| [Public contract review](public-contract-review.md)       | The review shell resolves source-locale messages with `DEFAULT_LOCALE`, and immutable editorial snapshots are currently English-only |
