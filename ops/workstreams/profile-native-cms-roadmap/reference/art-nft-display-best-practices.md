...
> Reference status (2026-07-23): This is a design reference, not current
> delivery status. Use [Active Context](../active-context.md) and current source
> for implementation and release decisions.
