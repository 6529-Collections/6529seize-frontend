...
> Reference status (2026-07-23): This is long-horizon product and architecture
> direction, not current delivery status. Use
> [Active Context](../active-context.md) and current source/GitHub state for
...
`ops/workstreams/profile-native-cms-roadmap/reference/art-nft-display-best-practices.md`.
