...
- Focused Jest passed:
  ...
  The nested local worktree required explicit Jest path overrides; Jest also
  reported its existing open-handle warning after all tests passed.
...
- Browser smoke screenshots were captured as untracked local artifacts and are
  not preserved in this archive.
