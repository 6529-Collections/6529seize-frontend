...
- Browser verification on `http://localhost:3142/punk6529/cms/builder` with
  ...
  - Desktop poster, ready, and canvas screenshots and a mobile fallback
    screenshot were captured as untracked local artifacts and are not preserved
    in this archive.
...
Local browser smoke passed for the profile CMS builder with viewport screenshots
for desktop snapshot review, desktop preview, and mobile snapshot review.
Those untracked local artifacts are not preserved in this archive.
