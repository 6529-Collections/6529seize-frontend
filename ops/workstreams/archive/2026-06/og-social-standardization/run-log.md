...
- Loaded the autonomous-manager and write-prs workflows for the seven-PR OG
  standardization delivery path.
- Created clean worktree branch `codex/og-social-baseline` from `origin/main`.
