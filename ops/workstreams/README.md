...
| [Museum release fast lane](museum-release-fast-lane/README.md)         | Risk-based release qualification for fast Museum presentation changes without weakening exact-source or deployment controls | [`proposal.md`](museum-release-fast-lane/proposal.md), [`active-context.md`](museum-release-fast-lane/active-context.md), current workflows, and measured GitHub Actions evidence         |
