...
import { AppWalletsProvider, useAppWallets, appWalletsEventEmitter } from '../../../components/app-wallets/AppWalletsContext';
      ...
      const TestComponent = () => {
        ...
        return (
          <div>
            ...
            <div data-testid="has-create">{typeof context.createAppWallet === 'function' ? 'true' : 'false'}</div>
            <div data-testid="has-import">{typeof context.importAppWallet === 'function' ? 'true' : 'false'}</div>
            <div data-testid="has-delete">{typeof context.deleteAppWallet === 'function' ? 'true' : 'false'}</div>
            <div data-testid="is-array">{Array.isArray(context.appWallets) ? 'true' : 'false'}</div>
            <div data-testid="has-fetching">{typeof context.fetchingAppWallets === 'boolean' ? 'true' : 'false'}</div>
            <div data-testid="has-supported">{typeof context.appWalletsSupported === 'boolean' ? 'true' : 'false'}</div>
          </div>
        );
      };
  ...
  describe('interface types', () => {
    it('AppWallet interface is properly structured', () => {
      ...
      const TestComponent = () => {
        ...
        const hasWalletStructure = appWallets.every((wallet: any) => 
        ...
        return <div data-testid="wallet-structure">{hasWalletStructure.toString()}</div>;
      };
