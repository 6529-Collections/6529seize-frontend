...
jest.mock("@/components/app-wallets/AppWalletCard", () => (props: any) => (
  <div data-testid="card">{props.wallet.address}</div>
));
...
jest.mock("@/components/app-wallets/AppWalletModal", () => ({
  CreateAppWalletModal: (props: any) => (
    <div data-testid="modal">{props.show ? "open" : "closed"}</div>
  ),
}));
