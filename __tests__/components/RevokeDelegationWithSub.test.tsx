...
describe("RevokeDelegationWithSub", () => {
  ...
  it("renders the component with correct title", () => {
    ...
    expect(
      screen.getByText("Revoke as Delegation Manager")
    ).toBeInTheDocument();
  });
  ...
  it("displays the original delegator address", () => {
    ...
    expect(
      screen.getByDisplayValue(defaultProps.originalDelegator)
    ).toBeInTheDocument();
  });
  ...
  it("displays the delegation manager address", () => {
    ...
    expect(screen.getByTestId("disabled-address")).toHaveTextContent(
