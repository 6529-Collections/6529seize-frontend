  ...
  return function MockNFTImageBalance({ contract, tokenId, height }: any) {
    ...
    return (
      <div
        ...
        {balance === 0 && <span data-testid="unseized-text">UNSEIZED</span>}
        {balance === -1 && <span data-testid="loading-text">...</span>}
      </div>
    );
  };
});
...
describe("NFTModelRenderer", () => {
  ...
  describe("NFTModel Integration", () => {
    ...
    it("passes NFT data to NFTModel correctly", () => {
      ...
      const modelViewer = screen
        .getByTestId("nft-model")
  ...
  describe("NFTImageBalance Integration", () => {
    ...
    it("renders seized with quantity when balance is positive and showBalance is true", () => {
      const { useNftBalance } = require("@/hooks/useNftBalance");
      useNftBalance.mockReturnValue({
        balance: 3,
        isLoading: false,
  ...
  describe("Edge Cases and Error Handling", () => {
    ...
    it("handles large balance numbers correctly", () => {
      ...
      expect(screen.getByTestId("seized-text")).toHaveTextContent(
        "SEIZED x999999"
      );
    });
  });
  ...
  describe("Props Propagation", () => {
    ...
    it("propagates balance-related props to NFTImageBalance", () => {
      ...
      const props = createDefaultProps({ height: 650 });
      render(<NFTModelRenderer {...props} />);
      ...
      expect(seizedText).toHaveTextContent("SEIZED x7");
    });
