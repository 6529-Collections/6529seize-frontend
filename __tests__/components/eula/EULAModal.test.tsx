...
describe("EULAModal", () => {
  ...
  it("renders the extracted introductory legal sections unchanged", () => {
    render(<EULAModal />);
    ...
    expect(
      screen.getByText("The Underlying Principles Of These Terms")
    ).toBeInTheDocument();
    expect(
      screen.getByText("Our Platform, Our House Rules III")
    ).toBeInTheDocument();
  });
});
