...
const mockUseIsMobileScreen = useIsMobileScreen as jest.MockedFunction<typeof useIsMobileScreen>;
  ...
  describe("Hook integration", () => {
    ...
    it("properly integrates with useNFTCollections hook", async () => {
      ...
      expect(mockFetchUrl).toHaveBeenCalledWith(
        "https://test.6529.io/api/memes_lite"
      );
      expect(mockFetchAllPages).toHaveBeenCalledWith(
        "https://test.6529.io/api/nfts/gradients?&page_size=101"
      );
