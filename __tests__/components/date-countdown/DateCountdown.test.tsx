...
describe("DateCountdown", () => {
  describe("Basic Rendering", () => {
    ...
    it("displays time correctly for future date", () => {
      ...
      const timeDisplay = screen.getByText(
        /2 days, 3 hours, 45 minutes and 30 seconds/
      );
  ...
  describe("Time Unit Display Logic", () => {
    it("shows only relevant time units (no days)", () => {
      ...
      expect(
        screen.getByText(/3 hours, 45 minutes and 30 seconds/)
      ).toBeInTheDocument();
  ...
  describe("Layout and Structure", () => {
    ...
    it("maintains semantic HTML structure", () => {
      ...
      const spans = container.querySelectorAll("div");
  ...
  describe("Accessibility", () => {
    it("provides readable content for screen readers", () => {
      ...
      expect(
        screen.getByText(/1 day, 3 hours, 30 minutes and 45 seconds/)
      ).toBeInTheDocument();
    });
