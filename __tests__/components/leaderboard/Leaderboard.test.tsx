...
import Leaderboard, { LeaderboardFocus } from '../../../components/leaderboard/Leaderboard';
...
jest.mock('../../../components/leaderboard/LeaderboardCardsCollected', () => () => <div data-testid="cards" />);
jest.mock('../../../components/leaderboard/LeaderboardInteractions', () => () => <div data-testid="interactions" />);
