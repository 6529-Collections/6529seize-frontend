...
it.each(["viewer-only receipt", "restricted historical target"])(
  "keeps a %s readable without enabling source import",
  async (scenario) => {
    ...
    else context.mutation_restricted_paths = ["artwork.title"];
