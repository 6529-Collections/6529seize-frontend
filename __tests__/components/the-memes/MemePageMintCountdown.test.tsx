...
describe("MemePageMintCountdown", () => {
  ...
  describe("Ended State", () => {
    it("shows mint phase complete message when status is ENDED", () => {
      ...
      expect(
        screen.getByText("This mint phase has ended.")
      ).toBeInTheDocument();
      expect(
  ...
  describe("Finalized State", () => {
    it("shows sold out message when isFinalized is true", () => {
      ...
      expect(
        screen.getByText("✅ Mint Complete - Sold Out!")
      ).toBeInTheDocument();
      expect(
        screen.getByText("All NFTs have been successfully minted.")
      ).toBeInTheDocument();
      expect(
        screen.getByText("Thank you for participating!")
      ).toBeInTheDocument();
