...
const useHeaderContextMock = useHeaderContext as jest.MockedFunction<
  typeof useHeaderContext
>;
const useDeviceInfoMock = useDeviceInfo as jest.MockedFunction<
  typeof useDeviceInfo
>;
const createBreakpointMock = createBreakpoint as jest.MockedFunction<
  typeof createBreakpoint
>;
