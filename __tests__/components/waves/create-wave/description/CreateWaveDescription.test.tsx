...
jest.mock("@/helpers/ProfileHelpers", () => ({
  ...
  profileAndConsolidationsToProfileMin:
    mockProfileAndConsolidationsToProfileMin,
}));
  ...
  React.forwardRef((props: any, ref: any) => {
    ...
    return (
      <div data-testid="drop-editor">
        ...
        <div data-testid="emoji-picker-mobile-z-index-class">
          {emojiPickerLayer.mobileZIndexClassName}
        </div>
      </div>
    );
  })
...
describe("CreateWaveDescription", () => {
  ...
  it("scopes emoji picker layer above the create-wave modal", () => {
    ...
    expect(
      screen.getByTestId("emoji-picker-desktop-z-index")
    ).toHaveTextContent("10000");
    expect(
      screen.getByTestId("emoji-picker-mobile-z-index-class")
    ).toHaveTextContent("tw-z-[10000]");
  });
  ...
  it("handles wave with null image", () => {
    ...
    render(
      <CreateWaveDescription {...defaultProps} wave={waveWithNullImage} />
    );
