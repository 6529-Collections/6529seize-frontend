...
jest.mock(
  "@/components/waves/create-wave/main-steps/CreateWavesMainStepIcon",
  () => () => <div data-testid="icon" />
);
jest.mock(
  "@/components/waves/create-wave/main-steps/CreateWavesMainStepConnectionLine",
...
describe("CreateWavesMainStep", () => {
  ...
  it("disables button when not done", () => {
    ...
    helpers.getCreateWaveStepStatus.mockReturnValue(
  ...
  it("disables completed steps while navigation is busy", () => {
    const helpers = require("@/helpers/waves/waves.helpers");
    helpers.getCreateWaveStepStatus.mockReturnValue(CreateWaveStepStatus.DONE);
    render(
      <CreateWavesMainStep
        isLast={false}
        label="Step"
