...
describe('CreateWavesMainStepConnectionLine', () => {
  it('renders static background line', () => {
    ...
    expect(backgroundLine).toHaveClass('tw-absolute', 'tw-left-[11px]', 'tw-top-9', 'tw-h-full', 'tw-rounded-sm', 'tw-w-0.5');
  });
  ...
  it('renders animated progress line when done is false', () => {
    ...
    expect(progressLine).toHaveClass('tw-absolute', 'tw-left-[11px]', 'tw-top-9', 'tw-h-full', 'tw-rounded-sm', 'tw-w-0.5');
  });
