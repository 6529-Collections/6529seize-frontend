...
jest.mock(
  "@/components/waves/create-wave/outcomes/winners/rows/manual/CreateWaveOutcomesRowManual",
  () => {
...
jest.mock(
  "@/components/waves/create-wave/outcomes/winners/rows/rep/CreateWaveOutcomesRowRep",
  () => {
...
jest.mock(
  "@/components/waves/create-wave/outcomes/winners/rows/cic/CreateWaveOutcomesRowCIC",
  () => {
