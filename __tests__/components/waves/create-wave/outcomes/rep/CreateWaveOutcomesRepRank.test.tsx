...
jest.mock(
  "@/components/waves/create-wave/outcomes/winners/CreateWaveOutcomesWinners",
  () => {
    return function CreateWaveOutcomesWinners({
      ...
      return (
        <div data-testid="outcomes-winners">
          ...
          {totalValueError && (
            <span data-testid="total-value-error">Total value error</span>
          )}
          {percentageError && (
            <span data-testid="percentage-error">Percentage error</span>
          )}
...
describe("CreateWaveOutcomesRepRank", () => {
  ...
  it("initializes with REP outcome type", () => {
    ...
    expect(screen.getByTestId("outcome-type")).toHaveTextContent(
  ...
  it("renders with proper structure and classes", () => {
    ...
    const buttonContainer = container.querySelector(
      ".tw-flex.tw-flex-wrap.tw-justify-end.tw-gap-3"
    );
