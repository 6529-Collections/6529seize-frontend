import { isVideoMimeType, processContent } from '../../../../components/waves/drops/media-utils';
...
describe('media-utils', () => {
  ...
  it('processes markdown content and extracts media', () => {
    const result = processContent('Hello @[bob]! ![v](http://x.com/a.mp4) end ![i](img.jpg)', []);
    expect(result.segments[0]).toEqual({ type: 'text', content: 'Hello @bob!' });
