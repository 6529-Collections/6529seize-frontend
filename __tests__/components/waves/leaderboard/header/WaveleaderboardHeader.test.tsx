...
jest.mock('../../../../../components/waves/leaderboard/header/WaveleaderboardSort', () => ({ WaveleaderboardSort: (props:any) => <button data-testid="sort" onClick={()=>props.onSortChange('SORT' as any)} /> }));

jest.mock('../../../../../hooks/useWave', () => ({ useWave: () => ({ isMemesWave: true, participation: { isEligible: true } }) }));
...
it('renders controls and handles actions', async () => {
  ...
  render(
    <AuthContext.Provider value={{ connectedProfile: {} } as any}>
      <WaveLeaderboardHeader wave={wave} onCreateDrop={onCreate} viewMode="list" onViewModeChange={onViewModeChange} sort={WaveDropsLeaderboardSort.RANK} onSortChange={onSortChange} />
