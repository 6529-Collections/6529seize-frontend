...
jest.mock("@/components/auth/SeizeConnectContext", () => ({
  useSeizeConnectContext: () => ({ address: undefined, isSafeWallet: false }),
}));
...
jest.mock("@/components/waves/drop/SingleWaveDropVoteSlider", () => ({
  __esModule: true,
  default: (props: any) => (
    <div data-testid="slider" onClick={() => props.setVoteValue(5)} />
  ),
}));
...
jest.mock("@/components/waves/drop/SingleWaveDropVoteStats", () => ({
  __esModule: true,
  SingleWaveDropVoteStats: () => <div data-testid="stats" />,
}));
