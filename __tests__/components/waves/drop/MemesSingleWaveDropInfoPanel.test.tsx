...
jest.mock("../../../../components/waves/drop/SingleWaveDropClose", () => ({
  SingleWaveDropClose: () => <div data-testid="close" />,
}));
jest.mock(
  "../../../../components/waves/drop/SingleWaveDropInfoContainer",
  () => ({
    SingleWaveDropInfoContainer: ({ children }: any) => (
      <div data-testid="container">{children}</div>
    ),
  })
);
jest.mock(
  "../../../../components/waves/drop/SingleWaveDropInfoDetails",
  () => ({ SingleWaveDropInfoDetails: () => <div data-testid="details" /> })
);
jest.mock(
  "../../../../components/waves/drop/SingleWaveDropInfoAuthorSection",
  () => ({
    SingleWaveDropInfoAuthorSection: () => <div data-testid="author" />,
  })
);
jest.mock(
  "../../../../components/waves/drop/SingleWaveDropInfoActions",
...
jest.mock("../../../../components/waves/drop/DropTraits", () => ({
  DropTraits: () => <div data-testid="traits" />,
}));
...
jest.mock("../../../../hooks/drops/useDropInteractionRules", () => ({
  useDropInteractionRules: jest.fn(() => ({ isWinner: true, canDelete: true })),
}));
