...
jest.mock('@/hooks/useIsMobileLayoutViewport', () => ({ __esModule: true, default: jest.fn(() => false) }));
const mobileMock = require('@/hooks/useIsMobileLayoutViewport').default as jest.Mock;
