...
jest.mock(
  "@/components/user/identity/statements/utils/UserPageIdentityStatementsStatementsList",
  () => (props: any) => {
    capturedProps = props;
...
describe("UserPageIdentityStatementsSocialMediaVerificationPosts", () => {
  it("forwards props to statements list", () => {
    ...
    expect(capturedProps.noItemsMessage).toBe(
      "No verification posts added yet."
    );
