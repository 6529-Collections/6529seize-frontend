...
let cicProps: any;
jest.mock('../../../../../components/user/utils/UserCICAndLevel', () => (props: any) => { cicProps = props; return <div data-testid="cic" />; });
...
describe('ProfileRatersTableItem', () => {
  ...
  it('shows positive rating and rep link', () => {
    render(<table><tbody><ProfileRatersTableItem rating={baseRating} type={ProfileRatersTableType.REP_RECEIVED} /></tbody></table>);
  ...
  it('shows negative rating without plus sign', () => {
    ...
    render(<table><tbody><ProfileRatersTableItem rating={rating} type={ProfileRatersTableType.CIC_GIVEN} /></tbody></table>);
