...
let itemProps: any[] = [];
jest.mock('../../../../../components/user/utils/raters-table/ProfileRatersTableItem', () => (props: any) => { itemProps.push(props); return <tr data-testid="item" />; });
...
describe('ProfileRatersTableBody', () => {
  ...
  it('renders a row for each rating', () => {
    ...
    const { getAllByTestId } = render(
      <table><ProfileRatersTableBody ratings={ratings} type={ProfileRatersTableType.CIC_RECEIVED} /></table>
    );
