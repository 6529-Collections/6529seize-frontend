...
describe('ProfileRatersTableWrapperHeader', () => {
  it('renders CIC received text', () => {
    render(<ProfileRatersTableWrapperHeader type={ProfileRatersTableType.CIC_RECEIVED} />);
    expect(screen.getByTestId('wrapper').textContent).toContain("Who's NIC-Rating");
    expect(screen.getByTestId('name')).toBeInTheDocument();
  });

  it('renders REP given text', () => {
    render(<ProfileRatersTableWrapperHeader type={ProfileRatersTableType.REP_GIVEN} />);
