...
jest.mock('../../../../components/user/collected/filters/UserPageCollectedFilters', () => 
  function MockFilters(props: any) {
    return <div data-testid="filters" data-collection={props.filters.collection} />;
  }
);
...
jest.mock('../../../../components/user/collected/UserPageCollectedFirstLoading', () => 
...
describe('UserPageCollected', () => {
  ...
  it('renders filters and cards when data loaded', () => {
    ...
    expect(screen.getByTestId('cards')).toHaveAttribute('data-cards-count', '2');
  });
  ...
  it('handles collection filter from search params', () => {
    ...
    expect(screen.getByTestId('filters')).toHaveAttribute('data-collection', 'MEMES');
  });
  ...
  it('calculates total pages correctly from data count', async () => {
    ...
    await waitFor(() => {
      expect(screen.getByTestId('cards')).toHaveAttribute('data-total-pages', '3');
    });
  });
