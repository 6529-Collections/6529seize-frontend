...
jest.mock('../../../../components/user/waves/UserPageWaves', () => 
  function MockUserPageWaves({ profile }: { profile: ApiIdentity }) {
    return <div data-testid="user-page-waves" data-profile-handle={profile.handle} />;
  }
);
...
describe('UserPageWavesWrapper', () => {
  ...
  it('does not redirect when showWaves is false but no connectedProfile and has address', () => {
    renderComponent({
      showWaves: false,
      connectedProfile: null,
    });
