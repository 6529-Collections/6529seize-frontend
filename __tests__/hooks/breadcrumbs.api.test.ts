...
describe('breadcrumbs.api', () => {
  ...
  describe('fetchGradientName', () => {
    ...
    it('returns fallback name on API error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error fetching gradient name:', expect.any(Error));
    });
  ...
  describe('fetchProfileHandle', () => {
    ...
    it('handles errors gracefully', async () => {
      ...
      expect(result).toEqual({ handle: 'testhandle' });
      expect(console.error).toHaveBeenCalledWith('Error fetching profile handle:', expect.any(Error));
    });
  });
  ...
  describe('fetchWaveName', () => {
    ...
    it('returns fallback name on API error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error fetching wave name:', expect.any(Error));
    });
  ...
  describe('fetchMemeName', () => {
    ...
    it('returns fallback name on API error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error fetching meme name:', expect.any(Error));
    });
  ...
  describe('fetchNextgenName', () => {
    ...
    it('returns fallback name on API error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error fetching nextgen name:', expect.any(Error));
    });
  });
  ...
  describe('fetchRememeName', () => {
    ...
    it('returns fallback name on API error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error fetching rememe name:', expect.any(Error));
    });
  ...
  describe('fetchMemeLabName', () => {
    ...
    it('returns fallback name on API error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error fetching meme lab name:', expect.any(Error));
    });
  });
  ...
  describe('fetchCollectionName', () => {
    ...
    it('returns fallback name on API error', async () => {
      ...
      expect(console.error).toHaveBeenCalledWith('Error fetching collection name:', expect.any(Error));
    });
