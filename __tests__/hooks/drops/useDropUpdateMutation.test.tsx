...
>;
const mockedUseMyStream = useMyStream as jest.MockedFunction<
  typeof useMyStream
>;
...
interface TestHookResult {
  result: ReturnType<
    typeof renderHook<ReturnType<typeof useDropUpdateMutation>, any>
  >["result"];
...
const executeMutation = async (
  result: any,
  params?: Partial<DropUpdateMutationParams>
) => {
