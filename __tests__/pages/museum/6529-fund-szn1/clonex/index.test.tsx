...
import Page from "../../../../../pages/app/museum/6529-fund-szn1/clonex/page";
...
describe('CloneX Page', () => {
  const renderComponent = () => render(<Page />);

  it('renders the page title', () => {
    renderComponent();
    const title = document.querySelector('title');
    expect(title?.textContent).toBe('CLONEX - 6529.io');
  });
  ...
  it('includes canonical link', () => {
    ...
    expect(canonical?.getAttribute('href')).toBe('/museum/6529-fund-szn1/clonex/');
  });
  ...
  it('includes Open Graph title', () => {
    ...
    expect(ogTitle?.getAttribute('content')).toBe('CLONEX - 6529.io');
  });
