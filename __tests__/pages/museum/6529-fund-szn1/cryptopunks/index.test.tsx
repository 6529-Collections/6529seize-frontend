...
import CryptoPunksPage from '../../../../../pages/museum/6529-fund-szn1/cryptopunks/index';
...
describe('CryptoPunksPage', () => {
  ...
  it('includes canonical link', () => {
    ...
    expect(canonicalLink?.getAttribute('href')).toBe('/museum/6529-fund-szn1/cryptopunks/');
  });
  ...
  it('includes Open Graph meta tags', () => {
    ...
    expect(ogUrl?.getAttribute('content')).toBe('/museum/6529-fund-szn1/cryptopunks/');
  });
