...
import GenesisPage from '../../../../../pages/museum/6529-fund-szn1/genesis/index';
...
describe('GenesisPage', () => {
  ...
  it('renders the page title', () => {
    ...
    expect(titleElement?.textContent).toBe('GENESIS - 6529.io');
  });
  ...
  it('includes canonical link', () => {
    ...
    expect(canonicalLink?.getAttribute('href')).toBe('/museum/6529-fund-szn1/genesis/');
  });
  ...
  it('includes Open Graph meta tags', () => {
    ...
    expect(ogTitle?.getAttribute('content')).toBe('GENESIS - 6529.io');
    ...
    expect(ogUrl?.getAttribute('content')).toBe('/museum/6529-fund-szn1/genesis/');
  });
  ...
  it('displays the page heading', () => {
    ...
    const pageHeadings = screen.getAllByText('GENESIS');
