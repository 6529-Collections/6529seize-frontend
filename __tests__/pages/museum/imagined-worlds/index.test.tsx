...
import Page from "../../../../pages/app/museum/imagined-worlds/page";
...
describe('Imagined Worlds Page', () => {
  const renderComponent = () => render(<Page />);

  it('renders the page title', () => {
    renderComponent();
    const title = document.querySelector('title');
    expect(title?.textContent).toBe('IMAGINED WORLDS - 6529.io');
  });
  ...
  it('includes canonical link', () => {
    ...
    expect(canonical?.getAttribute('href')).toBe('/museum/imagined-worlds/');
  });
  ...
  it('includes Open Graph title', () => {
    ...
    expect(ogTitle?.getAttribute('content')).toBe('IMAGINED WORLDS - 6529.io');
  });
