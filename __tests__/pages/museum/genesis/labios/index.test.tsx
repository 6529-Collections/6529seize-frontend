...
import Page from "../../../../../pages/app/museum/genesis/labios/page";
...
describe('Labios Page', () => {
  const renderComponent = () => render(<Page />);

  it('renders the page title', () => {
    renderComponent();
    const title = document.querySelector('title');
    expect(title?.textContent).toBe('LABIOS - 6529.io');
  });
  ...
  it('includes canonical link', () => {
    ...
    expect(canonical?.getAttribute('href')).toBe('/museum/genesis/labios/');
  });
  ...
  it('includes Open Graph title', () => {
    ...
    expect(ogTitle?.getAttribute('content')).toBe('LABIOS - 6529.io');
  });
