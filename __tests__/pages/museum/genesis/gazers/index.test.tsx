...
import Page from "../../../../../pages/app/museum/genesis/gazers/page";
...
describe('Gazers Page', () => {
  const renderComponent = () => render(<Page />);

  it('renders the page title', () => {
    renderComponent();
    const title = document.querySelector('title');
    expect(title?.textContent).toBe('GAZERS - 6529.io');
  });
  ...
  it('includes canonical link', () => {
    ...
    expect(canonical?.getAttribute('href')).toBe('/museum/genesis/gazers/');
  });
  ...
  it('includes Open Graph title', () => {
    ...
    expect(ogTitle?.getAttribute('content')).toBe('GAZERS - 6529.io');
  });
