...
import Page from "../../../../../pages/app/museum/genesis/glitch-crystal-monsters/page";
...
describe('Glitch Crystal Monsters Page', () => {
  const renderComponent = () => render(<Page />);

  it('renders the page title', () => {
    renderComponent();
    const title = document.querySelector('title');
    expect(title?.textContent).toBe('GLITCH CRYSTAL MONSTERS - 6529.io');
  });
  ...
  it('includes canonical link', () => {
    ...
    expect(canonical?.getAttribute('href')).toBe('/museum/genesis/glitch-crystal-monsters/');
  });
  ...
  it('includes Open Graph title', () => {
    ...
    expect(ogTitle?.getAttribute('content')).toBe('GLITCH CRYSTAL MONSTERS - 6529.io');
  });
