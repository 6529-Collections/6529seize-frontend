...
import Page from "../../../../../pages/app/museum/genesis/kai-gen/page";
...
describe('Kai-Gen Page', () => {
  const renderComponent = () => render(<Page />);

  it('renders the page title', () => {
    renderComponent();
    const title = document.querySelector('title');
    expect(title?.textContent).toBe('KAI-GEN - 6529.io');
  });
  ...
  it('includes canonical link', () => {
    ...
    expect(canonical?.getAttribute('href')).toBe('/museum/genesis/kai-gen/');
  });
  ...
  it('includes Open Graph title', () => {
    ...
    expect(ogTitle?.getAttribute('content')).toBe('KAI-GEN - 6529.io');
  });
