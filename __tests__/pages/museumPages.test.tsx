...
import CryptoAdPunks from "../../pages/app/museum/6529-fund-szn1/cryptoad-punks/page";
import CryptoPunks from "../../pages/app/museum/6529-fund-szn1/cryptopunks/page";
import QueensKings from "../../pages/app/museum/6529-fund-szn1/queens-kings/page";
import AckBar from "../../pages/app/museum/ack-bar/page";
import EarlyNftArt from "../../pages/app/museum/early-nft-art/page";
import Autology from "../../pages/app/museum/genesis/autology/page";
import Cryptoblots from "../../pages/app/museum/genesis/cryptoblots/page";
import Dreams from "../../pages/app/museum/genesis/dreams/page";
import DynamicSlices from "../../pages/app/museum/genesis/dynamic-slices/page";
import Edifice from "../../pages/app/museum/genesis/edifice/page";
