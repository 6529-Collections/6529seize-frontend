...
import Azuki from "../../pages/app/museum/6529-fund-szn1/azuki/page";
import Cod from "../../pages/app/museum/6529-fund-szn1/cod/page";
import InvisibleFriends from "../../pages/app/museum/6529-fund-szn1/invisible-friends/page";
import Nouns from "../../pages/app/museum/6529-fund-szn1/nouns/page";
import ScreensPage from "../../pages/app/museum/6529-fund-szn1/screens/page";
import TwinFlames from "../../pages/app/museum/6529-fund-szn1/twin-flames/page";
import PhotoA from "../../pages/app/museum/6529-photo-a/page";
import Batsoupyum from "../../pages/app/museum/batsoupyum-museum-2/page";
import MemeLabId from '../../pages/meme-lab/[id]';
import BharatKrymo from "../../pages/app/museum/bharat-krymo-museum-1/page";
import GenerativeArt from "../../pages/app/museum/generative-art/page";
import SevenTwenty from "../../pages/app/museum/genesis/720-minutes/page";
import Bent from "../../pages/app/museum/genesis/bent/page";
import Elementals from "../../pages/app/museum/genesis/elementals/page";
import GreatHall from "../../pages/app/museum/genesis/great-hall-of-generative-art/page";
import JiometoryNoCompute from "../../pages/app/museum/genesis/jiometory-no-compute/page";
import ParaBellum from "../../pages/app/museum/genesis/para-bellum/page";
import ScribbledBoundaries from "../../pages/app/museum/genesis/scribbled-boundaries/page";
import Spectron from "../../pages/app/museum/genesis/spectron/page";
