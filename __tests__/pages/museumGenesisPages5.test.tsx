...
import Century from "../../pages/app/museum/genesis/century/page";
import Meridian from "../../pages/app/museum/genesis/meridian/page";
import PublicDomain from "../../pages/app/museum/6529-public-domain/page";
import Archetype from "../../pages/app/museum/genesis/archetype/page";
import FragmentsOfAnInfiniteField from "../../pages/app/museum/genesis/fragments-of-an-infinite-field/page";
import Nimbuds from "../../pages/app/museum/genesis/nimbuds/page";
import NftPhotography from "../../pages/app/museum/nft-photography/page";
