...
describe("Static Pages Rendering", () => {
  ...
  describe("Error Resistance and Stability", () => {
    ...
    it("should maintain consistent document structure across renders", () => {
      ...
      const initialCanonical = document.querySelector('link[rel="canonical"]')?.getAttribute('href');
      
      rerender(<EmailSignatures />);
      
      expect(document.title).toBe(initialTitle);
      expect(document.querySelector('link[rel="canonical"]')?.getAttribute('href')).toBe(initialCanonical);
    });
  });
});
