...
import MuseumFund from "@/pages/app/museum/6529-fund-szn1/page";
import ConstructionToken from "@/pages/app/museum/6529-fund-szn1/construction-token/page";
import ImageWithArrow from "@/pages/app/museum/6529-fund-szn1/image-with-arrow/page";
