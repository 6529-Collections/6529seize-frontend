...
describe("WebSocketProvider", () => {
  ...
  describe("Message Handling", () => {
    ...
    it("handles wrapped payload messages and routes nested data", () => {
      ...
      act(() => {
        result.current.subscribe(WsMessageType.MEDIA_LINK_UPDATED, callback);
      });
        ...
        ws.triggerMessage({
          ...
          message: {
            ...
            data: {
              ...
              media_uri: "https://cdn.example.com/image.png",
            },
          },
          raw: '{"type":"MEDIA_LINK_UPDATED"}',
        });
      });
    ...
    it("sends messages only when connection is open", () => {
      ...
      expect(ws.send).toHaveBeenCalledWith(
        JSON.stringify({ type: WsMessageType.DROP_UPDATE, id: 3 })
      );
    });
  ...
  describe("Subscription Management", () => {
    it("manages multiple subscribers for same message type", () => {
      ...
      act(() => {
        unsubscribe1 = result.current.subscribe(
          WsMessageType.DROP_UPDATE,
          callback1
        );
        unsubscribe2 = result.current.subscribe(
          WsMessageType.DROP_UPDATE,
          callback2
        );
      });
