...
export class RatingWithProfileInfoAndLevelPage {
    'data': Array<RatingWithProfileInfoAndLevel>;
    'count': number;
    'page': number;
    'next': boolean;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<RatingWithProfileInfoAndLevel>",
            "format": ""
        },
        {
            "name": "count",
    ...
    static getAttributeTypeMap() {
        return RatingWithProfileInfoAndLevelPage.attributeTypeMap;
    }
