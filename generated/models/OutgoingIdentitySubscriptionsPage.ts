...
export class OutgoingIdentitySubscriptionsPage {
    'data': Array<TargetAndSubscriptionActions>;
    'count': number;
    'page': number;
    'next': boolean;
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            "name": "data",
            "baseName": "data",
            "type": "Array<TargetAndSubscriptionActions>",
            "format": ""
        },
        {
            "name": "count",
    ...
    static getAttributeTypeMap() {
        return OutgoingIdentitySubscriptionsPage.attributeTypeMap;
    }
