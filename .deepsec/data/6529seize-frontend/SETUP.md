# Agent setup for `6529seize-frontend`

This is a deepsec scanning workspace. Project `6529seize-frontend` was just registered
(target: `..`). Setup is incomplete — `data/6529seize-frontend/INFO.md`
...
2. **Fill in `data/6529seize-frontend/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id 6529seize-frontend
pnpm deepsec process --project-id 6529seize-frontend
```
