...
| `test:e2e:staging:museum-institutional-practice`    | museum-institutional-practice | readonly | staging     | post-deploy, manual       | 30m     | Staging Network Museum institutional-practice deployed route smoke.                 |
