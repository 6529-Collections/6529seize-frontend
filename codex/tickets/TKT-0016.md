...
- [ ] Validate the application by running tests, lint, and type-check.

## Acceptance

- [ ] `next` and related dependencies updated to version 16 and app boots locally.
- [ ] `npm run test`, `npm run lint`, and `npm run type-check` pass without errors.
- [ ] Documented the upgrade outcome and any required follow-ups.

## Links

- Primary PR: https://github.com/6529-Collections/6529seize-frontend/pull/1570
