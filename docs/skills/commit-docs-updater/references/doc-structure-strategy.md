...
Use this guide to keep `/docs` easy to browse, logically grouped, and current-state only.

## Goals

- Make `docs/README.md` the clear start point.
...
- `docs/README.md` (global map and entrypoint)
- `docs/<area>/README.md` (area index)
- `docs/<area>/<subarea>/README.md` (optional; required when scale thresholds are hit)
- `docs/<area>/<...>/feature-*.md`
- `docs/<area>/<...>/flow-*.md`
- `docs/<area>/<...>/troubleshooting-*.md`
...
- Identify missing indexes (`docs/README.md`, area `README.md`, needed subarea `README.md`).
...
- Avoid redundant area prefixes in filenames inside area/subarea paths.
  - Good: `docs/waves/create/feature-dates-step.md`
  - Bad: `docs/waves/create/feature-wave-create-dates-step.md`
