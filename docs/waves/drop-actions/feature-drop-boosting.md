...
Wave drops support a per-user boost action.
...
4. Boost count on the action updates immediately and stays updated on success.
5. If the server request fails, the action and count revert to the previous
