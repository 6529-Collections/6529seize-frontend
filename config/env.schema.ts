...
export const publicEnvSchema = z.object({
  ...
  AUTH_LEGACY_REFRESH_ENABLED: z.enum(["true", "false"]).optional(),
  AUTH_SESSION_V2_ENABLED: z.enum(["true", "false"]).optional(),
  AUTH_STRUCTURED_SIGNATURES_ENABLED: z.enum(["true", "false"]).optional(),
  AUTH_TRANSFER_CODES_ENABLED: z.enum(["true", "false"]).optional(),
