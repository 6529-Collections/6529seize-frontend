...
separately installs `StreamMintManager` in Core, but
...
That may be a reasonable trust model for a particular sale, with different
guarantees. Stream's complexity should be judged against the responsibilities
it carries.
