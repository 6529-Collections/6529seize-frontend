...
authority. The present Core-freeze call is an administrative action available
without a new artist signature.
...
placing speculative mechanisms in the permanent Core. Each sale profile needs
its own
...
same derived seed. That protects
