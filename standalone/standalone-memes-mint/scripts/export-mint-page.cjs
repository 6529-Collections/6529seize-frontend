...
Package scripts:
  6529 run export-mint-page            prod, no sync
  6529 run export-mint-page:sync       prod + sync
  6529 run export-mint-page:test       test, no sync
  6529 run export-mint-page:test:sync  test + sync
